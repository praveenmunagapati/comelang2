...
memset(&word_6, 0, sizeof(char*));
memset(&right_value11, 0, sizeof(void*));
memset(&generics_name_9, 0, sizeof(char*));
memset(&right_value15, 0, sizeof(void*));
memset(&pointer_num_13, 0, sizeof(int));
memset(&right_value16, 0, sizeof(void*));
memset(&right_value17, 0, sizeof(void*));
memset(&right_value18, 0, sizeof(void*));
memset(&head_21, 0, sizeof(char*));
memset(&right_value19, 0, sizeof(void*));
memset(&buf_22, 0, sizeof(char*));
memset(&right_value20, 0, sizeof(void*));
memset(&node_23, 0, sizeof(struct sNode*));
...
memset(&right_value23, 0, sizeof(void*));
    ...
    if(_if_conditional5=string_operator_equals(buf,"impl"),    _if_conditional5) {
        # 6 "22impl.c"
        word_6=(char*)come_increment_ref_count(optional$2charphbool_value(((struct optional$2charphbool*)(right_value10=parse_word(info)))));
        __freed_obj__ = come_is_contained_element(__right_value_freed_obj, 0, right_value10);
        if(right_value10 && right_value10 != __result_obj__ && !__freed_obj__) { come_call_finalizer(optional$2charphboolp_finalize,right_value10, (void*)0, (void*)0, 0, 1, 0, 0); }
        __right_value_freed_obj[0] = right_value10;
        __freed_obj__ = 0;
        # 34 "22impl.c"
        # 8 "22impl.c"
        if(_if_conditional8=*info->p==60,        _if_conditional8) {
            # 9 "22impl.c"
            info->p++;
            # 10 "22impl.c"
            ...
            while(_while_condtional2=(_Bool)1,            _while_condtional2) {
                # 14 "22impl.c"
                generics_name_9=(char*)come_increment_ref_count(optional$2charphbool_value(((struct optional$2charphbool*)(right_value11=parse_word(info)))));
                ...
                __freed_obj__ = 0;
                # 16 "22impl.c"
                list$1charph_push_back(info->generics_type_names,(char*)come_increment_ref_count(((char*)(right_value15=string_clone(generics_name_9)))));
                ...
                # 31 "22impl.c"
                # 18 "22impl.c"
                if(_if_conditional12=*info->p==44,                _if_conditional12) {
                    # 19 "22impl.c"
                    info->p++;
                    # 20 "22impl.c"
                    skip_spaces_and_lf(info);
                    ...
                    # 31 "22impl.c"
                    # 22 "22impl.c"
                    if(_if_conditional13=*info->p==62,                    _if_conditional13) {
                        # 23 "22impl.c"
                        info->p++;
                        # 24 "22impl.c"
                        skip_spaces_and_lf(info);
                        # 25 "22impl.c"
                        if(generics_name_9 && !__freed_obj__) { generics_name_9 = come_decrement_ref_count(generics_name_9, (void*)0, (void*)0, 0, 0, 0); }
                        break;
                    }
                    else {
                        # 28 "22impl.c"
        ...
        # 41 "22impl.c"
        optional$2intbool_value(((struct optional$2intbool*)(right_value16=expected_next_character(123,info))));
        __freed_obj__ = come_is_contained_element(__right_value_freed_obj, 1, right_value16);
        if(right_value16 && right_value16 != __result_obj__ && !__freed_obj__) { come_call_finalizer(optional$2intboolp_finalize,right_value16, (void*)0, (void*)0, 0, 1, 0, 0); }
        __right_value_freed_obj[1] = right_value16;
        __freed_obj__ = 0;
        # 43 "22impl.c"
        __dec_obj9=info->impl_type;
        info->impl_type=(struct sType*)come_increment_ref_count(((struct sType*)(right_value18=sType_initialize((struct sType*)come_increment_ref_count(((struct sType*)(right_value17=(struct sType*)come_calloc(1, sizeof(struct sType)*(1), "22impl.c", 43)))),word_6,(_Bool)0,info))));
        ...
        __freed_obj__ = 0;
        # 44 "22impl.c"
        info->impl_type->mPointerNum=pointer_num_13;
        # 74 "22impl.c"
        while(_while_condtional7=*info->p!=125,        _while_condtional7) {
            ...
            head_21=info->p;
            # 50 "22impl.c"
            buf_22=(char*)come_increment_ref_count(optional$2charphbool_value(((struct optional$2charphbool*)(right_value19=parse_word(info)))));
            ...
            parse_sharp_v5(info);
            # 54 "22impl.c"
            node_23=(struct sNode*)come_increment_ref_count(((struct sNode*)(right_value20=top_level_v99((char*)come_increment_ref_count(buf_22),head_21,head_sline,info))));
            ...
            # 69 "22impl.c"
            # 63 "22impl.c"
            if(_if_conditional30=node_23!=((void*)0),            _if_conditional30) {
                # 68 "22impl.c"
                # 64 "22impl.c"
                if(_if_conditional31=!node_compile(node_23,info),                _if_conditional31) {
                    # 65 "22impl.c"
            ...
            # 71 "22impl.c"
            skip_spaces_and_lf(info);
            if(buf_22 && !__freed_obj__) { buf_22 = come_decrement_ref_count(buf_22, (void*)0, (void*)0, 0, 0, 0); }
            if(node_23 && !__freed_obj__) { node_23 = come_decrement_ref_count(node_23, ((struct sNode*)node_23)->finalize, ((struct sNode*)node_23)->_protocol_obj, 0, 0, 0); } 
        }
        # 74 "22impl.c"
        optional$2intbool_value(((struct optional$2intbool*)(right_value21=expected_next_character(125,info))));
        __freed_obj__ = come_is_contained_element(__right_value_freed_obj, 4, right_value21);
        if(right_value21 && right_value21 != __result_obj__ && !__freed_obj__) { come_call_finalizer(optional$2intboolp_finalize,right_value21, (void*)0, (void*)0, 0, 1, 0, 0); }
        __right_value_freed_obj[4] = right_value21;
        __freed_obj__ = 0;
        # 75 "22impl.c"
        list$1charph_reset(info->generics_type_names);
        # 76 "22impl.c"
        ...
        # 78 "22impl.c"
        __result13__ = __result_obj__ = (struct sNode*)((void*)0);
        if(word_6 && !__freed_obj__) { word_6 = come_decrement_ref_count(word_6, (void*)0, (void*)0, 0, 0, 0); }
        if(buf && !__freed_obj__) { buf = come_decrement_ref_count(buf, (void*)0, (void*)0, 0, 1, 0); }
        return __result13__;
        if(word_6 && !__freed_obj__) { word_6 = come_decrement_ref_count(word_6, (void*)0, (void*)0, 0, 0, 0); }
    }
    # 81 "22impl.c"
    __result14__ = __result_obj__ = ((struct sNode*)(right_value23=top_level_v92((char*)come_increment_ref_count(((char*)(right_value22=__builtin_string(buf)))),head,head_sline,info)));
    if(buf && !__freed_obj__) { buf = come_decrement_ref_count(buf, (void*)0, (void*)0, 0, 1, 0); }
    ...
    if(right_value23 && right_value23 != __result_obj__ && !__freed_obj__) { right_value23 = come_decrement_ref_count(right_value23, ((struct sNode*)right_value23)->finalize, ((struct sNode*)right_value23)->_protocol_obj, 1, 0, 0); } 
...
char* default_value_5;
char* __result7__;
char* __result8__;
memset(&__result_obj__, 0, sizeof(void*));
memset(&__freed_obj__, 0, sizeof(_Bool));
memset(&default_value_5, 0, sizeof(char*));
            # 69 "./comelang2.h"
            # 61 "./comelang2.h"
            if(_if_conditional6=self==((void*)0),            _if_conditional6) {
                ...
                memset(&default_value_5,0,sizeof(char*));
                # 64 "./comelang2.h"
                __result7__ = __result_obj__ = default_value_5;
                return __result7__;
            }
            else {
                # 67 "./comelang2.h"
                __result8__ = __result_obj__ = self->v1;
                return __result8__;
            }
}
...
char* __dec_obj8;
struct list$1charph* __result10__;
memset(&__result_obj__, 0, sizeof(void*));
memset(&__freed_obj__, 0, sizeof(_Bool));
...
memset(&litem_12, 0, sizeof(struct list_item$1charph*));
                    # 309 "./comelang2.h"
                    # 278 "./comelang2.h"
                    if(_if_conditional10=self->len==0,                    _if_conditional10) {
                        # 279 "./comelang2.h"
                        litem_10=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(right_value12=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "./comelang2.h", 279))));
                        __freed_obj__ = come_is_contained_element(__right_value_freed_obj, 0, right_value12);
                        if(right_value12 && right_value12 != __result_obj__ && !__freed_obj__) { come_call_finalizer(list_item$1charphp_finalize,right_value12, (void*)0, (void*)0, 0, 1, 0, 0); }
                        ...
                        # 309 "./comelang2.h"
                        # 288 "./comelang2.h"
                        if(_if_conditional11=self->len==1,                        _if_conditional11) {
                            # 289 "./comelang2.h"
                            litem_11=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(right_value13=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "./comelang2.h", 289))));
                            __freed_obj__ = come_is_contained_element(__right_value_freed_obj, 0, right_value13);
                            if(right_value13 && right_value13 != __result_obj__ && !__freed_obj__) { come_call_finalizer(list_item$1charphp_finalize,right_value13, (void*)0, (void*)0, 0, 1, 0, 0); }
                            ...
                            # 299 "./comelang2.h"
                            litem_12=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(right_value14=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "./comelang2.h", 299))));
...
int default_value_14;
int __result11__;
int __result12__;
memset(&__result_obj__, 0, sizeof(void*));
memset(&__freed_obj__, 0, sizeof(_Bool));
memset(&default_value_14, 0, sizeof(int));
            # 69 "./comelang2.h"
            # 61 "./comelang2.h"
            if(_if_conditional14=self==((void*)0),            _if_conditional14) {
                ...
                memset(&default_value_14,0,sizeof(int));
                # 64 "./comelang2.h"
                __result11__ = default_value_14;
                return __result11__;
            }
            else {
                # 67 "./comelang2.h"
                __result12__ = self->v1;
                return __result12__;
            }
}
...
memset(&prev_it_18, 0, sizeof(struct list_item$1sNodeph*));
                    ...
                    while(_while_condtional5=it_17!=((void*)0),                    _while_condtional5) {
                        ...
                        it_17=it_17->next;
                        # 180 "./comelang2.h"
                        if(prev_it_18 && !__freed_obj__) { come_call_finalizer(list_item$1sNodephp_finalize,prev_it_18, (void*)0, (void*)0, 0, 0, 0, 0); }
                    }
}
...
memset(&prev_it_20, 0, sizeof(struct list_item$1charph*));
                    ...
                    it_19=self->head;
                    # 182 "./comelang2.h"
                    while(_while_condtional6=it_19!=((void*)0),                    _while_condtional6) {
                        # 178 "./comelang2.h"
                        prev_it_20=it_19;
                        # 179 "./comelang2.h"
                        it_19=it_19->next;
