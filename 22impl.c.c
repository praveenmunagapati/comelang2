...
memset(&right_value23, 0, sizeof(void*));
    if(_if_conditional5=string_operator_equals(buf,"impl"),    _if_conditional5) {
        ...
        __result19__ = __result_obj__ = (struct sNode*)((void*)0);
    ...
    __result20__ = __result_obj__ = ((struct sNode*)(right_value23=top_level_v92((char*)come_increment_ref_count(((char*)(right_value22=__builtin_string(buf)))),head,head_sline,info)));
    if(buf && !__freed_obj__) { buf = come_decrement_ref_count(buf, (void*)0, (void*)0, 0, 1, 0); }
...
memset(&default_value_5, 0, sizeof(char*));
            if(_if_conditional6=self==((void*)0),            _if_conditional6) {
                memset(&default_value_5,0,sizeof(char*));
                __result13__ = __result_obj__ = default_value_5;
                return __result13__;
            }
            else {
...
memset(&default_value_14, 0, sizeof(int));
            if(_if_conditional14=self==((void*)0),            _if_conditional14) {
                memset(&default_value_14,0,sizeof(int));
                __result17__ = default_value_14;
                return __result17__;
            }
            else {
                __result18__ = self->v1;
                return __result18__;
            }
}
