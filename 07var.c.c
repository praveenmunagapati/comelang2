...
right_value60 = (void*)0;
            ...
            result_31=(struct list$1tuple3$3sTypephcharphsNodephph*)come_increment_ref_count(((struct list$1tuple3$3sTypephcharphsNodephph*)(right_value52=list$1tuple3$3sTypephcharphsNodephph_initialize((struct list$1tuple3$3sTypephcharphsNodephph*)come_increment_ref_count(((struct list$1tuple3$3sTypephcharphsNodephph*)(right_value51=(struct list$1tuple3$3sTypephcharphsNodephph*)come_calloc(1, sizeof(struct list$1tuple3$3sTypephcharphsNodephph)*(1), "/usr/local/include/comelang2.h", 142, "list$1tuple3$3sTypephcharphsNodephph"))))))));
...
memset(&litem_35, 0, sizeof(struct list_item$1tuple3$3sTypephcharphsNodephph*));
                    if(_if_conditional101=self->len==0,                    _if_conditional101) {
                        litem_33=(struct list_item$1tuple3$3sTypephcharphsNodephph*)come_increment_ref_count(((struct list_item$1tuple3$3sTypephcharphsNodephph*)(right_value53=(struct list_item$1tuple3$3sTypephcharphsNodephph*)come_calloc(1, sizeof(struct list_item$1tuple3$3sTypephcharphsNodephph)*(1), "/usr/local/include/comelang2.h", 156, "list_item$1tuple3$3sTypephcharphsNodephph"))));
                        ...
                        if(_if_conditional105=self->len==1,                        _if_conditional105) {
                            litem_34=(struct list_item$1tuple3$3sTypephcharphsNodephph*)come_increment_ref_count(((struct list_item$1tuple3$3sTypephcharphsNodephph*)(right_value54=(struct list_item$1tuple3$3sTypephcharphsNodephph*)come_calloc(1, sizeof(struct list_item$1tuple3$3sTypephcharphsNodephph)*(1), "/usr/local/include/comelang2.h", 166, "list_item$1tuple3$3sTypephcharphsNodephph"))));
                            ...
                            litem_35=(struct list_item$1tuple3$3sTypephcharphsNodephph*)come_increment_ref_count(((struct list_item$1tuple3$3sTypephcharphsNodephph*)(right_value55=(struct list_item$1tuple3$3sTypephcharphsNodephph*)come_calloc(1, sizeof(struct list_item$1tuple3$3sTypephcharphsNodephph)*(1), "/usr/local/include/comelang2.h", 176, "list_item$1tuple3$3sTypephcharphsNodephph"))));
...
memset(&litem_76, 0, sizeof(struct list_item$1CVALUEph*));
                    if(_if_conditional157=self->len==0,                    _if_conditional157) {
                        litem_74=(struct list_item$1CVALUEph*)come_increment_ref_count(((struct list_item$1CVALUEph*)(right_value91=(struct list_item$1CVALUEph*)come_calloc(1, sizeof(struct list_item$1CVALUEph)*(1), "/usr/local/include/comelang2.h", 226, "list_item$1CVALUEph"))));
                        ...
                        if(_if_conditional159=self->len==1,                        _if_conditional159) {
                            litem_75=(struct list_item$1CVALUEph*)come_increment_ref_count(((struct list_item$1CVALUEph*)(right_value92=(struct list_item$1CVALUEph*)come_calloc(1, sizeof(struct list_item$1CVALUEph)*(1), "/usr/local/include/comelang2.h", 236, "list_item$1CVALUEph"))));
                            ...
                            litem_76=(struct list_item$1CVALUEph*)come_increment_ref_count(((struct list_item$1CVALUEph*)(right_value93=(struct list_item$1CVALUEph*)come_calloc(1, sizeof(struct list_item$1CVALUEph)*(1), "/usr/local/include/comelang2.h", 246, "list_item$1CVALUEph"))));
...
memset(&default_value_162, 0, sizeof(struct sVar*));
                ...
                keys_147=(char**)come_increment_ref_count(((char**)(right_value205=(char**)come_calloc(1, sizeof(char*)*(1*(size_146)), "/usr/local/include/comelang2.h", 1335, "char*%"))));
                right_value205 = come_decrement_ref_count2(right_value205, (void*)0, (void*)0, 1, 0, 0, __result_obj__);
                items_148=(struct sVar**)come_increment_ref_count(((struct sVar**)(right_value206=(struct sVar**)come_calloc(1, sizeof(struct sVar*)*(1*(size_146)), "/usr/local/include/comelang2.h", 1336, "sVar*%"))));
                come_call_finalizer2(sVar_finalize,right_value206, (void*)0, (void*)0, 0, 1, 0, 0, __result_obj__);
                item_existance_149=(_Bool*)come_increment_ref_count(((_Bool*)(right_value207=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_146)), "/usr/local/include/comelang2.h", 1337, "bool"))));
...
memset(&litem_189, 0, sizeof(struct list_item$1charp*));
                if(_if_conditional313=self->len==0,                _if_conditional313) {
                    litem_187=(struct list_item$1charp*)come_increment_ref_count(((struct list_item$1charp*)(right_value208=(struct list_item$1charp*)come_calloc(1, sizeof(struct list_item$1charp)*(1), "/usr/local/include/comelang2.h", 226, "list_item$1charp"))));
                    ...
                    if(_if_conditional314=self->len==1,                    _if_conditional314) {
                        litem_188=(struct list_item$1charp*)come_increment_ref_count(((struct list_item$1charp*)(right_value209=(struct list_item$1charp*)come_calloc(1, sizeof(struct list_item$1charp)*(1), "/usr/local/include/comelang2.h", 236, "list_item$1charp"))));
                        ...
                        litem_189=(struct list_item$1charp*)come_increment_ref_count(((struct list_item$1charp*)(right_value210=(struct list_item$1charp*)come_calloc(1, sizeof(struct list_item$1charp)*(1), "/usr/local/include/comelang2.h", 246, "list_item$1charp"))));
...
char* anonymous_var_nameX1939_266;
void* right_value338;
...
memset(&anonymous_var_nameX1939_266, 0, sizeof(char*));
                            ...
                            if(_if_conditional417=*info->p==61,                            _if_conditional417) {
                                ...
                                if(_if_conditional418=*info->p==123,                                _if_conditional418) {
                                    ...
                                    while(_while_condtional25=*info->p==44,                                    _while_condtional25) {
                                        anonymous_var_nameX1939_266 = come_decrement_ref_count2(anonymous_var_nameX1939_266, (void*)0, (void*)0, 0, 0, 0, (void*)0);
                                    }
...
memset(&litem_214, 0, sizeof(struct list_item$1charph*));
                if(_if_conditional325=self->len==0,                _if_conditional325) {
                    litem_212=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(right_value228=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "/usr/local/include/comelang2.h", 226, "list_item$1charph"))));
                    ...
                    if(_if_conditional326=self->len==1,                    _if_conditional326) {
                        litem_213=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(right_value229=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "/usr/local/include/comelang2.h", 236, "list_item$1charph"))));
                        ...
                        litem_214=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(right_value230=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "/usr/local/include/comelang2.h", 246, "list_item$1charph"))));
...
memset(&litem_228, 0, sizeof(struct list_item$1tuple3$3sTypephcharphsNodephph*));
                if(_if_conditional350=self->len==0,                _if_conditional350) {
                    litem_226=(struct list_item$1tuple3$3sTypephcharphsNodephph*)come_increment_ref_count(((struct list_item$1tuple3$3sTypephcharphsNodephph*)(right_value254=(struct list_item$1tuple3$3sTypephcharphsNodephph*)come_calloc(1, sizeof(struct list_item$1tuple3$3sTypephcharphsNodephph)*(1), "/usr/local/include/comelang2.h", 226, "list_item$1tuple3$3sTypephcharphsNodephph"))));
                    ...
                    if(_if_conditional351=self->len==1,                    _if_conditional351) {
                        litem_227=(struct list_item$1tuple3$3sTypephcharphsNodephph*)come_increment_ref_count(((struct list_item$1tuple3$3sTypephcharphsNodephph*)(right_value255=(struct list_item$1tuple3$3sTypephcharphsNodephph*)come_calloc(1, sizeof(struct list_item$1tuple3$3sTypephcharphsNodephph)*(1), "/usr/local/include/comelang2.h", 236, "list_item$1tuple3$3sTypephcharphsNodephph"))));
                        ...
                        litem_228=(struct list_item$1tuple3$3sTypephcharphsNodephph*)come_increment_ref_count(((struct list_item$1tuple3$3sTypephcharphsNodephph*)(right_value256=(struct list_item$1tuple3$3sTypephcharphsNodephph*)come_calloc(1, sizeof(struct list_item$1tuple3$3sTypephcharphsNodephph)*(1), "/usr/local/include/comelang2.h", 246, "list_item$1tuple3$3sTypephcharphsNodephph"))));
