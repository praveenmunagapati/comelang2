...
struct sTypedefNode* __result52__;
memset(&__result_obj__, 0, sizeof(void*));
...
struct list$1tuple2$2sTypephcharphph* __result46__;
void* right_value88;
void* right_value89;
...
void* right_value96;
struct list$1tuple2$2sTypephcharphph* __result51__;
memset(&__result_obj__, 0, sizeof(void*));
...
static struct list$1tuple2$2sTypephcharphph* list$1tuple2$2sTypephcharphph_initialize(struct list$1tuple2$2sTypephcharphph* self){
void* __result_obj__;
struct list$1tuple2$2sTypephcharphph* __result47__;
memset(&__result_obj__, 0, sizeof(void*));
            self->head=((void*)0);
            self->tail=((void*)0);
            self->len=0;
...
struct list$1tuple2$2sTypephcharphph* __result48__;
memset(&__result_obj__, 0, sizeof(void*));
...
struct tuple2$2sTypephcharph* __result49__;
void* right_value93;
...
void* right_value95;
char* __dec_obj43;
struct tuple2$2sTypephcharph* __result50__;
memset(&__result_obj__, 0, sizeof(void*));
...
right_value98 = (void*)0;
    __result54__ = __result_obj__ = ((char*)(right_value98=__builtin_string("sTypedefNode")));
...
right_value125 = (void*)0;
    ...
    if(_if_conditional112=string_operator_equals(type_name_43,"__darwin_va_list"),    _if_conditional112) {
        ...
        if(self->multiple_declare) {
            for(            o2_saved_112=(struct list$1tuple2$2sTypephcharphph*)come_increment_ref_count((self->multiple_declare)),it_115=list$1tuple2$2sTypephcharphph_begin((o2_saved_112));            !list$1tuple2$2sTypephcharphph_end((o2_saved_112));            it_115=list$1tuple2$2sTypephcharphph_next((o2_saved_112))            ){
                ...
                if(_if_conditional194=string_operator_not_equals(type_name_119,"va_list"),                _if_conditional194) {
            ...
            if(_if_conditional196=string_operator_not_equals(type_name_43,"va_list"),            _if_conditional196) {
...
memset(&it2_84, 0, sizeof(char*));
            ...
            while(_while_condtional12=(_Bool)1,            _while_condtional12) {
                if(_if_conditional131=self->item_existance[it_64],                _if_conditional131) {
                    if(_if_conditional132=string_equals(self->keys[it_64],key),                    _if_conditional132) {
                    ...
                    it_64++;
                    if(_if_conditional154=it_64>=self->size,                    _if_conditional154) {
                        it_64=0;
                    }
                    else {
                        if(_if_conditional155=it_64==hash_63,                        _if_conditional155) {
            ...
            for(            it2_84=list$1charp_begin(self->key_list);            !list$1charp_end(self->key_list);            it2_84=list$1charp_next(self->key_list)            ){
                if(_if_conditional162=string_equals(it2_84,key),                _if_conditional162) {
                    puts("SAME KEY");
                    same_key_exist_81=(_Bool)1;
                }
            }
            if(_if_conditional163=!same_key_exist_81,            _if_conditional163) {
...
memset(&default_value_62, 0, sizeof(struct sClass*));
                    ...
                    keys_45=(char**)come_increment_ref_count(((char**)(right_value100=(char**)come_calloc(1, sizeof(char*)*(1*(size_44)), "./comelang2.h", 1335, "char*%"))));
                    right_value100 = come_decrement_ref_count2(right_value100, (void*)0, (void*)0, 1, 0, 0, __result_obj__);
                    items_46=(struct sClass**)come_increment_ref_count(((struct sClass**)(right_value101=(struct sClass**)come_calloc(1, sizeof(struct sClass*)*(1*(size_44)), "./comelang2.h", 1336, "sClass*%"))));
                    come_call_finalizer2(sClass_finalize,right_value101, (void*)0, (void*)0, 0, 1, 0, 0, __result_obj__);
                    item_existance_49=(_Bool*)come_increment_ref_count(((_Bool*)(right_value102=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_44)), "./comelang2.h", 1337, "bool"))));
                    ...
                    for(                    it_53=map$2charphsClassph_begin(self);                    !map$2charphsClassph_end(self);                    it_53=map$2charphsClassph_next(self)                    ){
                        ...
                        while(_while_condtional11=(_Bool)1,                        _while_condtional11) {
                            if(_if_conditional128=item_existance_49[n_61],                            _if_conditional128) {
                                n_61++;
                                if(_if_conditional129=n_61>=size_44,                                _if_conditional129) {
                                    n_61=0;
                                }
                                else {
                                    if(_if_conditional130=n_61==hash_60,                                    _if_conditional130) {
...
memset(&it_58, 0, sizeof(unsigned int));
                            ...
                            while(_while_condtional10=(_Bool)1,                            _while_condtional10) {
                                if(_if_conditional124=self->item_existance[it_58],                                _if_conditional124) {
                                    if(_if_conditional125=string_equals(self->keys[it_58],key),                                    _if_conditional125) {
                                        __result62__ = __result_obj__ = self->items[it_58];
                                        come_call_finalizer2(sClass_finalize,default_value, (void*)0, (void*)0, 0, 0, 1, 0, (void*)0);
                                        return __result62__;
                                    }
                                    it_58++;
                                    if(_if_conditional126=it_58>=self->size,                                    _if_conditional126) {
                                        it_58=0;
                                    }
                                    else {
                                        if(_if_conditional127=it_58==hash_57,                                        _if_conditional127) {
...
memset(&it_66, 0, sizeof(struct list_item$1charp*));
                                ...
                                while(_while_condtional13=it_66!=((void*)0),                                _while_condtional13) {
                                    if(_if_conditional134=string_equals(it_66->item,item),                                    _if_conditional134) {
                                            ...
                                            if(_if_conditional141=head==0&&tail==self->len,                                            _if_conditional141) {
                                                ...
                                                if(_if_conditional142=head==0,                                                _if_conditional142) {
                                                    ...
                                                    while(_while_condtional15=it_70!=((void*)0),                                                    _while_condtional15) {
                                                        if(_if_conditional143=i_71<tail,                                                        _if_conditional143) {
                                                            prev_it_72=it_70;
                                                            it_70=it_70->next;
                                                            i_71++;
                                                    ...
                                                    if(_if_conditional145=tail==self->len,                                                    _if_conditional145) {
                                                        ...
                                                        while(_while_condtional16=it_73!=((void*)0),                                                        _while_condtional16) {
                                                            if(_if_conditional146=i_74==head,                                                            _if_conditional146) {
                                                        ...
                                                        while(_while_condtional17=it_76!=((void*)0),                                                        _while_condtional17) {
                                                            if(_if_conditional148=i_79==head,                                                            _if_conditional148) {
                                                                head_prev_it_77=it_76->prev;
                                                            }
                                                            if(_if_conditional149=i_79==tail,                                                            _if_conditional149) {
                                                                tail_it_78=it_76;
                                                            }
                                                            if(_if_conditional150=i_79>=head&&i_79<tail,                                                            _if_conditional150) {
                                                                prev_it_80=it_76;
                                                                it_76=it_76->next;
                                                                i_79++;
                                                        ...
                                                        if(_if_conditional151=head_prev_it_77!=((void*)0),                                                        _if_conditional151) {
                                                            head_prev_it_77->next=tail_it_78;
                                                        }
                                                        if(_if_conditional152=tail_it_78!=((void*)0),                                                        _if_conditional152) {
...
struct map$2charphsTypeph* __result90__;
memset(&__result_obj__, 0, sizeof(void*));
...
memset(&it2_111, 0, sizeof(char*));
            ...
            while(_while_condtional20=(_Bool)1,            _while_condtional20) {
                if(_if_conditional178=self->item_existance[it_109],                _if_conditional178) {
                    if(_if_conditional179=string_equals(self->keys[it_109],key),                    _if_conditional179) {
                    ...
                    it_109++;
                    if(_if_conditional182=it_109>=self->size,                    _if_conditional182) {
                        it_109=0;
                    }
                    else {
                        if(_if_conditional183=it_109==hash_108,                        _if_conditional183) {
                            printf("unexpected error in map.insert\n");
                            stackframe();
                            exit(2);
                        }
            ...
            for(            it2_111=list$1charp_begin(self->key_list);            !list$1charp_end(self->key_list);            it2_111=list$1charp_next(self->key_list)            ){
                if(_if_conditional186=string_equals(it2_111,key),                _if_conditional186) {
                    puts("SAME KEY");
                    same_key_exist_110=(_Bool)1;
                }
            }
            if(_if_conditional187=!same_key_exist_110,            _if_conditional187) {
                list$1charp_push_back(self->key_list,key);
            }
...
memset(&default_value_107, 0, sizeof(struct sType*));
                    ...
                    keys_92=(char**)come_increment_ref_count(((char**)(right_value112=(char**)come_calloc(1, sizeof(char*)*(1*(size_91)), "./comelang2.h", 1335, "char*%"))));
                    right_value112 = come_decrement_ref_count2(right_value112, (void*)0, (void*)0, 1, 0, 0, __result_obj__);
                    items_93=(struct sType**)come_increment_ref_count(((struct sType**)(right_value113=(struct sType**)come_calloc(1, sizeof(struct sType*)*(1*(size_91)), "./comelang2.h", 1336, "sType*%"))));
                    come_call_finalizer2(sType_finalize,right_value113, (void*)0, (void*)0, 0, 1, 0, 0, __result_obj__);
                    item_existance_94=(_Bool*)come_increment_ref_count(((_Bool*)(right_value114=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_91)), "./comelang2.h", 1337, "bool"))));
                    ...
                    for(                    it_98=map$2charphsTypeph_begin(self);                    !map$2charphsTypeph_end(self);                    it_98=map$2charphsTypeph_next(self)                    ){
                        ...
                        while(_while_condtional19=(_Bool)1,                        _while_condtional19) {
                            if(_if_conditional175=item_existance_94[n_106],                            _if_conditional175) {
                                n_106++;
                                if(_if_conditional176=n_106>=size_91,                                _if_conditional176) {
                                    n_106=0;
                                }
                                else {
                                    if(_if_conditional177=n_106==hash_105,                                    _if_conditional177) {
                                        printf("unexpected error in map.rehash(1)\n");
                                        stackframe();
                                        exit(2);
                                    }
...
memset(&result_97, 0, sizeof(char*));
                        if(_if_conditional167=self==((void*)0),                        _if_conditional167) {
                            memset(&result_96,0,sizeof(char*));
                            __result79__ = __result_obj__ = result_96;
                            return __result79__;
                        }
                        self->key_list->it=self->key_list->head;
                        if(self->key_list->it) {
                        ...
                        memset(&result_97,0,sizeof(char*));
                        __result81__ = __result_obj__ = result_97;
                        return __result81__;
}
...
memset(&result_100, 0, sizeof(char*));
                        if(_if_conditional169=self==((void*)0)||self->key_list->it==((void*)0),                        _if_conditional169) {
                            memset(&result_99,0,sizeof(char*));
                            __result83__ = __result_obj__ = result_99;
                            return __result83__;
                        }
                        self->key_list->it=self->key_list->it->next;
                        if(self->key_list->it) {
...
memset(&it_103, 0, sizeof(unsigned int));
                            ...
                            while(_while_condtional18=(_Bool)1,                            _while_condtional18) {
                                if(_if_conditional171=self->item_existance[it_103],                                _if_conditional171) {
                                    if(_if_conditional172=string_equals(self->keys[it_103],key),                                    _if_conditional172) {
                                    ...
                                    it_103++;
                                    if(_if_conditional173=it_103>=self->size,                                    _if_conditional173) {
                                        it_103=0;
                                    }
                                    else {
                                        if(_if_conditional174=it_103==hash_102,                                        _if_conditional174) {
...
memset(&result_114, 0, sizeof(struct tuple2$2sTypephcharph*));
                if(_if_conditional190=self==((void*)0),                _if_conditional190) {
                    memset(&result_113,0,sizeof(struct tuple2$2sTypephcharph*));
                    __result91__ = __result_obj__ = result_113;
                    return __result91__;
                }
                self->it=self->head;
                if(self->it) {
...
memset(&result_117, 0, sizeof(struct tuple2$2sTypephcharph*));
                if(_if_conditional192=self==((void*)0)||self->it==((void*)0),                _if_conditional192) {
                    memset(&result_116,0,sizeof(struct tuple2$2sTypephcharph*));
                    __result95__ = __result_obj__ = result_116;
                    return __result95__;
                }
                self->it=self->it->next;
                if(self->it) {
...
right_value126 = (void*)0;
    __result100__ = __result_obj__ = ((char*)(right_value126=__builtin_string(self->sname)));
...
right_value162 = (void*)0;
    ...
    if(_if_conditional198=charp_operator_equals(buf,"typedef"),    _if_conditional198) {
        ...
        if(_if_conditional201=!err_125,        _if_conditional201) {
        ...
        if(_if_conditional202=*info->p==44,        _if_conditional202) {
            ...
            __result105__ = __result_obj__ = ((struct sNode*)(right_value149=_inf_value1));
            ...
            __result108__ = __result_obj__ = ((struct sNode*)(right_value161=_inf_value2));
    ...
    __result109__ = __result_obj__ = ((struct sNode*)(right_value162=top_level_v94(buf,head,head_sline,info)));
...
struct list$1tuple2$2sTypephcharphph* __result102__;
memset(&__result_obj__, 0, sizeof(void*));
...
struct sTypedefNode* __result106__;
void* right_value155;
...
void* right_value160;
char* __dec_obj62;
struct sTypedefNode* __result107__;
memset(&__result_obj__, 0, sizeof(void*));
...
right_value160 = (void*)0;
                ...
                __result107__ = __result_obj__ = result_139;
