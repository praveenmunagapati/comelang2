...
memset(&it_15, 0, sizeof(struct sMemHeader*));
    ...
    it_15->prev=((void*)0);
    if(_if_conditional31=gAllocMem,    _if_conditional31) {
...
memset(&next_it_18, 0, sizeof(struct sMemHeader*));
    if(_if_conditional32=mem,    _if_conditional32) {
        if(_if_conditional33=gComeGCLib,        _if_conditional33) {
        }
        else {
            it_16=(struct sMemHeader*)((char*)mem-sizeof(struct sMemHeader));
            prev_it_17=it_16->prev;
            next_it_18=it_16->next;
            if(_if_conditional34=gAllocMem==it_16,            _if_conditional34) {
                ...
                if(_if_conditional36=prev_it_17,                _if_conditional36) {
                    prev_it_17->next=next_it_18;
                }
                if(_if_conditional37=next_it_18,                _if_conditional37) {
...
memset(&finalizer_31, 0, sizeof(void (*)(void*)));
    ...
    if(_if_conditional44=!no_free&&(count_30<=0||force_delete_),    _if_conditional44) {
...
memset(&result_39, 0, sizeof(char*));
    ...
    len_38=strlen(str)+1;
    result_39=(char*)come_increment_ref_count(((char*)(right_value16=(char*)come_calloc(1, sizeof(char)*(1*(len_38)), "libcomelang2.c", 566))));
...
memset(&i_41, 0, sizeof(int));
    ...
    i_41=0 ,    0;    _for_condtionalA4=    i_41<len ,    _for_condtionalA4;    i_41++ ,    0    ){
        if(_if_conditional56=array[i_41]==element,        _if_conditional56) {
            found_40=(_Bool)1;
            break;
        }
    }
...
memset(&right_value17, 0, sizeof(void*));
    self->size=128;
    __dec_obj6=self->buf;
    self->buf=(char*)come_increment_ref_count(((char*)(right_value17=(char*)come_calloc(1, sizeof(char)*(1*(self->size)), "libcomelang2.c", 591))));
...
memset(&right_value19, 0, sizeof(void*));
    ...
    result_42=(struct buffer*)come_increment_ref_count(((struct buffer*)(right_value18=(struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "libcomelang2.c", 613))));
    ...
    result_42->buf=(char*)come_increment_ref_count(((char*)(right_value19=(char*)come_calloc(1, sizeof(char)*(1*(self->size)), "libcomelang2.c", 616))));
...
memset(&right_value21, 0, sizeof(void*));
    ...
    if(_if_conditional64=self->len+size+1+1>=self->size,    _if_conditional64) {
        old_buf_43=(char*)come_increment_ref_count(((char*)(right_value20=(char*)come_calloc(1, sizeof(char)*(1*(self->size)), "libcomelang2.c", 655))));
        ...
        __dec_obj8=self->buf;
        self->buf=(char*)come_increment_ref_count(((char*)(right_value21=(char*)come_calloc(1, sizeof(char)*(1*(new_size_45)), "libcomelang2.c", 659))));
...
memset(&right_value23, 0, sizeof(void*));
    ...
    if(_if_conditional66=self->len+1+1+1>=self->size,    _if_conditional66) {
        ...
        __dec_obj9=self->buf;
        self->buf=(char*)come_increment_ref_count(((char*)(right_value23=(char*)come_calloc(1, sizeof(char)*(1*(new_size_48)), "libcomelang2.c", 682))));
...
memset(&right_value25, 0, sizeof(void*));
    ...
    size_49=strlen(mem);
    if(_if_conditional68=self->len+size_49+1+1>=self->size,    _if_conditional68) {
        old_buf_50=(char*)come_increment_ref_count(((char*)(right_value24=(char*)come_calloc(1, sizeof(char)*(1*(self->size)), "libcomelang2.c", 704))));
        ...
        self->buf=(char*)come_increment_ref_count(((char*)(right_value25=(char*)come_calloc(1, sizeof(char)*(1*(new_size_52)), "libcomelang2.c", 708))));
...
memset(&right_value27, 0, sizeof(void*));
    ...
    if(_if_conditional70=self->len+size_53+1+1+1>=self->size,    _if_conditional70) {
        old_buf_54=(char*)come_increment_ref_count(((char*)(right_value26=(char*)come_calloc(1, sizeof(char)*(1*(self->size)), "libcomelang2.c", 728))));
        ...
        self->buf=(char*)come_increment_ref_count(((char*)(right_value27=(char*)come_calloc(1, sizeof(char)*(1*(new_size_56)), "libcomelang2.c", 732))));
...
memset(&right_value29, 0, sizeof(void*));
    ...
    mem_57=&value;
    size_58=sizeof(int);
    if(_if_conditional72=self->len+size_58+1+1>=self->size,    _if_conditional72) {
        old_buf_59=(char*)come_increment_ref_count(((char*)(right_value28=(char*)come_calloc(1, sizeof(char)*(1*(self->size)), "libcomelang2.c", 755))));
        ...
        self->buf=(char*)come_increment_ref_count(((char*)(right_value29=(char*)come_calloc(1, sizeof(char)*(1*(new_size_61)), "libcomelang2.c", 759))));
...
memset(&right_value31, 0, sizeof(void*));
    mem_62=&value;
    size_63=sizeof(long);
    if(_if_conditional73=self->len+size_63+1+1>=self->size,    _if_conditional73) {
        old_buf_64=(char*)come_increment_ref_count(((char*)(right_value30=(char*)come_calloc(1, sizeof(char)*(1*(self->size)), "libcomelang2.c", 778))));
        ...
        self->buf=(char*)come_increment_ref_count(((char*)(right_value31=(char*)come_calloc(1, sizeof(char)*(1*(new_size_66)), "libcomelang2.c", 782))));
...
memset(&right_value33, 0, sizeof(void*));
    ...
    if(_if_conditional75=self->len+size_68+1+1>=self->size,    _if_conditional75) {
        old_buf_69=(char*)come_increment_ref_count(((char*)(right_value32=(char*)come_calloc(1, sizeof(char)*(1*(self->size)), "libcomelang2.c", 805))));
        ...
        self->buf=(char*)come_increment_ref_count(((char*)(right_value33=(char*)come_calloc(1, sizeof(char)*(1*(new_size_71)), "libcomelang2.c", 809))));
...
memset(&i_74, 0, sizeof(int));
    ...
    len_72=self->len;
    len_72=(len_72+3)&~3;
    if(_if_conditional77=len_72>=self->size,    _if_conditional77) {
        new_size_73=(self->size+1+1)*2;
        __dec_obj15=self->buf;
        self->buf=(char*)come_increment_ref_count(((char*)(right_value34=(char*)come_calloc(1, sizeof(char)*(1*(new_size_73)), "libcomelang2.c", 833))));
...
memset(&right_value42, 0, sizeof(void*));
    if(_if_conditional78=left==((void*)0)&&right==((void*)0),    _if_conditional78) {
        __result65__ = __result_obj__ = ((struct optional$2intbool*)(right_value36=optional$2intbool_initialize(((struct optional$2intbool*)(right_value35=(struct optional$2intbool*)come_calloc(1, sizeof(struct optional$2intbool)*(1), "libcomelang2.c", 849))),0,(_Bool)0)));
        ...
        if(_if_conditional79=left==((void*)0),        _if_conditional79) {
            __result66__ = __result_obj__ = ((struct optional$2intbool*)(right_value38=optional$2intbool_initialize(((struct optional$2intbool*)(right_value37=(struct optional$2intbool*)come_calloc(1, sizeof(struct optional$2intbool)*(1), "libcomelang2.c", 852))),-1,(_Bool)0)));
            ...
            if(_if_conditional80=right==((void*)0),            _if_conditional80) {
                __result67__ = __result_obj__ = ((struct optional$2intbool*)(right_value40=optional$2intbool_initialize(((struct optional$2intbool*)(right_value39=(struct optional$2intbool*)come_calloc(1, sizeof(struct optional$2intbool)*(1), "libcomelang2.c", 855))),1,(_Bool)0)));
    ...
    __result68__ = __result_obj__ = ((struct optional$2intbool*)(right_value42=optional$2intbool_initialize((struct optional$2intbool*)come_increment_ref_count(((struct optional$2intbool*)(right_value41=(struct optional$2intbool*)come_calloc(1, sizeof(struct optional$2intbool)*(1), "libcomelang2.c", 858)))),strcmp(left->buf,right->buf),(_Bool)1)));
...
memset(&result_75, 0, sizeof(struct buffer*));
    result_75=(struct buffer*)come_increment_ref_count(((struct buffer*)(right_value44=buffer_initialize((struct buffer*)come_increment_ref_count(((struct buffer*)(right_value43=(struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "libcomelang2.c", 863))))))));
...
memset(&result_76, 0, sizeof(struct buffer*));
    result_76=(struct buffer*)come_increment_ref_count(((struct buffer*)(right_value46=buffer_initialize((struct buffer*)come_increment_ref_count(((struct buffer*)(right_value45=(struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "libcomelang2.c", 876))))))));
...
memset(&right_value56, 0, sizeof(void*));
    if(_if_conditional84=self==((void*)0)&&right==((void*)0),    _if_conditional84) {
        __result84__ = __result_obj__ = ((struct optional$2boolbool*)(right_value50=optional$2boolbool_initialize(((struct optional$2boolbool*)(right_value49=(struct optional$2boolbool*)come_calloc(1, sizeof(struct optional$2boolbool)*(1), "libcomelang2.c", 942))),(_Bool)1,(_Bool)0)));
        ...
        if(_if_conditional85=self==((void*)0),        _if_conditional85) {
            __result85__ = __result_obj__ = ((struct optional$2boolbool*)(right_value52=optional$2boolbool_initialize(((struct optional$2boolbool*)(right_value51=(struct optional$2boolbool*)come_calloc(1, sizeof(struct optional$2boolbool)*(1), "libcomelang2.c", 945))),(_Bool)0,(_Bool)0)));
            ...
            if(_if_conditional86=right==((void*)0),            _if_conditional86) {
                __result86__ = __result_obj__ = ((struct optional$2boolbool*)(right_value54=optional$2boolbool_initialize(((struct optional$2boolbool*)(right_value53=(struct optional$2boolbool*)come_calloc(1, sizeof(struct optional$2boolbool)*(1), "libcomelang2.c", 948))),(_Bool)0,(_Bool)0)));
    ...
    __result87__ = __result_obj__ = ((struct optional$2intbool*)(right_value56=optional$2intbool_initialize((struct optional$2intbool*)come_increment_ref_count(((struct optional$2intbool*)(right_value55=(struct optional$2intbool*)come_calloc(1, sizeof(struct optional$2intbool)*(1), "libcomelang2.c", 951)))),strcmp(self,right)==0,(_Bool)1)));
...
memset(&right_value64, 0, sizeof(void*));
    if(_if_conditional87=self==((void*)0)&&right==((void*)0),    _if_conditional87) {
        __result88__ = __result_obj__ = ((struct optional$2boolbool*)(right_value58=optional$2boolbool_initialize(((struct optional$2boolbool*)(right_value57=(struct optional$2boolbool*)come_calloc(1, sizeof(struct optional$2boolbool)*(1), "libcomelang2.c", 957))),(_Bool)1,(_Bool)0)));
        ...
        if(_if_conditional88=self==((void*)0),        _if_conditional88) {
            __result89__ = __result_obj__ = ((struct optional$2boolbool*)(right_value60=optional$2boolbool_initialize(((struct optional$2boolbool*)(right_value59=(struct optional$2boolbool*)come_calloc(1, sizeof(struct optional$2boolbool)*(1), "libcomelang2.c", 960))),(_Bool)0,(_Bool)0)));
            ...
            if(_if_conditional89=right==((void*)0),            _if_conditional89) {
                __result90__ = __result_obj__ = ((struct optional$2boolbool*)(right_value62=optional$2boolbool_initialize(((struct optional$2boolbool*)(right_value61=(struct optional$2boolbool*)come_calloc(1, sizeof(struct optional$2boolbool)*(1), "libcomelang2.c", 963))),(_Bool)0,(_Bool)0)));
    ...
    __result91__ = __result_obj__ = ((struct optional$2intbool*)(right_value64=optional$2intbool_initialize((struct optional$2intbool*)come_increment_ref_count(((struct optional$2intbool*)(right_value63=(struct optional$2intbool*)come_calloc(1, sizeof(struct optional$2intbool)*(1), "libcomelang2.c", 966)))),strcmp(self,right)==0,(_Bool)1)));
...
memset(&result_78, 0, sizeof(char*));
    ...
    result_78=(char*)come_increment_ref_count(((char*)(right_value66=(char*)come_calloc(1, sizeof(char)*(1*(len_77+1)), "libcomelang2.c", 1037))));
...
memset(&result_80, 0, sizeof(char*));
    ...
    result_80=(char*)come_increment_ref_count(((char*)(right_value68=(char*)come_calloc(1, sizeof(char)*(1*(len_79+1)), "libcomelang2.c", 1052))));
...
memset(&right_value72, 0, sizeof(void*));
    ...
    buf_81=(struct buffer*)come_increment_ref_count(((struct buffer*)(right_value71=buffer_initialize((struct buffer*)come_increment_ref_count(((struct buffer*)(right_value70=(struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "libcomelang2.c", 1065))))))));
...
memset(&right_value76, 0, sizeof(void*));
    ...
    buf_83=(struct buffer*)come_increment_ref_count(((struct buffer*)(right_value75=buffer_initialize((struct buffer*)come_increment_ref_count(((struct buffer*)(right_value74=(struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "libcomelang2.c", 1079))))))));
...
memset(&i_95, 0, sizeof(int));
    ...
    len_93=strlen(str);
    result_94=(char*)come_increment_ref_count(((char*)(right_value80=(char*)come_calloc(1, sizeof(char)*(1*(len_93+1)), "libcomelang2.c", 1296))));
...
memset(&i_98, 0, sizeof(int));
    ...
    len_96=strlen(str);
    result_97=(char*)come_increment_ref_count(((char*)(right_value82=(char*)come_calloc(1, sizeof(char)*(1*(len_96+1)), "libcomelang2.c", 1313))));
...
memset(&result_100, 0, sizeof(char*));
    ...
    if(_if_conditional119=tail>=len_99,    _if_conditional119) {
        tail=len_99;
    }
    ...
    result_100=(char*)come_increment_ref_count(((char*)(right_value88=(char*)come_calloc(1, sizeof(char)*(1*(tail-head+1)), "libcomelang2.c", 1358))));
...
memset(&result_102, 0, sizeof(char*));
    ...
    result_102=(char*)come_increment_ref_count(((char*)(right_value94=(char*)come_calloc(1, sizeof(char)*(1*(tail-head+1)), "libcomelang2.c", 1401))));
...
memset(&result_104, 0, sizeof(char*));
    ...
    result_104=(char*)come_increment_ref_count(((char*)(right_value100=(char*)come_calloc(1, sizeof(char)*(1*(tail-head+1)), "libcomelang2.c", 1444))));
...
memset(&result_106, 0, sizeof(char*));
    ...
    result_106=(char*)come_increment_ref_count(((char*)(right_value106=(char*)come_calloc(1, sizeof(char)*(1*(tail-head+1)), "libcomelang2.c", 1487))));
...
memset(&result2_110, 0, sizeof(char*));
    ...
    if(_if_conditional147=len_109<0,    _if_conditional147) {
...
memset(&right_value114, 0, sizeof(void*));
    ...
    if(_if_conditional154=tail>=len_111,    _if_conditional154) {
        tail=len_111;
    }
...
memset(&right_value119, 0, sizeof(void*));
    ...
    if(_if_conditional161=tail>=len_113,    _if_conditional161) {
        tail=len_113;
    }
...
memset(&right_value130, 0, sizeof(void*));
    if(_if_conditional162=self==((void*)0),    _if_conditional162) {
        __result190__ = __result_obj__ = ((struct list$1charph*)(right_value121=list$1charph_initialize((struct list$1charph*)come_increment_ref_count(((struct list$1charph*)(right_value120=(struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "libcomelang2.c", 1598)))))));
    ...
    result_117=(struct list$1charph*)come_increment_ref_count(((struct list$1charph*)(right_value123=list$1charph_initialize((struct list$1charph*)come_increment_ref_count(((struct list$1charph*)(right_value122=(struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "libcomelang2.c", 1601))))))));
    ...
    __freed_obj__ = 0;
    str_118=(struct buffer*)come_increment_ref_count(((struct buffer*)(right_value125=buffer_initialize((struct buffer*)come_increment_ref_count(((struct buffer*)(right_value124=(struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "libcomelang2.c", 1603))))))));
    ...
    i_119=0 ,    0;    _for_condtionalA10=    i_119<charp_length(self) ,    _for_condtionalA10;    i_119++ ,    0    ){
        if(_if_conditional164=self[i_119]==c,        _if_conditional164) {
    ...
    if(_if_conditional167=buffer_length(str_118)!=0,    _if_conditional167) {
...
memset(&right_value138, 0, sizeof(void*));
    if(_if_conditional168=self==((void*)0),    _if_conditional168) {
        __result193__ = __result_obj__ = ((struct list$1charph*)(right_value132=list$1charph_initialize((struct list$1charph*)come_increment_ref_count(((struct list$1charph*)(right_value131=(struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "libcomelang2.c", 1624)))))));
    ...
    result_123=(struct list$1charph*)come_increment_ref_count(((struct list$1charph*)(right_value134=list$1charph_initialize((struct list$1charph*)come_increment_ref_count(((struct list$1charph*)(right_value133=(struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "libcomelang2.c", 1627))))))));
    ...
    __freed_obj__ = 0;
    str_124=(struct buffer*)come_increment_ref_count(((struct buffer*)(right_value136=buffer_initialize((struct buffer*)come_increment_ref_count(((struct buffer*)(right_value135=(struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "libcomelang2.c", 1629))))))));
    ...
    i_125=0 ,    0;    _for_condtionalA11=    i_125<charp_length(self) ,    _for_condtionalA11;    i_125++ ,    0    ){
        if(_if_conditional169=self[i_125]==c,        _if_conditional169) {
    ...
    if(_if_conditional170=buffer_length(str_124)!=0,    _if_conditional170) {
...
memset(&right_value142, 0, sizeof(void*));
    ...
    while(_while_condtional6=p_126>=path,    _while_condtional6) {
        if(_if_conditional172=*p_126==47,        _if_conditional172) {
            break;
        }
        else {
            p_126--;
    ...
    if(_if_conditional173=p_126<path,    _if_conditional173) {
...
memset(&right_value150, 0, sizeof(void*));
    ...
    while(_while_condtional7=p_128>=path2_127,    _while_condtional7) {
        if(_if_conditional176=*p_128==46,        _if_conditional176) {
            break;
        }
        else {
            p_128--;
    ...
    if(_if_conditional177=p_128<path2_127,    _if_conditional177) {
...
memset(&right_value154, 0, sizeof(void*));
    ...
    while(_while_condtional8=p_129>=path,    _while_condtional8) {
        if(_if_conditional179=*p_129==46,        _if_conditional179) {
            break;
        }
        else {
            p_129--;
    ...
    if(_if_conditional180=p_129<path,    _if_conditional180) {
...
memset(&right_value177, 0, sizeof(void*));
    if(_if_conditional208=f==((void*)0),    _if_conditional208) {
        __result266__ = __result_obj__ = ((struct optional$2charphbool*)(right_value172=optional$2charphbool_initialize(((struct optional$2charphbool*)(right_value171=(struct optional$2charphbool*)come_calloc(1, sizeof(struct optional$2charphbool)*(1), "libcomelang2.c", 1978))),(char*)come_increment_ref_count(((char*)(right_value170=__builtin_string("")))),(_Bool)0)));
    ...
    buf_132=(struct buffer*)come_increment_ref_count(((struct buffer*)(right_value174=buffer_initialize((struct buffer*)come_increment_ref_count(((struct buffer*)(right_value173=(struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "libcomelang2.c", 1980))))))));
    ...
    while(_while_condtional9=1,    _while_condtional9) {
        ...
        if(_if_conditional210=size_134<8192,        _if_conditional210) {
            break;
        }
    }
    __result267__ = __result_obj__ = ((struct optional$2charphbool*)(right_value177=optional$2charphbool_initialize((struct optional$2charphbool*)come_increment_ref_count(((struct optional$2charphbool*)(right_value176=(struct optional$2charphbool*)come_calloc(1, sizeof(struct optional$2charphbool)*(1), "libcomelang2.c", 1994)))),(char*)come_increment_ref_count(((char*)(right_value175=buffer_to_string(buf_132)))),(_Bool)1)));
...
memset(&right_value181, 0, sizeof(void*));
    if(_if_conditional211=f==((void*)0)||str==((void*)0),    _if_conditional211) {
        __result268__ = __result_obj__ = ((struct optional$2intbool*)(right_value179=optional$2intbool_initialize(((struct optional$2intbool*)(right_value178=(struct optional$2intbool*)come_calloc(1, sizeof(struct optional$2intbool)*(1), "libcomelang2.c", 2000))),-1,(_Bool)0)));
    ...
    __result269__ = __result_obj__ = ((struct optional$2intbool*)(right_value181=optional$2intbool_initialize((struct optional$2intbool*)come_increment_ref_count(((struct optional$2intbool*)(right_value180=(struct optional$2intbool*)come_calloc(1, sizeof(struct optional$2intbool)*(1), "libcomelang2.c", 2003)))),fwrite(str,strlen(str),1,f),(_Bool)1)));
...
memset(&right_value187, 0, sizeof(void*));
    if(_if_conditional212=f==((void*)0),    _if_conditional212) {
        __result270__ = __result_obj__ = ((struct optional$2intbool*)(right_value183=optional$2intbool_initialize(((struct optional$2intbool*)(right_value182=(struct optional$2intbool*)come_calloc(1, sizeof(struct optional$2intbool)*(1), "libcomelang2.c", 2009))),-1,(_Bool)0)));
    ...
    result_135=fclose(f);
    if(_if_conditional213=result_135<0,    _if_conditional213) {
        __result271__ = __result_obj__ = ((struct optional$2intbool*)(right_value185=optional$2intbool_initialize(((struct optional$2intbool*)(right_value184=(struct optional$2intbool*)come_calloc(1, sizeof(struct optional$2intbool)*(1), "libcomelang2.c", 2015))),result_135,(_Bool)0)));
    ...
    __result272__ = __result_obj__ = ((struct optional$2intbool*)(right_value187=optional$2intbool_initialize((struct optional$2intbool*)come_increment_ref_count(((struct optional$2intbool*)(right_value186=(struct optional$2intbool*)come_calloc(1, sizeof(struct optional$2intbool)*(1), "libcomelang2.c", 2018)))),result_135,(_Bool)1)));
...
memset(&right_value193, 0, sizeof(void*));
    if(_if_conditional214=f==((void*)0)||msg==((void*)0),    _if_conditional214) {
        __result274__ = __result_obj__ = ((struct optional$2_IO_FILEpbool*)(right_value189=optional$2_IO_FILEpbool_initialize(((struct optional$2_IO_FILEpbool*)(right_value188=(struct optional$2_IO_FILEpbool*)come_calloc(1, sizeof(struct optional$2_IO_FILEpbool)*(1), "libcomelang2.c", 2024))),f,(_Bool)0)));
    ...
    if(_if_conditional215=result_138<0,    _if_conditional215) {
        __result275__ = __result_obj__ = ((struct optional$2intbool*)(right_value191=optional$2intbool_initialize(((struct optional$2intbool*)(right_value190=(struct optional$2intbool*)come_calloc(1, sizeof(struct optional$2intbool)*(1), "libcomelang2.c", 2036))),result_138,(_Bool)0)));
...
memset(&right_value203, 0, sizeof(void*));
    if(_if_conditional216=self==((void*)0)||file_name==((void*)0),    _if_conditional216) {
        __result277__ = __result_obj__ = ((struct optional$2intbool*)(right_value195=optional$2intbool_initialize(((struct optional$2intbool*)(right_value194=(struct optional$2intbool*)come_calloc(1, sizeof(struct optional$2intbool)*(1), "libcomelang2.c", 2045))),-1,(_Bool)0)));
    ...
    if(_if_conditional218=f_139==((void*)0),    _if_conditional218) {
        __result278__ = __result_obj__ = ((struct optional$2intbool*)(right_value197=optional$2intbool_initialize(((struct optional$2intbool*)(right_value196=(struct optional$2intbool*)come_calloc(1, sizeof(struct optional$2intbool)*(1), "libcomelang2.c", 2057))),-1,(_Bool)0)));
    ...
    if(_if_conditional219=result_140<0,    _if_conditional219) {
        __result279__ = __result_obj__ = ((struct optional$2intbool*)(right_value199=optional$2intbool_initialize(((struct optional$2intbool*)(right_value198=(struct optional$2intbool*)come_calloc(1, sizeof(struct optional$2intbool)*(1), "libcomelang2.c", 2063))),result_140,(_Bool)0)));
    ...
    if(_if_conditional220=result2_141<0,    _if_conditional220) {
        __result280__ = __result_obj__ = ((struct optional$2intbool*)(right_value201=optional$2intbool_initialize(((struct optional$2intbool*)(right_value200=(struct optional$2intbool*)come_calloc(1, sizeof(struct optional$2intbool)*(1), "libcomelang2.c", 2069))),result2_141,(_Bool)0)));
    ...
    __result281__ = __result_obj__ = ((struct optional$2intbool*)(right_value203=optional$2intbool_initialize((struct optional$2intbool*)come_increment_ref_count(((struct optional$2intbool*)(right_value202=(struct optional$2intbool*)come_calloc(1, sizeof(struct optional$2intbool)*(1), "libcomelang2.c", 2072)))),result_140,(_Bool)1)));
...
memset(&right_value213, 0, sizeof(void*));
    if(_if_conditional221=self==((void*)0)||file_name==((void*)0),    _if_conditional221) {
        __result282__ = __result_obj__ = ((struct optional$2intbool*)(right_value205=optional$2intbool_initialize(((struct optional$2intbool*)(right_value204=(struct optional$2intbool*)come_calloc(1, sizeof(struct optional$2intbool)*(1), "libcomelang2.c", 2078))),-1,(_Bool)0)));
    ...
    if(_if_conditional223=f_142==((void*)0),    _if_conditional223) {
        __result283__ = __result_obj__ = ((struct optional$2intbool*)(right_value207=optional$2intbool_initialize(((struct optional$2intbool*)(right_value206=(struct optional$2intbool*)come_calloc(1, sizeof(struct optional$2intbool)*(1), "libcomelang2.c", 2090))),-1,(_Bool)0)));
    ...
    if(_if_conditional224=result_143<0,    _if_conditional224) {
        __result284__ = __result_obj__ = ((struct optional$2intbool*)(right_value209=optional$2intbool_initialize(((struct optional$2intbool*)(right_value208=(struct optional$2intbool*)come_calloc(1, sizeof(struct optional$2intbool)*(1), "libcomelang2.c", 2096))),result_143,(_Bool)0)));
    ...
    if(_if_conditional225=result2_144<0,    _if_conditional225) {
        __result285__ = __result_obj__ = ((struct optional$2intbool*)(right_value211=optional$2intbool_initialize(((struct optional$2intbool*)(right_value210=(struct optional$2intbool*)come_calloc(1, sizeof(struct optional$2intbool)*(1), "libcomelang2.c", 2102))),result2_144,(_Bool)0)));
    ...
    __result286__ = __result_obj__ = ((struct optional$2intbool*)(right_value213=optional$2intbool_initialize((struct optional$2intbool*)come_increment_ref_count(((struct optional$2intbool*)(right_value212=(struct optional$2intbool*)come_calloc(1, sizeof(struct optional$2intbool)*(1), "libcomelang2.c", 2105)))),result_143,(_Bool)1)));
...
memset(&right_value227, 0, sizeof(void*));
    if(_if_conditional226=file_name==((void*)0),    _if_conditional226) {
        __result287__ = __result_obj__ = ((struct optional$2charphbool*)(right_value216=optional$2charphbool_initialize(((struct optional$2charphbool*)(right_value215=(struct optional$2charphbool*)come_calloc(1, sizeof(struct optional$2charphbool)*(1), "libcomelang2.c", 2111))),(char*)come_increment_ref_count(((char*)(right_value214=__builtin_string("")))),(_Bool)0)));
    ...
    if(_if_conditional227=f_145==((void*)0),    _if_conditional227) {
        __result288__ = __result_obj__ = ((struct optional$2charphbool*)(right_value219=optional$2charphbool_initialize(((struct optional$2charphbool*)(right_value218=(struct optional$2charphbool*)come_calloc(1, sizeof(struct optional$2charphbool)*(1), "libcomelang2.c", 2117))),(char*)come_increment_ref_count(((char*)(right_value217=__builtin_string("")))),(_Bool)0)));
    ...
    buf_146=(struct buffer*)come_increment_ref_count(((struct buffer*)(right_value221=buffer_initialize((struct buffer*)come_increment_ref_count(((struct buffer*)(right_value220=(struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "libcomelang2.c", 2120))))))));
    ...
    if(_if_conditional229=result2_150<0,    _if_conditional229) {
        __result289__ = __result_obj__ = ((struct optional$2charphbool*)(right_value225=optional$2charphbool_initialize(((struct optional$2charphbool*)(right_value224=(struct optional$2charphbool*)come_calloc(1, sizeof(struct optional$2charphbool)*(1), "libcomelang2.c", 2139))),(char*)come_increment_ref_count(((char*)(right_value223=__builtin_string("")))),(_Bool)0)));
    ...
    __result290__ = __result_obj__ = ((struct optional$2charphbool*)(right_value227=optional$2charphbool_initialize((struct optional$2charphbool*)come_increment_ref_count(((struct optional$2charphbool*)(right_value226=(struct optional$2charphbool*)come_calloc(1, sizeof(struct optional$2charphbool)*(1), "libcomelang2.c", 2142)))),(char*)come_increment_ref_count(result_149),(_Bool)1)));
    if(buf_146 && !__freed_obj__) { come_call_finalizer(buffer_finalize,buf_146, (void*)0, (void*)0, 0, 0, 0, 0); }
    if(result_149 && !__freed_obj__) { result_149 = come_decrement_ref_count(result_149, (void*)0, (void*)0, 0, 0, 0); }
...
memset(&right_value241, 0, sizeof(void*));
    if(_if_conditional230=file_name==((void*)0),    _if_conditional230) {
        __result291__ = __result_obj__ = ((struct optional$2charphbool*)(right_value230=optional$2charphbool_initialize(((struct optional$2charphbool*)(right_value229=(struct optional$2charphbool*)come_calloc(1, sizeof(struct optional$2charphbool)*(1), "libcomelang2.c", 2148))),(char*)come_increment_ref_count(((char*)(right_value228=__builtin_string("")))),(_Bool)0)));
    ...
    if(_if_conditional231=f_151==((void*)0),    _if_conditional231) {
        __result292__ = __result_obj__ = ((struct optional$2charphbool*)(right_value233=optional$2charphbool_initialize(((struct optional$2charphbool*)(right_value232=(struct optional$2charphbool*)come_calloc(1, sizeof(struct optional$2charphbool)*(1), "libcomelang2.c", 2154))),(char*)come_increment_ref_count(((char*)(right_value231=__builtin_string("")))),(_Bool)0)));
    ...
    buf_152=(struct buffer*)come_increment_ref_count(((struct buffer*)(right_value235=buffer_initialize((struct buffer*)come_increment_ref_count(((struct buffer*)(right_value234=(struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "libcomelang2.c", 2157))))))));
    ...
    while(_while_condtional11=1,    _while_condtional11) {
        ...
        if(_if_conditional232=size_154<8192,        _if_conditional232) {
            break;
        }
    }
    ...
    if(_if_conditional233=result2_156<0,    _if_conditional233) {
        __result293__ = __result_obj__ = ((struct optional$2charphbool*)(right_value239=optional$2charphbool_initialize(((struct optional$2charphbool*)(right_value238=(struct optional$2charphbool*)come_calloc(1, sizeof(struct optional$2charphbool)*(1), "libcomelang2.c", 2176))),(char*)come_increment_ref_count(((char*)(right_value237=__builtin_string("")))),(_Bool)0)));
    ...
    __result294__ = __result_obj__ = ((struct optional$2charphbool*)(right_value241=optional$2charphbool_initialize((struct optional$2charphbool*)come_increment_ref_count(((struct optional$2charphbool*)(right_value240=(struct optional$2charphbool*)come_calloc(1, sizeof(struct optional$2charphbool)*(1), "libcomelang2.c", 2179)))),(char*)come_increment_ref_count(result_155),(_Bool)1)));
    if(buf_152 && !__freed_obj__) { come_call_finalizer(buffer_finalize,buf_152, (void*)0, (void*)0, 0, 0, 0, 0); }
    if(result_155 && !__freed_obj__) { result_155 = come_decrement_ref_count(result_155, (void*)0, (void*)0, 0, 0, 0); }
...
memset(&right_value248, 0, sizeof(void*));
    result_157=(struct list$1charph*)come_increment_ref_count(((struct list$1charph*)(right_value243=list$1charph_initialize((struct list$1charph*)come_increment_ref_count(((struct list$1charph*)(right_value242=(struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "libcomelang2.c", 2184))))))));
    ...
    if(_if_conditional234=f==((void*)0),    _if_conditional234) {
        __result296__ = __result_obj__ = ((struct optional$2list$1charphphbool*)(right_value245=optional$2list$1charphphbool_initialize(((struct optional$2list$1charphphbool*)(right_value244=(struct optional$2list$1charphphbool*)come_calloc(1, sizeof(struct optional$2list$1charphphbool)*(1), "libcomelang2.c", 2187))),(struct list$1charph*)come_increment_ref_count(result_157),(_Bool)0)));
    ...
    while(_while_condtional12=1,    _while_condtional12) {
        ...
        if(_if_conditional236=fgets(buf_158,8192,f)==((void*)0),        _if_conditional236) {
            break;
        }
    ...
    __result297__ = __result_obj__ = ((struct optional$2list$1charphphbool*)(right_value248=optional$2list$1charphphbool_initialize((struct optional$2list$1charphphbool*)come_increment_ref_count(((struct optional$2list$1charphphbool*)(right_value247=(struct optional$2list$1charphphbool*)come_calloc(1, sizeof(struct optional$2list$1charphphbool)*(1), "libcomelang2.c", 2200)))),(struct list$1charph*)come_increment_ref_count(result_157),(_Bool)1)));
    if(result_157 && !__freed_obj__) { come_call_finalizer(list$1charphp_finalize,result_157, (void*)0, (void*)0, 0, 0, 0, 0); }
...
memset(&right_value256, 0, sizeof(void*));
    if(_if_conditional237=path==((void*)0)||mode==((void*)0),    _if_conditional237) {
        __result298__ = __result_obj__ = ((struct optional$2intbool*)(right_value250=optional$2intbool_initialize(((struct optional$2intbool*)(right_value249=(struct optional$2intbool*)come_calloc(1, sizeof(struct optional$2intbool)*(1), "libcomelang2.c", 2206))),-1,(_Bool)0)));
    ...
    if(_if_conditional238=f_159,    _if_conditional238) {
        block(parent,f_159);
        if(_if_conditional239=((struct sDummyCurrentStack*)parent)->__method_block_result_kind__!=0,        _if_conditional239) {
            fclose(f_159);
            __result299__ = __result_obj__ = ((struct optional$2intbool*)(right_value252=optional$2intbool_initialize((struct optional$2intbool*)come_increment_ref_count(((struct optional$2intbool*)(right_value251=(struct optional$2intbool*)come_calloc(1, sizeof(struct optional$2intbool)*(1), "libcomelang2.c", 2214)))),0,(_Bool)1)));
        ...
        fclose(f_159);
        __result300__ = __result_obj__ = ((struct optional$2intbool*)(right_value254=optional$2intbool_initialize((struct optional$2intbool*)come_increment_ref_count(((struct optional$2intbool*)(right_value253=(struct optional$2intbool*)come_calloc(1, sizeof(struct optional$2intbool)*(1), "libcomelang2.c", 2219)))),0,(_Bool)1)));
    ...
    __result301__ = __result_obj__ = ((struct optional$2intbool*)(right_value256=optional$2intbool_initialize(((struct optional$2intbool*)(right_value255=(struct optional$2intbool*)come_calloc(1, sizeof(struct optional$2intbool)*(1), "libcomelang2.c", 2222))),-1,(_Bool)0)));
...
memset(&right_value261, 0, sizeof(void*));
    if(_if_conditional240=self==((void*)0),    _if_conditional240) {
        __result302__ = __result_obj__ = ((struct optional$2intbool*)(right_value258=optional$2intbool_initialize(((struct optional$2intbool*)(right_value257=(struct optional$2intbool*)come_calloc(1, sizeof(struct optional$2intbool)*(1), "libcomelang2.c", 2231))),-1,(_Bool)0)));
    ...
    puts(self);
    __result303__ = __result_obj__ = ((struct optional$2charphbool*)(right_value261=optional$2charphbool_initialize((struct optional$2charphbool*)come_increment_ref_count(((struct optional$2charphbool*)(right_value260=(struct optional$2charphbool*)come_calloc(1, sizeof(struct optional$2charphbool)*(1), "libcomelang2.c", 2235)))),(char*)come_increment_ref_count(((char*)(right_value259=__builtin_string(self)))),(_Bool)1)));
...
memset(&right_value266, 0, sizeof(void*));
    if(_if_conditional241=self==((void*)0),    _if_conditional241) {
        __result304__ = __result_obj__ = ((struct optional$2intbool*)(right_value263=optional$2intbool_initialize(((struct optional$2intbool*)(right_value262=(struct optional$2intbool*)come_calloc(1, sizeof(struct optional$2intbool)*(1), "libcomelang2.c", 2241))),-1,(_Bool)0)));
    ...
    printf("%s",self);
    __result305__ = __result_obj__ = ((struct optional$2charphbool*)(right_value266=optional$2charphbool_initialize((struct optional$2charphbool*)come_increment_ref_count(((struct optional$2charphbool*)(right_value265=(struct optional$2charphbool*)come_calloc(1, sizeof(struct optional$2charphbool)*(1), "libcomelang2.c", 2245)))),(char*)come_increment_ref_count(((char*)(right_value264=__builtin_string(self)))),(_Bool)1)));
...
memset(&right_value272, 0, sizeof(void*));
    if(_if_conditional242=self==((void*)0),    _if_conditional242) {
        __result306__ = __result_obj__ = ((struct optional$2charphbool*)(right_value269=optional$2charphbool_initialize(((struct optional$2charphbool*)(right_value268=(struct optional$2charphbool*)come_calloc(1, sizeof(struct optional$2charphbool)*(1), "libcomelang2.c", 2252))),(char*)come_increment_ref_count(((char*)(right_value267=__builtin_string("")))),(_Bool)0)));
    ...
    printf("%s",msg2_160);
    free(msg2_160);
    __result307__ = __result_obj__ = ((struct optional$2charphbool*)(right_value272=optional$2charphbool_initialize((struct optional$2charphbool*)come_increment_ref_count(((struct optional$2charphbool*)(right_value271=(struct optional$2charphbool*)come_calloc(1, sizeof(struct optional$2charphbool)*(1), "libcomelang2.c", 2265)))),(char*)come_increment_ref_count(((char*)(right_value270=__builtin_string(self)))),(_Bool)1)));
...
memset(&right_value278, 0, sizeof(void*));
    if(_if_conditional243=self==((void*)0),    _if_conditional243) {
        __result308__ = __result_obj__ = ((struct optional$2charphbool*)(right_value275=optional$2charphbool_initialize(((struct optional$2charphbool*)(right_value274=(struct optional$2charphbool*)come_calloc(1, sizeof(struct optional$2charphbool)*(1), "libcomelang2.c", 2271))),(char*)come_increment_ref_count(((char*)(right_value273=__builtin_string("")))),(_Bool)0)));
    ...
    printf("%s",msg2_162);
    free(msg2_162);
    __result309__ = __result_obj__ = ((struct optional$2charphbool*)(right_value278=optional$2charphbool_initialize((struct optional$2charphbool*)come_increment_ref_count(((struct optional$2charphbool*)(right_value277=(struct optional$2charphbool*)come_calloc(1, sizeof(struct optional$2charphbool)*(1), "libcomelang2.c", 2284)))),(char*)come_increment_ref_count(((char*)(right_value276=__builtin_string(self)))),(_Bool)1)));
...
memset(&right_value284, 0, sizeof(void*));
    if(_if_conditional244=self==((void*)0),    _if_conditional244) {
        __result311__ = __result_obj__ = ((struct optional$2charphbool*)(right_value281=optional$2charphbool_initialize(((struct optional$2charphbool*)(right_value280=(struct optional$2charphbool*)come_calloc(1, sizeof(struct optional$2charphbool)*(1), "libcomelang2.c", 2297))),(char*)come_increment_ref_count(((char*)(right_value279=__builtin_string("")))),(_Bool)0)));
    ...
    puts(self);
    __result312__ = __result_obj__ = ((struct optional$2charphbool*)(right_value284=optional$2charphbool_initialize((struct optional$2charphbool*)come_increment_ref_count(((struct optional$2charphbool*)(right_value283=(struct optional$2charphbool*)come_calloc(1, sizeof(struct optional$2charphbool)*(1), "libcomelang2.c", 2301)))),(char*)come_increment_ref_count(((char*)(right_value282=__builtin_string(self)))),(_Bool)1)));
