...
memset(&n_13, 0, sizeof(int));
    ...
    if(_if_conditional26=gComeDebugLib,    _if_conditional26) {
        ...
        while(_while_condtional1=it_8,        _while_condtional1) {
            ...
            flag_10=(_Bool)0;
            printf("#%d ",n_9);
            if(_if_conditional27=it_8->class_name,            _if_conditional27) {
                printf("(%s): ",it_8->class_name);
            }
            for(
            i_11=0 ,            0;            _for_condtionalA3=            i_11<16 ,            _for_condtionalA3;            i_11++ ,            0            ){
                if(_if_conditional28=it_8->sname[i_11],                _if_conditional28) {
    ...
    if(_if_conditional36=mem,    _if_conditional36) {
        if(_if_conditional37=gComeGCLib,        _if_conditional37) {
            ...
            if(_if_conditional38=gComeDebugLib,            _if_conditional38) {
                ...
                if(_if_conditional39=it_18->class_name,                _if_conditional39) {
...
memset(&result_32, 0, sizeof(void*));
    if(_if_conditional50=!block,    _if_conditional50) {
...
memset(&finalizer_37, 0, sizeof(void (*)(void*)));
    ...
    if(_if_conditional55=!no_free&&(count_36<=0||force_delete_),    _if_conditional55) {
...
memset(&finalizer_43, 0, sizeof(void (*)(void*)));
    if(_if_conditional57=mem==((void*)0),    _if_conditional57) {
        return;
    }
    if(_if_conditional58=call_finalizer_only,    _if_conditional58) {
        if(_if_conditional59=fun,        _if_conditional59) {
        ...
        if(_if_conditional62=!no_free&&(count_41<=0||force_delete_),        _if_conditional62) {
            if(_if_conditional63=mem,            _if_conditional63) {
                if(_if_conditional64=protocol_obj&&protocol_fun,                _if_conditional64) {
                    finalizer_42=protocol_fun;
                    finalizer_42(protocol_obj);
                    come_free_object(protocol_obj);
                }
                if(_if_conditional65=fun,                _if_conditional65) {
                    finalizer_43=fun;
                    finalizer_43(mem);
                }
                come_free_object(mem);
...
memset(&result_45, 0, sizeof(char*));
    if(_if_conditional66=str==((void*)0),    _if_conditional66) {
        __result42__ = __result_obj__ = ((void*)0);
        return __result42__;
    }
    len_44=strlen(str)+1;
    result_45=(char*)come_increment_ref_count(((char*)(right_value16=(char*)come_calloc(1, sizeof(char)*(1*(len_44)), "libcomelang2.c", 655, "char"))));
...
memset(&i_47, 0, sizeof(int));
    ...
    i_47=0 ,    0;    _for_condtionalA4=    i_47<len ,    _for_condtionalA4;    i_47++ ,    0    ){
        if(_if_conditional67=array[i_47]==element,        _if_conditional67) {
            found_46=(_Bool)1;
            break;
        }
    }
    __result44__ = found_46;
    return __result44__;
}
...
memset(&right_value17, 0, sizeof(void*));
    self->size=128;
    __dec_obj6=self->buf;
    self->buf=(char*)come_increment_ref_count(((char*)(right_value17=(char*)come_calloc(1, sizeof(char)*(1*(self->size)), "libcomelang2.c", 680, "char"))));
...
memset(&right_value19, 0, sizeof(void*));
    ...
    result_48=(struct buffer*)come_increment_ref_count(((struct buffer*)(right_value18=(struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "libcomelang2.c", 702, "struct buffer"))));
    ...
    result_48->buf=(char*)come_increment_ref_count(((char*)(right_value19=(char*)come_calloc(1, sizeof(char)*(1*(self->size)), "libcomelang2.c", 705, "char"))));
...
memset(&right_value21, 0, sizeof(void*));
    ...
    if(_if_conditional75=self->len+size+1+1>=self->size,    _if_conditional75) {
        old_buf_49=(char*)come_increment_ref_count(((char*)(right_value20=(char*)come_calloc(1, sizeof(char)*(1*(self->size)), "libcomelang2.c", 744, "char"))));
        ...
        __dec_obj8=self->buf;
        self->buf=(char*)come_increment_ref_count(((char*)(right_value21=(char*)come_calloc(1, sizeof(char)*(1*(new_size_51)), "libcomelang2.c", 748, "char"))));
...
memset(&right_value23, 0, sizeof(void*));
    ...
    if(_if_conditional77=self->len+1+1+1>=self->size,    _if_conditional77) {
        ...
        __dec_obj9=self->buf;
        self->buf=(char*)come_increment_ref_count(((char*)(right_value23=(char*)come_calloc(1, sizeof(char)*(1*(new_size_54)), "libcomelang2.c", 771, "char"))));
...
memset(&right_value25, 0, sizeof(void*));
    if(_if_conditional78=self==((void*)0)||mem==((void*)0),    _if_conditional78) {
        __result54__ = __result_obj__ = self;
        return __result54__;
    }
    size_55=strlen(mem);
    if(_if_conditional79=self->len+size_55+1+1>=self->size,    _if_conditional79) {
        old_buf_56=(char*)come_increment_ref_count(((char*)(right_value24=(char*)come_calloc(1, sizeof(char)*(1*(self->size)), "libcomelang2.c", 793, "char"))));
        ...
        self->buf=(char*)come_increment_ref_count(((char*)(right_value25=(char*)come_calloc(1, sizeof(char)*(1*(new_size_58)), "libcomelang2.c", 797, "char"))));
...
memset(&right_value27, 0, sizeof(void*));
    if(_if_conditional80=self==((void*)0)||mem==((void*)0),    _if_conditional80) {
        __result56__ = __result_obj__ = self;
        return __result56__;
    }
    size_59=strlen(mem)+1;
    if(_if_conditional81=self->len+size_59+1+1+1>=self->size,    _if_conditional81) {
        old_buf_60=(char*)come_increment_ref_count(((char*)(right_value26=(char*)come_calloc(1, sizeof(char)*(1*(self->size)), "libcomelang2.c", 817, "char"))));
        ...
        self->buf=(char*)come_increment_ref_count(((char*)(right_value27=(char*)come_calloc(1, sizeof(char)*(1*(new_size_62)), "libcomelang2.c", 821, "char"))));
...
memset(&right_value29, 0, sizeof(void*));
    ...
    mem_63=&value;
    size_64=sizeof(int);
    if(_if_conditional83=self->len+size_64+1+1>=self->size,    _if_conditional83) {
        old_buf_65=(char*)come_increment_ref_count(((char*)(right_value28=(char*)come_calloc(1, sizeof(char)*(1*(self->size)), "libcomelang2.c", 844, "char"))));
        ...
        self->buf=(char*)come_increment_ref_count(((char*)(right_value29=(char*)come_calloc(1, sizeof(char)*(1*(new_size_67)), "libcomelang2.c", 848, "char"))));
...
memset(&right_value31, 0, sizeof(void*));
    mem_68=&value;
    size_69=sizeof(long);
    if(_if_conditional84=self->len+size_69+1+1>=self->size,    _if_conditional84) {
        old_buf_70=(char*)come_increment_ref_count(((char*)(right_value30=(char*)come_calloc(1, sizeof(char)*(1*(self->size)), "libcomelang2.c", 867, "char"))));
        ...
        self->buf=(char*)come_increment_ref_count(((char*)(right_value31=(char*)come_calloc(1, sizeof(char)*(1*(new_size_72)), "libcomelang2.c", 871, "char"))));
...
memset(&right_value33, 0, sizeof(void*));
    ...
    if(_if_conditional86=self->len+size_74+1+1>=self->size,    _if_conditional86) {
        old_buf_75=(char*)come_increment_ref_count(((char*)(right_value32=(char*)come_calloc(1, sizeof(char)*(1*(self->size)), "libcomelang2.c", 894, "char"))));
        ...
        self->buf=(char*)come_increment_ref_count(((char*)(right_value33=(char*)come_calloc(1, sizeof(char)*(1*(new_size_77)), "libcomelang2.c", 898, "char"))));
...
memset(&i_80, 0, sizeof(int));
    ...
    len_78=self->len;
    len_78=(len_78+3)&~3;
    if(_if_conditional88=len_78>=self->size,    _if_conditional88) {
        new_size_79=(self->size+1+1)*2;
        __dec_obj15=self->buf;
        self->buf=(char*)come_increment_ref_count(((char*)(right_value34=(char*)come_calloc(1, sizeof(char)*(1*(new_size_79)), "libcomelang2.c", 922, "char"))));
...
memset(&right_value42, 0, sizeof(void*));
    if(_if_conditional89=left==((void*)0)&&right==((void*)0),    _if_conditional89) {
        __result66__ = __result_obj__ = ((struct optional$2intbool*)(right_value36=optional$2intbool_initialize(((struct optional$2intbool*)(right_value35=(struct optional$2intbool*)come_calloc(1, sizeof(struct optional$2intbool)*(1), "libcomelang2.c", 938, "struct optional$2intbool"))),0,(_Bool)0)));
        ...
        if(_if_conditional90=left==((void*)0),        _if_conditional90) {
            __result67__ = __result_obj__ = ((struct optional$2intbool*)(right_value38=optional$2intbool_initialize(((struct optional$2intbool*)(right_value37=(struct optional$2intbool*)come_calloc(1, sizeof(struct optional$2intbool)*(1), "libcomelang2.c", 941, "struct optional$2intbool"))),-1,(_Bool)0)));
            ...
            if(_if_conditional91=right==((void*)0),            _if_conditional91) {
                __result68__ = __result_obj__ = ((struct optional$2intbool*)(right_value40=optional$2intbool_initialize(((struct optional$2intbool*)(right_value39=(struct optional$2intbool*)come_calloc(1, sizeof(struct optional$2intbool)*(1), "libcomelang2.c", 944, "struct optional$2intbool"))),1,(_Bool)0)));
    ...
    __result69__ = __result_obj__ = ((struct optional$2intbool*)(right_value42=optional$2intbool_initialize((struct optional$2intbool*)come_increment_ref_count(((struct optional$2intbool*)(right_value41=(struct optional$2intbool*)come_calloc(1, sizeof(struct optional$2intbool)*(1), "libcomelang2.c", 947, "struct optional$2intbool")))),strcmp(left->buf,right->buf),(_Bool)1)));
...
memset(&result_81, 0, sizeof(struct buffer*));
    result_81=(struct buffer*)come_increment_ref_count(((struct buffer*)(right_value44=buffer_initialize((struct buffer*)come_increment_ref_count(((struct buffer*)(right_value43=(struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "libcomelang2.c", 952, "struct buffer"))))))));
    ...
    __result71__ = __result_obj__ = result_81;
    if(result_81 && !__freed_obj__) { come_call_finalizer(buffer_finalize,result_81, (void*)0, (void*)0, 0, 0, 1, 0); }
    return __result71__;
...
memset(&result_82, 0, sizeof(struct buffer*));
    result_82=(struct buffer*)come_increment_ref_count(((struct buffer*)(right_value46=buffer_initialize((struct buffer*)come_increment_ref_count(((struct buffer*)(right_value45=(struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "libcomelang2.c", 965, "struct buffer"))))))));
    ...
    __result73__ = __result_obj__ = result_82;
    if(result_82 && !__freed_obj__) { come_call_finalizer(buffer_finalize,result_82, (void*)0, (void*)0, 0, 0, 1, 0); }
    return __result73__;
...
memset(&right_value56, 0, sizeof(void*));
    if(_if_conditional95=self==((void*)0)&&right==((void*)0),    _if_conditional95) {
        __result85__ = __result_obj__ = ((struct optional$2boolbool*)(right_value50=optional$2boolbool_initialize(((struct optional$2boolbool*)(right_value49=(struct optional$2boolbool*)come_calloc(1, sizeof(struct optional$2boolbool)*(1), "libcomelang2.c", 1031, "struct optional$2boolbool"))),(_Bool)1,(_Bool)0)));
        ...
        if(_if_conditional96=self==((void*)0),        _if_conditional96) {
            __result86__ = __result_obj__ = ((struct optional$2boolbool*)(right_value52=optional$2boolbool_initialize(((struct optional$2boolbool*)(right_value51=(struct optional$2boolbool*)come_calloc(1, sizeof(struct optional$2boolbool)*(1), "libcomelang2.c", 1034, "struct optional$2boolbool"))),(_Bool)0,(_Bool)0)));
            ...
            if(_if_conditional97=right==((void*)0),            _if_conditional97) {
                __result87__ = __result_obj__ = ((struct optional$2boolbool*)(right_value54=optional$2boolbool_initialize(((struct optional$2boolbool*)(right_value53=(struct optional$2boolbool*)come_calloc(1, sizeof(struct optional$2boolbool)*(1), "libcomelang2.c", 1037, "struct optional$2boolbool"))),(_Bool)0,(_Bool)0)));
    ...
    __result88__ = __result_obj__ = ((struct optional$2intbool*)(right_value56=optional$2intbool_initialize((struct optional$2intbool*)come_increment_ref_count(((struct optional$2intbool*)(right_value55=(struct optional$2intbool*)come_calloc(1, sizeof(struct optional$2intbool)*(1), "libcomelang2.c", 1040, "struct optional$2intbool")))),strcmp(self,right)==0,(_Bool)1)));
...
memset(&right_value64, 0, sizeof(void*));
    if(_if_conditional98=self==((void*)0)&&right==((void*)0),    _if_conditional98) {
        __result89__ = __result_obj__ = ((struct optional$2boolbool*)(right_value58=optional$2boolbool_initialize(((struct optional$2boolbool*)(right_value57=(struct optional$2boolbool*)come_calloc(1, sizeof(struct optional$2boolbool)*(1), "libcomelang2.c", 1046, "struct optional$2boolbool"))),(_Bool)1,(_Bool)0)));
        ...
        if(_if_conditional99=self==((void*)0),        _if_conditional99) {
            __result90__ = __result_obj__ = ((struct optional$2boolbool*)(right_value60=optional$2boolbool_initialize(((struct optional$2boolbool*)(right_value59=(struct optional$2boolbool*)come_calloc(1, sizeof(struct optional$2boolbool)*(1), "libcomelang2.c", 1049, "struct optional$2boolbool"))),(_Bool)0,(_Bool)0)));
            ...
            if(_if_conditional100=right==((void*)0),            _if_conditional100) {
                __result91__ = __result_obj__ = ((struct optional$2boolbool*)(right_value62=optional$2boolbool_initialize(((struct optional$2boolbool*)(right_value61=(struct optional$2boolbool*)come_calloc(1, sizeof(struct optional$2boolbool)*(1), "libcomelang2.c", 1052, "struct optional$2boolbool"))),(_Bool)0,(_Bool)0)));
    ...
    __result92__ = __result_obj__ = ((struct optional$2intbool*)(right_value64=optional$2intbool_initialize((struct optional$2intbool*)come_increment_ref_count(((struct optional$2intbool*)(right_value63=(struct optional$2intbool*)come_calloc(1, sizeof(struct optional$2intbool)*(1), "libcomelang2.c", 1055, "struct optional$2intbool")))),strcmp(self,right)==0,(_Bool)1)));
...
memset(&result_84, 0, sizeof(char*));
    ...
    result_84=(char*)come_increment_ref_count(((char*)(right_value66=(char*)come_calloc(1, sizeof(char)*(1*(len_83+1)), "libcomelang2.c", 1126, "char"))));
    ...
    __result110__ = __result_obj__ = result_84;
...
memset(&result_86, 0, sizeof(char*));
    ...
    result_86=(char*)come_increment_ref_count(((char*)(right_value68=(char*)come_calloc(1, sizeof(char)*(1*(len_85+1)), "libcomelang2.c", 1141, "char"))));
    ...
    __result112__ = __result_obj__ = result_86;
...
memset(&right_value72, 0, sizeof(void*));
    ...
    buf_87=(struct buffer*)come_increment_ref_count(((struct buffer*)(right_value71=buffer_initialize((struct buffer*)come_increment_ref_count(((struct buffer*)(right_value70=(struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "libcomelang2.c", 1154, "struct buffer"))))))));
    ...
    __result114__ = __result_obj__ = ((char*)(right_value72=buffer_to_string(buf_87)));
...
memset(&right_value76, 0, sizeof(void*));
    ...
    buf_89=(struct buffer*)come_increment_ref_count(((struct buffer*)(right_value75=buffer_initialize((struct buffer*)come_increment_ref_count(((struct buffer*)(right_value74=(struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "libcomelang2.c", 1168, "struct buffer"))))))));
    ...
    __result116__ = __result_obj__ = ((char*)(right_value76=buffer_to_string(buf_89)));
...
memset(&i_101, 0, sizeof(int));
    ...
    len_99=strlen(str);
    result_100=(char*)come_increment_ref_count(((char*)(right_value80=(char*)come_calloc(1, sizeof(char)*(1*(len_99+1)), "libcomelang2.c", 1385, "char"))));
    ...
    result_100[len_99]=0;
    __result156__ = __result_obj__ = result_100;
...
memset(&i_104, 0, sizeof(int));
    ...
    len_102=strlen(str);
    result_103=(char*)come_increment_ref_count(((char*)(right_value82=(char*)come_calloc(1, sizeof(char)*(1*(len_102+1)), "libcomelang2.c", 1402, "char"))));
    ...
    __result158__ = __result_obj__ = result_103;
...
memset(&result_106, 0, sizeof(char*));
    ...
    if(_if_conditional130=tail>=len_105,    _if_conditional130) {
        tail=len_105;
    }
    ...
    result_106=(char*)come_increment_ref_count(((char*)(right_value88=(char*)come_calloc(1, sizeof(char)*(1*(tail-head+1)), "libcomelang2.c", 1447, "char"))));
    ...
    __result163__ = __result_obj__ = result_106;
...
memset(&result_108, 0, sizeof(char*));
    ...
    if(_if_conditional138=tail>=len_107,    _if_conditional138) {
        tail=len_107;
    }
    ...
    result_108=(char*)come_increment_ref_count(((char*)(right_value94=(char*)come_calloc(1, sizeof(char)*(1*(tail-head+1)), "libcomelang2.c", 1490, "char"))));
    ...
    __result168__ = __result_obj__ = result_108;
...
memset(&result_110, 0, sizeof(char*));
    if(_if_conditional141=str==((void*)0),    _if_conditional141) {
    ...
    if(_if_conditional146=tail>=len_109,    _if_conditional146) {
        tail=len_109;
    }
    ...
    if(_if_conditional148=tail-head+1<1,    _if_conditional148) {
    ...
    result_110=(char*)come_increment_ref_count(((char*)(right_value100=(char*)come_calloc(1, sizeof(char)*(1*(tail-head+1)), "libcomelang2.c", 1533, "char"))));
    ...
    __result173__ = __result_obj__ = result_110;
...
memset(&result_112, 0, sizeof(char*));
    ...
    if(_if_conditional156=tail-head+1<1,    _if_conditional156) {
    ...
    result_112=(char*)come_increment_ref_count(((char*)(right_value106=(char*)come_calloc(1, sizeof(char)*(1*(tail-head+1)), "libcomelang2.c", 1576, "char"))));
    ...
    __result178__ = __result_obj__ = result_112;
...
memset(&result2_116, 0, sizeof(char*));
    if(_if_conditional157=msg==((void*)0),    _if_conditional157) {
    ...
    if(_if_conditional158=len_115<0,    _if_conditional158) {
    ...
    __freed_obj__ = 0;
    free(result_114);
    __result181__ = __result_obj__ = result2_116;
    if((&args_113) && !__freed_obj__) { come_call_finalizer(va_list_finalize,(&args_113), (void*)0, (void*)0, 1, 0, 0, 0); }
...
memset(&right_value114, 0, sizeof(void*));
    ...
    if(_if_conditional165=tail>=len_117,    _if_conditional165) {
        tail=len_117;
    }
...
memset(&right_value119, 0, sizeof(void*));
    ...
    if(_if_conditional172=tail>=len_119,    _if_conditional172) {
        tail=len_119;
    }
...
memset(&right_value130, 0, sizeof(void*));
    if(_if_conditional173=self==((void*)0),    _if_conditional173) {
        __result191__ = __result_obj__ = ((struct list$1charph*)(right_value121=list$1charph_initialize((struct list$1charph*)come_increment_ref_count(((struct list$1charph*)(right_value120=(struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "libcomelang2.c", 1687, "struct list$1charph")))))));
    ...
    result_123=(struct list$1charph*)come_increment_ref_count(((struct list$1charph*)(right_value123=list$1charph_initialize((struct list$1charph*)come_increment_ref_count(((struct list$1charph*)(right_value122=(struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "libcomelang2.c", 1690, "struct list$1charph"))))))));
    ...
    __freed_obj__ = 0;
    str_124=(struct buffer*)come_increment_ref_count(((struct buffer*)(right_value125=buffer_initialize((struct buffer*)come_increment_ref_count(((struct buffer*)(right_value124=(struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "libcomelang2.c", 1692, "struct buffer"))))))));
    ...
    i_125=0 ,    0;    _for_condtionalA10=    i_125<charp_length(self) ,    _for_condtionalA10;    i_125++ ,    0    ){
        if(_if_conditional175=self[i_125]==c,        _if_conditional175) {
    ...
    if(_if_conditional178=buffer_length(str_124)!=0,    _if_conditional178) {
    ...
    __result193__ = __result_obj__ = result_123;
...
memset(&litem_128, 0, sizeof(struct list_item$1charph*));
                if(_if_conditional176=self->len==0,                _if_conditional176) {
                    litem_126=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(right_value126=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "./comelang2.h", 282, "struct list_item$1charph"))));
                    ...
                    if(_if_conditional177=self->len==1,                    _if_conditional177) {
                        litem_127=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(right_value127=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "./comelang2.h", 292, "struct list_item$1charph"))));
                        ...
                        litem_128=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(right_value128=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "./comelang2.h", 302, "struct list_item$1charph"))));
...
memset(&right_value138, 0, sizeof(void*));
    if(_if_conditional179=self==((void*)0),    _if_conditional179) {
        __result194__ = __result_obj__ = ((struct list$1charph*)(right_value132=list$1charph_initialize((struct list$1charph*)come_increment_ref_count(((struct list$1charph*)(right_value131=(struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "libcomelang2.c", 1713, "struct list$1charph")))))));
    ...
    result_129=(struct list$1charph*)come_increment_ref_count(((struct list$1charph*)(right_value134=list$1charph_initialize((struct list$1charph*)come_increment_ref_count(((struct list$1charph*)(right_value133=(struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "libcomelang2.c", 1716, "struct list$1charph"))))))));
    ...
    __freed_obj__ = 0;
    str_130=(struct buffer*)come_increment_ref_count(((struct buffer*)(right_value136=buffer_initialize((struct buffer*)come_increment_ref_count(((struct buffer*)(right_value135=(struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "libcomelang2.c", 1718, "struct buffer"))))))));
    ...
    i_131=0 ,    0;    _for_condtionalA11=    i_131<charp_length(self) ,    _for_condtionalA11;    i_131++ ,    0    ){
        if(_if_conditional180=self[i_131]==c,        _if_conditional180) {
    ...
    if(_if_conditional181=buffer_length(str_130)!=0,    _if_conditional181) {
    ...
    __result195__ = __result_obj__ = result_129;
...
memset(&right_value142, 0, sizeof(void*));
    ...
    while(_while_condtional6=p_132>=path,    _while_condtional6) {
        if(_if_conditional183=*p_132==47,        _if_conditional183) {
            break;
        }
        else {
            p_132--;
    ...
    if(_if_conditional184=p_132<path,    _if_conditional184) {
        ...
        __result198__ = __result_obj__ = ((char*)(right_value141=__builtin_string(p_132+1)));
...
memset(&right_value150, 0, sizeof(void*));
    ...
    while(_while_condtional7=p_134>=path2_133,    _while_condtional7) {
        if(_if_conditional187=*p_134==46,        _if_conditional187) {
            break;
        }
        else {
            p_134--;
    ...
    if(_if_conditional188=p_134<path2_133,    _if_conditional188) {
        __result203__ = __result_obj__ = ((char*)(right_value148=__builtin_string(path2_133)));
        ...
        __result204__ = __result_obj__ = ((char*)(right_value149=string_substring(path2_133,0,p_134-path2_133)));
        if(path2_133 && !__freed_obj__) { path2_133 = come_decrement_ref_count(path2_133, (void*)0, (void*)0, 0, 0, 0); }
...
memset(&right_value154, 0, sizeof(void*));
    ...
    while(_while_condtional8=p_135>=path,    _while_condtional8) {
        if(_if_conditional190=*p_135==46,        _if_conditional190) {
            break;
        }
        else {
            p_135--;
    ...
    if(_if_conditional191=p_135<path,    _if_conditional191) {
        ...
        __result208__ = __result_obj__ = ((char*)(right_value153=__builtin_string(p_135+1)));
...
memset(&result2_137, 0, sizeof(char*));
    ...
    __freed_obj__ = 0;
    free(result_136);
    __result211__ = __result_obj__ = result2_137;
...
memset(&right_value158, 0, sizeof(void*));
    if(_if_conditional193=self,    _if_conditional193) {
...
memset(&__result_obj__, 0, sizeof(void*));
memset(&__freed_obj__, 0, sizeof(_Bool));
    if(_if_conditional216=left==((void*)0)&&right==((void*)0),    _if_conditional216) {
        __result262__ = 0;
        return __result262__;
    }
    else {
        if(_if_conditional217=left==((void*)0),        _if_conditional217) {
            __result263__ = -1;
            return __result263__;
        }
        else {
            if(_if_conditional218=right==((void*)0),            _if_conditional218) {
                __result264__ = 1;
...
memset(&right_value177, 0, sizeof(void*));
    if(_if_conditional219=f==((void*)0),    _if_conditional219) {
        __result267__ = __result_obj__ = ((struct optional$2charphbool*)(right_value172=optional$2charphbool_initialize(((struct optional$2charphbool*)(right_value171=(struct optional$2charphbool*)come_calloc(1, sizeof(struct optional$2charphbool)*(1), "libcomelang2.c", 2067, "struct optional$2charphbool"))),(char*)come_increment_ref_count(((char*)(right_value170=__builtin_string("")))),(_Bool)0)));
    ...
    buf_138=(struct buffer*)come_increment_ref_count(((struct buffer*)(right_value174=buffer_initialize((struct buffer*)come_increment_ref_count(((struct buffer*)(right_value173=(struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "libcomelang2.c", 2069, "struct buffer"))))))));
    ...
    while(_while_condtional9=1,    _while_condtional9) {
        char buf2_139[8192];
        memset(&buf2_139, 0, sizeof(char)        *(8192)        );
        size_140=fread(buf2_139,1,8192,f);
        buffer_append(buf_138,buf2_139,size_140);
        if(_if_conditional221=size_140<8192,        _if_conditional221) {
            break;
        }
    }
    __result268__ = __result_obj__ = ((struct optional$2charphbool*)(right_value177=optional$2charphbool_initialize((struct optional$2charphbool*)come_increment_ref_count(((struct optional$2charphbool*)(right_value176=(struct optional$2charphbool*)come_calloc(1, sizeof(struct optional$2charphbool)*(1), "libcomelang2.c", 2083, "struct optional$2charphbool")))),(char*)come_increment_ref_count(((char*)(right_value175=buffer_to_string(buf_138)))),(_Bool)1)));
...
memset(&right_value181, 0, sizeof(void*));
    if(_if_conditional222=f==((void*)0)||str==((void*)0),    _if_conditional222) {
        __result269__ = __result_obj__ = ((struct optional$2intbool*)(right_value179=optional$2intbool_initialize(((struct optional$2intbool*)(right_value178=(struct optional$2intbool*)come_calloc(1, sizeof(struct optional$2intbool)*(1), "libcomelang2.c", 2089, "struct optional$2intbool"))),-1,(_Bool)0)));
    ...
    __result270__ = __result_obj__ = ((struct optional$2intbool*)(right_value181=optional$2intbool_initialize((struct optional$2intbool*)come_increment_ref_count(((struct optional$2intbool*)(right_value180=(struct optional$2intbool*)come_calloc(1, sizeof(struct optional$2intbool)*(1), "libcomelang2.c", 2092, "struct optional$2intbool")))),fwrite(str,strlen(str),1,f),(_Bool)1)));
...
memset(&right_value187, 0, sizeof(void*));
    if(_if_conditional223=f==((void*)0),    _if_conditional223) {
        __result271__ = __result_obj__ = ((struct optional$2intbool*)(right_value183=optional$2intbool_initialize(((struct optional$2intbool*)(right_value182=(struct optional$2intbool*)come_calloc(1, sizeof(struct optional$2intbool)*(1), "libcomelang2.c", 2098, "struct optional$2intbool"))),-1,(_Bool)0)));
    ...
    if(_if_conditional224=result_141<0,    _if_conditional224) {
        __result272__ = __result_obj__ = ((struct optional$2intbool*)(right_value185=optional$2intbool_initialize(((struct optional$2intbool*)(right_value184=(struct optional$2intbool*)come_calloc(1, sizeof(struct optional$2intbool)*(1), "libcomelang2.c", 2104, "struct optional$2intbool"))),result_141,(_Bool)0)));
    ...
    __result273__ = __result_obj__ = ((struct optional$2intbool*)(right_value187=optional$2intbool_initialize((struct optional$2intbool*)come_increment_ref_count(((struct optional$2intbool*)(right_value186=(struct optional$2intbool*)come_calloc(1, sizeof(struct optional$2intbool)*(1), "libcomelang2.c", 2107, "struct optional$2intbool")))),result_141,(_Bool)1)));
...
memset(&right_value193, 0, sizeof(void*));
    ...
    if(_if_conditional226=result_144<0,    _if_conditional226) {
        __result276__ = __result_obj__ = ((struct optional$2intbool*)(right_value191=optional$2intbool_initialize(((struct optional$2intbool*)(right_value190=(struct optional$2intbool*)come_calloc(1, sizeof(struct optional$2intbool)*(1), "libcomelang2.c", 2125, "struct optional$2intbool"))),result_144,(_Bool)0)));
...
memset(&right_value203, 0, sizeof(void*));
    if(_if_conditional227=self==((void*)0)||file_name==((void*)0),    _if_conditional227) {
        __result278__ = __result_obj__ = ((struct optional$2intbool*)(right_value195=optional$2intbool_initialize(((struct optional$2intbool*)(right_value194=(struct optional$2intbool*)come_calloc(1, sizeof(struct optional$2intbool)*(1), "libcomelang2.c", 2134, "struct optional$2intbool"))),-1,(_Bool)0)));
    ...
    if(_if_conditional229=f_145==((void*)0),    _if_conditional229) {
        __result279__ = __result_obj__ = ((struct optional$2intbool*)(right_value197=optional$2intbool_initialize(((struct optional$2intbool*)(right_value196=(struct optional$2intbool*)come_calloc(1, sizeof(struct optional$2intbool)*(1), "libcomelang2.c", 2146, "struct optional$2intbool"))),-1,(_Bool)0)));
    ...
    if(_if_conditional230=result_146<0,    _if_conditional230) {
        __result280__ = __result_obj__ = ((struct optional$2intbool*)(right_value199=optional$2intbool_initialize(((struct optional$2intbool*)(right_value198=(struct optional$2intbool*)come_calloc(1, sizeof(struct optional$2intbool)*(1), "libcomelang2.c", 2152, "struct optional$2intbool"))),result_146,(_Bool)0)));
    ...
    if(_if_conditional231=result2_147<0,    _if_conditional231) {
        __result281__ = __result_obj__ = ((struct optional$2intbool*)(right_value201=optional$2intbool_initialize(((struct optional$2intbool*)(right_value200=(struct optional$2intbool*)come_calloc(1, sizeof(struct optional$2intbool)*(1), "libcomelang2.c", 2158, "struct optional$2intbool"))),result2_147,(_Bool)0)));
    ...
    __result282__ = __result_obj__ = ((struct optional$2intbool*)(right_value203=optional$2intbool_initialize((struct optional$2intbool*)come_increment_ref_count(((struct optional$2intbool*)(right_value202=(struct optional$2intbool*)come_calloc(1, sizeof(struct optional$2intbool)*(1), "libcomelang2.c", 2161, "struct optional$2intbool")))),result_146,(_Bool)1)));
...
memset(&right_value213, 0, sizeof(void*));
    if(_if_conditional232=self==((void*)0)||file_name==((void*)0),    _if_conditional232) {
        __result283__ = __result_obj__ = ((struct optional$2intbool*)(right_value205=optional$2intbool_initialize(((struct optional$2intbool*)(right_value204=(struct optional$2intbool*)come_calloc(1, sizeof(struct optional$2intbool)*(1), "libcomelang2.c", 2167, "struct optional$2intbool"))),-1,(_Bool)0)));
    ...
    if(_if_conditional234=f_148==((void*)0),    _if_conditional234) {
        __result284__ = __result_obj__ = ((struct optional$2intbool*)(right_value207=optional$2intbool_initialize(((struct optional$2intbool*)(right_value206=(struct optional$2intbool*)come_calloc(1, sizeof(struct optional$2intbool)*(1), "libcomelang2.c", 2179, "struct optional$2intbool"))),-1,(_Bool)0)));
    ...
    if(_if_conditional235=result_149<0,    _if_conditional235) {
        __result285__ = __result_obj__ = ((struct optional$2intbool*)(right_value209=optional$2intbool_initialize(((struct optional$2intbool*)(right_value208=(struct optional$2intbool*)come_calloc(1, sizeof(struct optional$2intbool)*(1), "libcomelang2.c", 2185, "struct optional$2intbool"))),result_149,(_Bool)0)));
    ...
    if(_if_conditional236=result2_150<0,    _if_conditional236) {
        __result286__ = __result_obj__ = ((struct optional$2intbool*)(right_value211=optional$2intbool_initialize(((struct optional$2intbool*)(right_value210=(struct optional$2intbool*)come_calloc(1, sizeof(struct optional$2intbool)*(1), "libcomelang2.c", 2191, "struct optional$2intbool"))),result2_150,(_Bool)0)));
    ...
    __result287__ = __result_obj__ = ((struct optional$2intbool*)(right_value213=optional$2intbool_initialize((struct optional$2intbool*)come_increment_ref_count(((struct optional$2intbool*)(right_value212=(struct optional$2intbool*)come_calloc(1, sizeof(struct optional$2intbool)*(1), "libcomelang2.c", 2194, "struct optional$2intbool")))),result_149,(_Bool)1)));
...
memset(&right_value227, 0, sizeof(void*));
    if(_if_conditional237=file_name==((void*)0),    _if_conditional237) {
        __result288__ = __result_obj__ = ((struct optional$2charphbool*)(right_value216=optional$2charphbool_initialize(((struct optional$2charphbool*)(right_value215=(struct optional$2charphbool*)come_calloc(1, sizeof(struct optional$2charphbool)*(1), "libcomelang2.c", 2200, "struct optional$2charphbool"))),(char*)come_increment_ref_count(((char*)(right_value214=__builtin_string("")))),(_Bool)0)));
    ...
    if(_if_conditional238=f_151==((void*)0),    _if_conditional238) {
        __result289__ = __result_obj__ = ((struct optional$2charphbool*)(right_value219=optional$2charphbool_initialize(((struct optional$2charphbool*)(right_value218=(struct optional$2charphbool*)come_calloc(1, sizeof(struct optional$2charphbool)*(1), "libcomelang2.c", 2206, "struct optional$2charphbool"))),(char*)come_increment_ref_count(((char*)(right_value217=__builtin_string("")))),(_Bool)0)));
    ...
    buf_152=(struct buffer*)come_increment_ref_count(((struct buffer*)(right_value221=buffer_initialize((struct buffer*)come_increment_ref_count(((struct buffer*)(right_value220=(struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "libcomelang2.c", 2209, "struct buffer"))))))));
    ...
    while(_while_condtional10=1,    _while_condtional10) {
        ...
        if(_if_conditional239=size_154<8192,        _if_conditional239) {
            break;
        }
    }
    ...
    if(_if_conditional240=result2_156<0,    _if_conditional240) {
        __result290__ = __result_obj__ = ((struct optional$2charphbool*)(right_value225=optional$2charphbool_initialize(((struct optional$2charphbool*)(right_value224=(struct optional$2charphbool*)come_calloc(1, sizeof(struct optional$2charphbool)*(1), "libcomelang2.c", 2228, "struct optional$2charphbool"))),(char*)come_increment_ref_count(((char*)(right_value223=__builtin_string("")))),(_Bool)0)));
    ...
    __result291__ = __result_obj__ = ((struct optional$2charphbool*)(right_value227=optional$2charphbool_initialize((struct optional$2charphbool*)come_increment_ref_count(((struct optional$2charphbool*)(right_value226=(struct optional$2charphbool*)come_calloc(1, sizeof(struct optional$2charphbool)*(1), "libcomelang2.c", 2231, "struct optional$2charphbool")))),(char*)come_increment_ref_count(result_155),(_Bool)1)));
    if(buf_152 && !__freed_obj__) { come_call_finalizer(buffer_finalize,buf_152, (void*)0, (void*)0, 0, 0, 0, 0); }
    if(result_155 && !__freed_obj__) { result_155 = come_decrement_ref_count(result_155, (void*)0, (void*)0, 0, 0, 0); }
...
memset(&right_value241, 0, sizeof(void*));
    if(_if_conditional241=file_name==((void*)0),    _if_conditional241) {
        __result292__ = __result_obj__ = ((struct optional$2charphbool*)(right_value230=optional$2charphbool_initialize(((struct optional$2charphbool*)(right_value229=(struct optional$2charphbool*)come_calloc(1, sizeof(struct optional$2charphbool)*(1), "libcomelang2.c", 2237, "struct optional$2charphbool"))),(char*)come_increment_ref_count(((char*)(right_value228=__builtin_string("")))),(_Bool)0)));
    ...
    if(_if_conditional242=f_157==((void*)0),    _if_conditional242) {
        __result293__ = __result_obj__ = ((struct optional$2charphbool*)(right_value233=optional$2charphbool_initialize(((struct optional$2charphbool*)(right_value232=(struct optional$2charphbool*)come_calloc(1, sizeof(struct optional$2charphbool)*(1), "libcomelang2.c", 2243, "struct optional$2charphbool"))),(char*)come_increment_ref_count(((char*)(right_value231=__builtin_string("")))),(_Bool)0)));
    ...
    buf_158=(struct buffer*)come_increment_ref_count(((struct buffer*)(right_value235=buffer_initialize((struct buffer*)come_increment_ref_count(((struct buffer*)(right_value234=(struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "libcomelang2.c", 2246, "struct buffer"))))))));
    ...
    while(_while_condtional11=1,    _while_condtional11) {
        ...
        if(_if_conditional243=size_160<8192,        _if_conditional243) {
            break;
        }
    }
    ...
    if(_if_conditional244=result2_162<0,    _if_conditional244) {
        __result294__ = __result_obj__ = ((struct optional$2charphbool*)(right_value239=optional$2charphbool_initialize(((struct optional$2charphbool*)(right_value238=(struct optional$2charphbool*)come_calloc(1, sizeof(struct optional$2charphbool)*(1), "libcomelang2.c", 2265, "struct optional$2charphbool"))),(char*)come_increment_ref_count(((char*)(right_value237=__builtin_string("")))),(_Bool)0)));
    ...
    __result295__ = __result_obj__ = ((struct optional$2charphbool*)(right_value241=optional$2charphbool_initialize((struct optional$2charphbool*)come_increment_ref_count(((struct optional$2charphbool*)(right_value240=(struct optional$2charphbool*)come_calloc(1, sizeof(struct optional$2charphbool)*(1), "libcomelang2.c", 2268, "struct optional$2charphbool")))),(char*)come_increment_ref_count(result_161),(_Bool)1)));
    if(buf_158 && !__freed_obj__) { come_call_finalizer(buffer_finalize,buf_158, (void*)0, (void*)0, 0, 0, 0, 0); }
    if(result_161 && !__freed_obj__) { result_161 = come_decrement_ref_count(result_161, (void*)0, (void*)0, 0, 0, 0); }
...
memset(&right_value248, 0, sizeof(void*));
    result_163=(struct list$1charph*)come_increment_ref_count(((struct list$1charph*)(right_value243=list$1charph_initialize((struct list$1charph*)come_increment_ref_count(((struct list$1charph*)(right_value242=(struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "libcomelang2.c", 2273, "struct list$1charph"))))))));
    ...
    if(_if_conditional245=f==((void*)0),    _if_conditional245) {
        __result297__ = __result_obj__ = ((struct optional$2list$1charphphbool*)(right_value245=optional$2list$1charphphbool_initialize(((struct optional$2list$1charphphbool*)(right_value244=(struct optional$2list$1charphphbool*)come_calloc(1, sizeof(struct optional$2list$1charphphbool)*(1), "libcomelang2.c", 2276, "struct optional$2list$1charphphbool"))),(struct list$1charph*)come_increment_ref_count(result_163),(_Bool)0)));
    ...
    while(_while_condtional12=1,    _while_condtional12) {
        char buf_164[8192];
        memset(&buf_164, 0, sizeof(char)        *(8192)        );
        if(_if_conditional247=fgets(buf_164,8192,f)==((void*)0),        _if_conditional247) {
            break;
        }
    ...
    __result298__ = __result_obj__ = ((struct optional$2list$1charphphbool*)(right_value248=optional$2list$1charphphbool_initialize((struct optional$2list$1charphphbool*)come_increment_ref_count(((struct optional$2list$1charphphbool*)(right_value247=(struct optional$2list$1charphphbool*)come_calloc(1, sizeof(struct optional$2list$1charphphbool)*(1), "libcomelang2.c", 2289, "struct optional$2list$1charphphbool")))),(struct list$1charph*)come_increment_ref_count(result_163),(_Bool)1)));
    if(result_163 && !__freed_obj__) { come_call_finalizer(list$1charphp_finalize,result_163, (void*)0, (void*)0, 0, 0, 0, 0); }
...
memset(&right_value256, 0, sizeof(void*));
    if(_if_conditional248=path==((void*)0)||mode==((void*)0),    _if_conditional248) {
        __result299__ = __result_obj__ = ((struct optional$2intbool*)(right_value250=optional$2intbool_initialize(((struct optional$2intbool*)(right_value249=(struct optional$2intbool*)come_calloc(1, sizeof(struct optional$2intbool)*(1), "libcomelang2.c", 2295, "struct optional$2intbool"))),-1,(_Bool)0)));
    ...
    if(_if_conditional249=f_165,    _if_conditional249) {
        block(parent,f_165);
        if(_if_conditional250=((struct sDummyCurrentStack*)parent)->__method_block_result_kind__!=0,        _if_conditional250) {
            fclose(f_165);
            __result300__ = __result_obj__ = ((struct optional$2intbool*)(right_value252=optional$2intbool_initialize((struct optional$2intbool*)come_increment_ref_count(((struct optional$2intbool*)(right_value251=(struct optional$2intbool*)come_calloc(1, sizeof(struct optional$2intbool)*(1), "libcomelang2.c", 2303, "struct optional$2intbool")))),0,(_Bool)1)));
        ...
        fclose(f_165);
        __result301__ = __result_obj__ = ((struct optional$2intbool*)(right_value254=optional$2intbool_initialize((struct optional$2intbool*)come_increment_ref_count(((struct optional$2intbool*)(right_value253=(struct optional$2intbool*)come_calloc(1, sizeof(struct optional$2intbool)*(1), "libcomelang2.c", 2308, "struct optional$2intbool")))),0,(_Bool)1)));
    ...
    __result302__ = __result_obj__ = ((struct optional$2intbool*)(right_value256=optional$2intbool_initialize(((struct optional$2intbool*)(right_value255=(struct optional$2intbool*)come_calloc(1, sizeof(struct optional$2intbool)*(1), "libcomelang2.c", 2311, "struct optional$2intbool"))),-1,(_Bool)0)));
...
memset(&right_value261, 0, sizeof(void*));
    if(_if_conditional251=self==((void*)0),    _if_conditional251) {
        __result303__ = __result_obj__ = ((struct optional$2intbool*)(right_value258=optional$2intbool_initialize(((struct optional$2intbool*)(right_value257=(struct optional$2intbool*)come_calloc(1, sizeof(struct optional$2intbool)*(1), "libcomelang2.c", 2320, "struct optional$2intbool"))),-1,(_Bool)0)));
    ...
    puts(self);
    __result304__ = __result_obj__ = ((struct optional$2charphbool*)(right_value261=optional$2charphbool_initialize((struct optional$2charphbool*)come_increment_ref_count(((struct optional$2charphbool*)(right_value260=(struct optional$2charphbool*)come_calloc(1, sizeof(struct optional$2charphbool)*(1), "libcomelang2.c", 2324, "struct optional$2charphbool")))),(char*)come_increment_ref_count(((char*)(right_value259=__builtin_string(self)))),(_Bool)1)));
...
memset(&right_value266, 0, sizeof(void*));
    if(_if_conditional252=self==((void*)0),    _if_conditional252) {
        __result305__ = __result_obj__ = ((struct optional$2intbool*)(right_value263=optional$2intbool_initialize(((struct optional$2intbool*)(right_value262=(struct optional$2intbool*)come_calloc(1, sizeof(struct optional$2intbool)*(1), "libcomelang2.c", 2330, "struct optional$2intbool"))),-1,(_Bool)0)));
    ...
    printf("%s",self);
    __result306__ = __result_obj__ = ((struct optional$2charphbool*)(right_value266=optional$2charphbool_initialize((struct optional$2charphbool*)come_increment_ref_count(((struct optional$2charphbool*)(right_value265=(struct optional$2charphbool*)come_calloc(1, sizeof(struct optional$2charphbool)*(1), "libcomelang2.c", 2334, "struct optional$2charphbool")))),(char*)come_increment_ref_count(((char*)(right_value264=__builtin_string(self)))),(_Bool)1)));
...
memset(&right_value272, 0, sizeof(void*));
    if(_if_conditional253=self==((void*)0),    _if_conditional253) {
        __result307__ = __result_obj__ = ((struct optional$2charphbool*)(right_value269=optional$2charphbool_initialize(((struct optional$2charphbool*)(right_value268=(struct optional$2charphbool*)come_calloc(1, sizeof(struct optional$2charphbool)*(1), "libcomelang2.c", 2341, "struct optional$2charphbool"))),(char*)come_increment_ref_count(((char*)(right_value267=__builtin_string("")))),(_Bool)0)));
    ...
    printf("%s",msg2_166);
    free(msg2_166);
    __result308__ = __result_obj__ = ((struct optional$2charphbool*)(right_value272=optional$2charphbool_initialize((struct optional$2charphbool*)come_increment_ref_count(((struct optional$2charphbool*)(right_value271=(struct optional$2charphbool*)come_calloc(1, sizeof(struct optional$2charphbool)*(1), "libcomelang2.c", 2354, "struct optional$2charphbool")))),(char*)come_increment_ref_count(((char*)(right_value270=__builtin_string(self)))),(_Bool)1)));
...
memset(&right_value278, 0, sizeof(void*));
    if(_if_conditional254=self==((void*)0),    _if_conditional254) {
        __result309__ = __result_obj__ = ((struct optional$2charphbool*)(right_value275=optional$2charphbool_initialize(((struct optional$2charphbool*)(right_value274=(struct optional$2charphbool*)come_calloc(1, sizeof(struct optional$2charphbool)*(1), "libcomelang2.c", 2360, "struct optional$2charphbool"))),(char*)come_increment_ref_count(((char*)(right_value273=__builtin_string("")))),(_Bool)0)));
    ...
    printf("%s",msg2_168);
    free(msg2_168);
    __result310__ = __result_obj__ = ((struct optional$2charphbool*)(right_value278=optional$2charphbool_initialize((struct optional$2charphbool*)come_increment_ref_count(((struct optional$2charphbool*)(right_value277=(struct optional$2charphbool*)come_calloc(1, sizeof(struct optional$2charphbool)*(1), "libcomelang2.c", 2373, "struct optional$2charphbool")))),(char*)come_increment_ref_count(((char*)(right_value276=__builtin_string(self)))),(_Bool)1)));
...
memset(&right_value284, 0, sizeof(void*));
    if(_if_conditional255=self==((void*)0),    _if_conditional255) {
        __result312__ = __result_obj__ = ((struct optional$2charphbool*)(right_value281=optional$2charphbool_initialize(((struct optional$2charphbool*)(right_value280=(struct optional$2charphbool*)come_calloc(1, sizeof(struct optional$2charphbool)*(1), "libcomelang2.c", 2386, "struct optional$2charphbool"))),(char*)come_increment_ref_count(((char*)(right_value279=__builtin_string("")))),(_Bool)0)));
    ...
    puts(self);
    __result313__ = __result_obj__ = ((struct optional$2charphbool*)(right_value284=optional$2charphbool_initialize((struct optional$2charphbool*)come_increment_ref_count(((struct optional$2charphbool*)(right_value283=(struct optional$2charphbool*)come_calloc(1, sizeof(struct optional$2charphbool)*(1), "libcomelang2.c", 2390, "struct optional$2charphbool")))),(char*)come_increment_ref_count(((char*)(right_value282=__builtin_string(self)))),(_Bool)1)));
...
memset(&i_170, 0, sizeof(int));
    ...
    i_170=0 ,    0;    _for_condtionalA12=    i_170<self ,    _for_condtionalA12;    i_170++ ,    0    ){
        block(parent,i_170);
        if(_if_conditional256=((struct sDummyCurrentStack*)parent)->__method_block_result_kind__!=0,        _if_conditional256) {
            return;
        }
    }
}
