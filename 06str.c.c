...
memset(&right_value64, 0, sizeof(void*));
                ...
                result_44=(struct list$1sTypeph*)come_increment_ref_count(((struct list$1sTypeph*)(right_value60=list$1sTypeph_initialize((struct list$1sTypeph*)come_increment_ref_count(((struct list$1sTypeph*)(right_value59=(struct list$1sTypeph*)come_calloc(1, sizeof(struct list$1sTypeph)*(1), "./comelang2.h", 198, "struct list$1sTypeph"))))))));
...
memset(&litem_48, 0, sizeof(struct list_item$1sTypeph*));
                        if(_if_conditional67=self->len==0,                        _if_conditional67) {
                            litem_46=(struct list_item$1sTypeph*)come_increment_ref_count(((struct list_item$1sTypeph*)(right_value61=(struct list_item$1sTypeph*)come_calloc(1, sizeof(struct list_item$1sTypeph)*(1), "./comelang2.h", 212, "struct list_item$1sTypeph"))));
                            ...
                            if(_if_conditional68=self->len==1,                            _if_conditional68) {
                                litem_47=(struct list_item$1sTypeph*)come_increment_ref_count(((struct list_item$1sTypeph*)(right_value62=(struct list_item$1sTypeph*)come_calloc(1, sizeof(struct list_item$1sTypeph)*(1), "./comelang2.h", 222, "struct list_item$1sTypeph"))));
                                ...
                                litem_48=(struct list_item$1sTypeph*)come_increment_ref_count(((struct list_item$1sTypeph*)(right_value63=(struct list_item$1sTypeph*)come_calloc(1, sizeof(struct list_item$1sTypeph)*(1), "./comelang2.h", 232, "struct list_item$1sTypeph"))));
...
memset(&right_value73, 0, sizeof(void*));
                ...
                result_49=(struct list$1charph*)come_increment_ref_count(((struct list$1charph*)(right_value69=list$1charph_initialize((struct list$1charph*)come_increment_ref_count(((struct list$1charph*)(right_value68=(struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "./comelang2.h", 198, "struct list$1charph"))))))));
...
memset(&litem_53, 0, sizeof(struct list_item$1charph*));
                        if(_if_conditional74=self->len==0,                        _if_conditional74) {
                            litem_51=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(right_value70=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "./comelang2.h", 212, "struct list_item$1charph"))));
                            ...
                            if(_if_conditional75=self->len==1,                            _if_conditional75) {
                                litem_52=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(right_value71=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "./comelang2.h", 222, "struct list_item$1charph"))));
                                ...
                                litem_53=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(right_value72=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "./comelang2.h", 232, "struct list_item$1charph"))));
...
memset(&litem_69, 0, sizeof(struct list_item$1sNodeph*));
        if(_if_conditional124=self->len==0,        _if_conditional124) {
            litem_67=(struct list_item$1sNodeph*)come_increment_ref_count(((struct list_item$1sNodeph*)(right_value123=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "./comelang2.h", 282, "struct list_item$1sNodeph"))));
            ...
            if(_if_conditional125=self->len==1,            _if_conditional125) {
                litem_68=(struct list_item$1sNodeph*)come_increment_ref_count(((struct list_item$1sNodeph*)(right_value124=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "./comelang2.h", 292, "struct list_item$1sNodeph"))));
                ...
                litem_69=(struct list_item$1sNodeph*)come_increment_ref_count(((struct list_item$1sNodeph*)(right_value125=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "./comelang2.h", 302, "struct list_item$1sNodeph"))));
...
memset(&litem_87, 0, sizeof(struct list_item$1sTypeph*));
        if(_if_conditional133=self->len==0,        _if_conditional133) {
            litem_85=(struct list_item$1sTypeph*)come_increment_ref_count(((struct list_item$1sTypeph*)(right_value137=(struct list_item$1sTypeph*)come_calloc(1, sizeof(struct list_item$1sTypeph)*(1), "./comelang2.h", 282, "struct list_item$1sTypeph"))));
            ...
            if(_if_conditional134=self->len==1,            _if_conditional134) {
                litem_86=(struct list_item$1sTypeph*)come_increment_ref_count(((struct list_item$1sTypeph*)(right_value138=(struct list_item$1sTypeph*)come_calloc(1, sizeof(struct list_item$1sTypeph)*(1), "./comelang2.h", 292, "struct list_item$1sTypeph"))));
                ...
                litem_87=(struct list_item$1sTypeph*)come_increment_ref_count(((struct list_item$1sTypeph*)(right_value139=(struct list_item$1sTypeph*)come_calloc(1, sizeof(struct list_item$1sTypeph)*(1), "./comelang2.h", 302, "struct list_item$1sTypeph"))));
...
memset(&litem_150, 0, sizeof(struct list_item$1CVALUEph*));
            if(_if_conditional169=self->len==0,            _if_conditional169) {
                litem_148=(struct list_item$1CVALUEph*)come_increment_ref_count(((struct list_item$1CVALUEph*)(right_value232=(struct list_item$1CVALUEph*)come_calloc(1, sizeof(struct list_item$1CVALUEph)*(1), "./comelang2.h", 212, "struct list_item$1CVALUEph"))));
                ...
                if(_if_conditional170=self->len==1,                _if_conditional170) {
                    litem_149=(struct list_item$1CVALUEph*)come_increment_ref_count(((struct list_item$1CVALUEph*)(right_value233=(struct list_item$1CVALUEph*)come_calloc(1, sizeof(struct list_item$1CVALUEph)*(1), "./comelang2.h", 222, "struct list_item$1CVALUEph"))));
                    ...
                    litem_150=(struct list_item$1CVALUEph*)come_increment_ref_count(((struct list_item$1CVALUEph*)(right_value234=(struct list_item$1CVALUEph*)come_calloc(1, sizeof(struct list_item$1CVALUEph)*(1), "./comelang2.h", 232, "struct list_item$1CVALUEph"))));
                    ...
                    if(_if_conditional267=*info->p==76&&*(info->p+1)==39,                    _if_conditional267) {
                        ...
                        if(_if_conditional268=*info->p==92,                        _if_conditional268) {
                            ...
                            if(_if_conditional271=p2_284>127,                            _if_conditional271) {
                                ...
                                if(_if_conditional272=size_285>4,                                _if_conditional272) {
                        ...
                        if(_if_conditional280=*info->p==76&&*(info->p+1)==34,                        _if_conditional280) {
                            ...
                            wstr_300=(unsigned int*)come_increment_ref_count(((unsigned int*)(right_value435=(unsigned int*)come_calloc(1, sizeof(unsigned int)*(1*(len_299+1)), "06str.c", 2007, "unsigned int"))));
                            ...
                            _inf_obj_value8=come_increment_ref_count(((struct sWStringNode*)(right_value437=sWStringNode_initialize((struct sWStringNode*)come_increment_ref_count(((struct sWStringNode*)(right_value436=(struct sWStringNode*)come_calloc(1, sizeof(struct sWStringNode)*(1), "06str.c", 2018, "struct sWStringNode")))),(unsigned int*)come_increment_ref_count(wstr_300),sline_288,info))));
...
memset(&right_value440, 0, sizeof(void*));
                                ...
                                if(_if_conditional292=self!=((void*)0)&&self->value!=((void*)0),                                _if_conditional292) {
                                    ...
                                    result_302->value=(unsigned int*)come_increment_ref_count(((unsigned int*)(right_value439=(unsigned int*)come_memdup(self->value, "sWStringNode_clone", 4, "unsigned int*"))));
