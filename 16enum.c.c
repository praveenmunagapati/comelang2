...
right_value157 = (void*)0;
    ...
    while(_while_condtional20=(_Bool)1,    _while_condtional20) {
        ...
        parse_sharp_v5(info);
        if(_if_conditional219=*info->p==61,        _if_conditional219) {
            info->p++;
            ...
            if(_if_conditional220=!info->no_output_err,            _if_conditional220) {
            ...
            if(_if_conditional223=!info->no_output_err,            _if_conditional223) {
...
right_value133 = (void*)0;
                                    ...
                                    if(_if_conditional214=self!=((void*)0)&&self->mAsmName!=((void*)0),                                    _if_conditional214) {
...
memset(&litem_123, 0, sizeof(struct list_item$1tuple2$2charphsNodephph*));
                    if(_if_conditional221=self->len==0,                    _if_conditional221) {
...
right_value181 = (void*)0;
    if(_if_conditional237=charp_operator_equals(buf,"enum"),    _if_conditional237) {
        ...
        if(_if_conditional238=*info->p==123,        _if_conditional238) {
            ...
            if(_if_conditional239=map$2charphsClassph_at(info->classes,type_name_127,((void*)0))==((void*)0),            _if_conditional239) {
            }
            else {
                output_126=(_Bool)0;
            }
        ...
        while(_while_condtional21=(_Bool)1,        _while_condtional21) {
            ...
            parse_sharp_v5(info);
            if(_if_conditional240=*info->p==61,            _if_conditional240) {
                info->p++;
                skip_spaces_and_lf(info);
            ...
            parse_sharp_v5(info);
            if(_if_conditional241=*info->p==44,            _if_conditional241) {
                info->p++;
                skip_spaces_and_lf(info);
            }
            parse_sharp_v5(info);
...
right_value179 = (void*)0;
            ...
            if(_if_conditional249=self!=((void*)0)&&self->mElements!=((void*)0),            _if_conditional249) {
