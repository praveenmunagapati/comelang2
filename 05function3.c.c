...
memset(&litem_14, 0, sizeof(struct list_item$1CVALUEph*));
        # 309 "./comelang2.h"
        # 278 "./comelang2.h"
        if(_if_conditional24=((struct list$1CVALUEph*)come_null_check(self, "./comelang2.h", 278))->len==0,        _if_conditional24) {
            # 279 "./comelang2.h"
            litem_12=(struct list_item$1CVALUEph*)come_increment_ref_count(((struct list_item$1CVALUEph*)(right_value16=(struct list_item$1CVALUEph*)come_calloc(1, sizeof(struct list_item$1CVALUEph)*(1), "./comelang2.h", 279))));
            ...
            __freed_obj__ = 0;
            # 281 "./comelang2.h"
            ((struct list_item$1CVALUEph*)come_null_check(litem_12, "./comelang2.h", 281))->prev=((void*)0);
            # 282 "./comelang2.h"
            ((struct list_item$1CVALUEph*)come_null_check(litem_12, "./comelang2.h", 282))->next=((void*)0);
            # 283 "./comelang2.h"
            __dec_obj9=((struct list_item$1CVALUEph*)come_null_check(litem_12, "./comelang2.h", 283))->item;
            ((struct list_item$1CVALUEph*)come_null_check(litem_12, "./comelang2.h", 283))->item=(struct CVALUE*)come_increment_ref_count(item);
            if(__dec_obj9) { come_call_finalizer(CVALUE_finalize,__dec_obj9, (void*)0, (void*)0, 0, 0, 0, 0); }
            # 285 "./comelang2.h"
            ((struct list$1CVALUEph*)come_null_check(self, "./comelang2.h", 285))->tail=litem_12;
            # 286 "./comelang2.h"
            ((struct list$1CVALUEph*)come_null_check(self, "./comelang2.h", 286))->head=litem_12;
        }
        else {
            # 309 "./comelang2.h"
            # 288 "./comelang2.h"
            if(_if_conditional26=((struct list$1CVALUEph*)come_null_check(self, "./comelang2.h", 288))->len==1,            _if_conditional26) {
                # 289 "./comelang2.h"
                litem_13=(struct list_item$1CVALUEph*)come_increment_ref_count(((struct list_item$1CVALUEph*)(right_value17=(struct list_item$1CVALUEph*)come_calloc(1, sizeof(struct list_item$1CVALUEph)*(1), "./comelang2.h", 289))));
                ...
                __freed_obj__ = 0;
                # 291 "./comelang2.h"
                ((struct list_item$1CVALUEph*)come_null_check(litem_13, "./comelang2.h", 291))->prev=((struct list$1CVALUEph*)come_null_check(self, "./comelang2.h", 291))->head;
                # 292 "./comelang2.h"
                ((struct list_item$1CVALUEph*)come_null_check(litem_13, "./comelang2.h", 292))->next=((void*)0);
                # 293 "./comelang2.h"
                __dec_obj10=((struct list_item$1CVALUEph*)come_null_check(litem_13, "./comelang2.h", 293))->item;
                ((struct list_item$1CVALUEph*)come_null_check(litem_13, "./comelang2.h", 293))->item=(struct CVALUE*)come_increment_ref_count(item);
                if(__dec_obj10) { come_call_finalizer(CVALUE_finalize,__dec_obj10, (void*)0, (void*)0, 0, 0, 0, 0); }
                # 295 "./comelang2.h"
                ((struct list$1CVALUEph*)come_null_check(self, "./comelang2.h", 295))->tail=litem_13;
                # 296 "./comelang2.h"
                ((struct list_item$1CVALUEph*)come_null_check(((struct list$1CVALUEph*)come_null_check(self, "./comelang2.h", 296))->head, "./comelang2.h", 296))->next=litem_13;
            }
            else {
                # 299 "./comelang2.h"
                litem_14=(struct list_item$1CVALUEph*)come_increment_ref_count(((struct list_item$1CVALUEph*)(right_value18=(struct list_item$1CVALUEph*)come_calloc(1, sizeof(struct list_item$1CVALUEph)*(1), "./comelang2.h", 299))));
                ...
                __freed_obj__ = 0;
                # 301 "./comelang2.h"
                ((struct list_item$1CVALUEph*)come_null_check(litem_14, "./comelang2.h", 301))->prev=((struct list$1CVALUEph*)come_null_check(self, "./comelang2.h", 301))->tail;
                # 302 "./comelang2.h"
                ((struct list_item$1CVALUEph*)come_null_check(litem_14, "./comelang2.h", 302))->next=((void*)0);
                # 303 "./comelang2.h"
                __dec_obj11=((struct list_item$1CVALUEph*)come_null_check(litem_14, "./comelang2.h", 303))->item;
                ((struct list_item$1CVALUEph*)come_null_check(litem_14, "./comelang2.h", 303))->item=(struct CVALUE*)come_increment_ref_count(item);
                if(__dec_obj11) { come_call_finalizer(CVALUE_finalize,__dec_obj11, (void*)0, (void*)0, 0, 0, 0, 0); }
                # 305 "./comelang2.h"
                ((struct list_item$1CVALUEph*)come_null_check(((struct list$1CVALUEph*)come_null_check(self, "./comelang2.h", 305))->tail, "./comelang2.h", 305))->next=litem_14;
                # 306 "./comelang2.h"
                ((struct list$1CVALUEph*)come_null_check(self, "./comelang2.h", 306))->tail=litem_14;
            }
        }
        # 309 "./comelang2.h"
