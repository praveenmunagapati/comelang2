...
memset(&litem_14, 0, sizeof(struct list_item$1CVALUEph*));
        if(_if_conditional24=self->len==0,        _if_conditional24) {
            litem_12=(struct list_item$1CVALUEph*)come_increment_ref_count(((struct list_item$1CVALUEph*)(right_value16=(struct list_item$1CVALUEph*)come_calloc(1, sizeof(struct list_item$1CVALUEph)*(1), "./comelang2.h", 282, "struct list_item$1CVALUEph"))));
            ...
            if(_if_conditional26=self->len==1,            _if_conditional26) {
                litem_13=(struct list_item$1CVALUEph*)come_increment_ref_count(((struct list_item$1CVALUEph*)(right_value17=(struct list_item$1CVALUEph*)come_calloc(1, sizeof(struct list_item$1CVALUEph)*(1), "./comelang2.h", 292, "struct list_item$1CVALUEph"))));
                ...
                litem_14=(struct list_item$1CVALUEph*)come_increment_ref_count(((struct list_item$1CVALUEph*)(right_value18=(struct list_item$1CVALUEph*)come_calloc(1, sizeof(struct list_item$1CVALUEph)*(1), "./comelang2.h", 302, "struct list_item$1CVALUEph"))));
        ...
        if(_if_conditional36=*info->p==46&&xisdigit(c_23),        _if_conditional36) {
            ...
            *p2_22=0;
            ...
            if(_if_conditional48=*info->p==102||*info->p==70,            _if_conditional48) {
                ...
                __right_value_freed_obj[2] = right_value59, right_value59 = (void*)0;
                __freed_obj__ = 0;
                return __result46__;
            }
            else {
            ...
            if(_if_conditional65=*info->p==117||*info->p==85,            _if_conditional65) {
                ...
                if(_if_conditional66=*info->p==76||*info->p==108,                _if_conditional66) {
                    ...
                    __right_value_freed_obj[2] = right_value84, right_value84 = (void*)0;
                    __freed_obj__ = 0;
                    return __result61__;
                }
            }
                ...
                if(_if_conditional83=*info->p==76||*info->p==108,                _if_conditional83) {
                    ...
                    if(_if_conditional84=*info->p==76||*info->p==108,                    _if_conditional84) {
                        ...
                        __right_value_freed_obj[2] = right_value89, right_value89 = (void*)0;
                        __freed_obj__ = 0;
                        return __result64__;
                    }
                    else {
                        if(_if_conditional90=*info->p==85||*info->p==117,                        _if_conditional90) {
                            ...
                            __right_value_freed_obj[2] = right_value99, right_value99 = (void*)0;
                            __freed_obj__ = 0;
                            return __result70__;
                        }
                    }
        ...
        if(_if_conditional114=*info->p==76||*info->p==108,        _if_conditional114) {
            ...
            if(_if_conditional115=*info->p==76||*info->p==108,            _if_conditional115) {
                ...
                if(_if_conditional127=minus,                _if_conditional127) {
                    ...
                    __right_value_freed_obj[2] = right_value129, right_value129 = (void*)0;
                    __freed_obj__ = 0;
                    return __result89__;
                }
            }
            ...
            if(_if_conditional138=minus,            _if_conditional138) {
                ...
                __right_value_freed_obj[2] = right_value134, right_value134 = (void*)0;
                __freed_obj__ = 0;
                return __result92__;
            }
            else {
        ...
        if(_if_conditional149=*info->p==76||*info->p==108,        _if_conditional149) {
            ...
            if(_if_conditional150=*info->p==76||*info->p==108,            _if_conditional150) {
                ...
                if(_if_conditional151=minus,                _if_conditional151) {
                    ...
                    __right_value_freed_obj[2] = right_value149, right_value149 = (void*)0;
                    __freed_obj__ = 0;
                ...
                if(_if_conditional162=*info->p==85||*info->p==117,                _if_conditional162) {
                    ...
                    if(_if_conditional163=minus,                    _if_conditional163) {
                        ...
                        __right_value_freed_obj[2] = right_value159, right_value159 = (void*)0;
                        __freed_obj__ = 0;
