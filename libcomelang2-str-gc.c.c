...
int* wcscpy(int* anonymous_var_nameX863, const int* anonymous_var_nameX864);

int* wcsncpy(int* anonymous_var_nameX865, const int* anonymous_var_nameX866, unsigned long int anonymous_var_nameX867);

int* wcscat(int* anonymous_var_nameX868, const int* anonymous_var_nameX869);

int* wcsncat(int* anonymous_var_nameX870, const int* anonymous_var_nameX871, unsigned long int anonymous_var_nameX872);

int wcscmp(const int* anonymous_var_nameX873, const int* anonymous_var_nameX874);

int wcsncmp(const int* anonymous_var_nameX875, const int* anonymous_var_nameX876, unsigned long int anonymous_var_nameX877);

int wcscoll(const int* anonymous_var_nameX878, const int* anonymous_var_nameX879);

unsigned long int wcsxfrm(int* anonymous_var_nameX880, const int* anonymous_var_nameX881, unsigned long int anonymous_var_nameX882);

int* wcschr(const int* anonymous_var_nameX883, int anonymous_var_nameX884);

int* wcsrchr(const int* anonymous_var_nameX885, int anonymous_var_nameX886);

unsigned long int wcscspn(const int* anonymous_var_nameX887, const int* anonymous_var_nameX888);

unsigned long int wcsspn(const int* anonymous_var_nameX889, const int* anonymous_var_nameX890);

int* wcspbrk(const int* anonymous_var_nameX891, const int* anonymous_var_nameX892);

int* wcstok(int* anonymous_var_nameX893, const int* anonymous_var_nameX894, int** anonymous_var_nameX895);

unsigned long int wcslen(const int* anonymous_var_nameX896);

int* wcsstr(const int* anonymous_var_nameX897, const int* anonymous_var_nameX898);

int* wcswcs(const int* anonymous_var_nameX899, const int* anonymous_var_nameX900);

int* wmemchr(const int* anonymous_var_nameX901, int anonymous_var_nameX902, unsigned long int anonymous_var_nameX903);

int wmemcmp(const int* anonymous_var_nameX904, const int* anonymous_var_nameX905, unsigned long int anonymous_var_nameX906);

int* wmemcpy(int* anonymous_var_nameX907, const int* anonymous_var_nameX908, unsigned long int anonymous_var_nameX909);

int* wmemmove(int* anonymous_var_nameX910, const int* anonymous_var_nameX911, unsigned long int anonymous_var_nameX912);

int* wmemset(int* anonymous_var_nameX913, int anonymous_var_nameX914, unsigned long int anonymous_var_nameX915);
...
unsigned long int mbrtowc(int* anonymous_var_nameX919, const char* anonymous_var_nameX920, unsigned long int anonymous_var_nameX921, struct __mbstate_t* anonymous_var_nameX922);

unsigned long int wcrtomb(char* anonymous_var_nameX923, int anonymous_var_nameX924, struct __mbstate_t* anonymous_var_nameX925);
...
unsigned long int mbsrtowcs(int* anonymous_var_nameX929, const char** anonymous_var_nameX930, unsigned long int anonymous_var_nameX931, struct __mbstate_t* anonymous_var_nameX932);

unsigned long int wcsrtombs(char* anonymous_var_nameX933, const int** anonymous_var_nameX934, unsigned long int anonymous_var_nameX935, struct __mbstate_t* anonymous_var_nameX936);

float wcstof(const int* anonymous_var_nameX937, int** anonymous_var_nameX938);

double wcstod(const int* anonymous_var_nameX939, int** anonymous_var_nameX940);

long double wcstold(const int* anonymous_var_nameX941, int** anonymous_var_nameX942);

long wcstol(const int* anonymous_var_nameX943, int** anonymous_var_nameX944, int anonymous_var_nameX945);

unsigned long int wcstoul(const int* anonymous_var_nameX946, int** anonymous_var_nameX947, int anonymous_var_nameX948);

long long wcstoll(const int* anonymous_var_nameX949, int** anonymous_var_nameX950, int anonymous_var_nameX951);

unsigned long long wcstoull(const int* anonymous_var_nameX952, int** anonymous_var_nameX953, int anonymous_var_nameX954);

int fwide(struct _IO_FILE* anonymous_var_nameX955, int anonymous_var_nameX956);

int wprintf(const int* anonymous_var_nameX957, ...);

int fwprintf(struct _IO_FILE* anonymous_var_nameX958, const int* anonymous_var_nameX959, ...);

int swprintf(int* anonymous_var_nameX960, unsigned long int anonymous_var_nameX961, const int* anonymous_var_nameX962, ...);

int vwprintf(const int* anonymous_var_nameX963, va_list anonymous_var_nameX964);

int vfwprintf(struct _IO_FILE* anonymous_var_nameX965, const int* anonymous_var_nameX966, va_list anonymous_var_nameX967);

int vswprintf(int* anonymous_var_nameX968, unsigned long int anonymous_var_nameX969, const int* anonymous_var_nameX970, va_list anonymous_var_nameX971);

int wscanf(const int* anonymous_var_nameX972, ...);

int fwscanf(struct _IO_FILE* anonymous_var_nameX973, const int* anonymous_var_nameX974, ...);

int swscanf(const int* anonymous_var_nameX975, const int* anonymous_var_nameX976, ...);

int vwscanf(const int* anonymous_var_nameX977, va_list anonymous_var_nameX978);

int vfwscanf(struct _IO_FILE* anonymous_var_nameX979, const int* anonymous_var_nameX980, va_list anonymous_var_nameX981);

int vswscanf(const int* anonymous_var_nameX982, const int* anonymous_var_nameX983, va_list anonymous_var_nameX984);
...
unsigned int fputwc(int anonymous_var_nameX987, struct _IO_FILE* anonymous_var_nameX988);

unsigned int putwc(int anonymous_var_nameX989, struct _IO_FILE* anonymous_var_nameX990);

unsigned int putwchar(int anonymous_var_nameX991);

int* fgetws(int* anonymous_var_nameX992, int anonymous_var_nameX993, struct _IO_FILE* anonymous_var_nameX994);

int fputws(const int* anonymous_var_nameX995, struct _IO_FILE* anonymous_var_nameX996);

unsigned int ungetwc(unsigned int anonymous_var_nameX997, struct _IO_FILE* anonymous_var_nameX998);

unsigned long int wcsftime(int* anonymous_var_nameX999, unsigned long int anonymous_var_nameX1000, const int* anonymous_var_nameX1001, const struct tm* anonymous_var_nameX1002);
...
unsigned int fputwc_unlocked(int anonymous_var_nameX1005, struct _IO_FILE* anonymous_var_nameX1006);

unsigned int putwc_unlocked(int anonymous_var_nameX1007, struct _IO_FILE* anonymous_var_nameX1008);

unsigned int putwchar_unlocked(int anonymous_var_nameX1009);

int* fgetws_unlocked(int* anonymous_var_nameX1010, int anonymous_var_nameX1011, struct _IO_FILE* anonymous_var_nameX1012);

int fputws_unlocked(const int* anonymous_var_nameX1013, struct _IO_FILE* anonymous_var_nameX1014);

unsigned long int wcsftime_l(int* anonymous_var_nameX1015, unsigned long int anonymous_var_nameX1016, const int* anonymous_var_nameX1017, const struct tm* anonymous_var_nameX1018, struct __locale_struct* anonymous_var_nameX1019);

struct _IO_FILE* open_wmemstream(int** anonymous_var_nameX1020, unsigned long int* anonymous_var_nameX1021);

unsigned long int mbsnrtowcs(int* anonymous_var_nameX1022, const char** anonymous_var_nameX1023, unsigned long int anonymous_var_nameX1024, unsigned long int anonymous_var_nameX1025, struct __mbstate_t* anonymous_var_nameX1026);

unsigned long int wcsnrtombs(char* anonymous_var_nameX1027, const int** anonymous_var_nameX1028, unsigned long int anonymous_var_nameX1029, unsigned long int anonymous_var_nameX1030, struct __mbstate_t* anonymous_var_nameX1031);

int* wcsdup(const int* anonymous_var_nameX1032);

unsigned long int wcsnlen(const int* anonymous_var_nameX1033, unsigned long int anonymous_var_nameX1034);

int* wcpcpy(int* anonymous_var_nameX1035, const int* anonymous_var_nameX1036);

int* wcpncpy(int* anonymous_var_nameX1037, const int* anonymous_var_nameX1038, unsigned long int anonymous_var_nameX1039);

int wcscasecmp(const int* anonymous_var_nameX1040, const int* anonymous_var_nameX1041);

int wcscasecmp_l(const int* anonymous_var_nameX1042, const int* anonymous_var_nameX1043, struct __locale_struct* anonymous_var_nameX1044);

int wcsncasecmp(const int* anonymous_var_nameX1045, const int* anonymous_var_nameX1046, unsigned long int anonymous_var_nameX1047);

int wcsncasecmp_l(const int* anonymous_var_nameX1048, const int* anonymous_var_nameX1049, unsigned long int anonymous_var_nameX1050, struct __locale_struct* anonymous_var_nameX1051);

int wcscoll_l(const int* anonymous_var_nameX1052, const int* anonymous_var_nameX1053, struct __locale_struct* anonymous_var_nameX1054);

unsigned long int wcsxfrm_l(int* anonymous_var_nameX1055, const int* anonymous_var_nameX1056, unsigned long int anonymous_var_nameX1057, struct __locale_struct* anonymous_var_nameX1058);

int wcwidth(int anonymous_var_nameX1059);

int wcswidth(const int* anonymous_var_nameX1060, unsigned long int anonymous_var_nameX1061);
...
void* GC_debug_malloc_atomic_uncollectable(unsigned long int anonymous_var_nameX1149, const char* s, int i);

void* GC_debug_malloc(unsigned long int anonymous_var_nameX1150, const char* s, int i);

void* GC_debug_malloc_atomic(unsigned long int anonymous_var_nameX1151, const char* s, int i);

char* GC_debug_strdup(const char* anonymous_var_nameX1152, const char* s, int i);

char* GC_debug_strndup(const char* anonymous_var_nameX1153, unsigned long int anonymous_var_nameX1154, const char* s, int i);

void* GC_debug_malloc_uncollectable(unsigned long int anonymous_var_nameX1155, const char* s, int i);

void* GC_debug_malloc_stubborn(unsigned long int anonymous_var_nameX1156, const char* s, int i);

void* GC_debug_malloc_ignore_off_page(unsigned long int anonymous_var_nameX1157, const char* s, int i);

void* GC_debug_malloc_atomic_ignore_off_page(unsigned long int anonymous_var_nameX1158, const char* s, int i);

void GC_debug_free(void* anonymous_var_nameX1159);

void* GC_debug_realloc(void* anonymous_var_nameX1160, unsigned long int anonymous_var_nameX1161, const char* s, int i);
