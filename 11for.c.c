...
memset(&right_value21, 0, sizeof(void*));
                ...
                result_9=(struct list$1sNodeph*)come_increment_ref_count(((struct list$1sNodeph*)(right_value17=list$1sNodeph_initialize((struct list$1sNodeph*)come_increment_ref_count(((struct list$1sNodeph*)(right_value16=(struct list$1sNodeph*)come_calloc(1, sizeof(struct list$1sNodeph)*(1), "/usr/local/include/comelang2.h", 198, "struct list$1sNodeph"))))))));
...
memset(&litem_13, 0, sizeof(struct list_item$1sNodeph*));
                        if(_if_conditional23=self->len==0,                        _if_conditional23) {
                            litem_11=(struct list_item$1sNodeph*)come_increment_ref_count(((struct list_item$1sNodeph*)(right_value18=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "/usr/local/include/comelang2.h", 212, "struct list_item$1sNodeph"))));
                            ...
                            if(_if_conditional24=self->len==1,                            _if_conditional24) {
                                litem_12=(struct list_item$1sNodeph*)come_increment_ref_count(((struct list_item$1sNodeph*)(right_value19=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "/usr/local/include/comelang2.h", 222, "struct list_item$1sNodeph"))));
                                ...
                                litem_13=(struct list_item$1sNodeph*)come_increment_ref_count(((struct list_item$1sNodeph*)(right_value20=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "/usr/local/include/comelang2.h", 232, "struct list_item$1sNodeph"))));
...
memset(&it2_34, 0, sizeof(struct sVar*));
                        ...
                        result_24=(struct map$2charphsVarph*)come_increment_ref_count(((struct map$2charphsVarph*)(right_value30=map$2charphsVarph_initialize((struct map$2charphsVarph*)come_increment_ref_count(((struct map$2charphsVarph*)(right_value24=(struct map$2charphsVarph*)come_calloc(1, sizeof(struct map$2charphsVarph)*(1), "/usr/local/include/comelang2.h", 1225, "struct map$2charphsVarph"))))))));
...
memset(&right_value29, 0, sizeof(void*));
                            self->keys=(char**)come_increment_ref_count(((char**)(right_value25=(char**)come_calloc(1, sizeof(char*)*(1*(1024)), "/usr/local/include/comelang2.h", 1132, "char*"))));
                            ...
                            __freed_obj__ = 0;
                            self->items=(struct sVar**)come_increment_ref_count(((struct sVar**)(right_value26=(struct sVar**)come_calloc(1, sizeof(struct sVar*)*(1*(1024)), "/usr/local/include/comelang2.h", 1133, "struct sVar*"))));
                            ...
                            __freed_obj__ = 0;
                            self->item_existance=(_Bool*)come_increment_ref_count(((_Bool*)(right_value27=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(1024)), "/usr/local/include/comelang2.h", 1134, "_Bool"))));
                            ...
                            self->key_list=(struct list$1charp*)come_increment_ref_count(((struct list$1charp*)(right_value29=list$1charp_initialize((struct list$1charp*)come_increment_ref_count(((struct list$1charp*)(right_value28=(struct list$1charp*)come_calloc(1, sizeof(struct list$1charp)*(1), "/usr/local/include/comelang2.h", 1144, "struct list$1charp"))))))));
...
memset(&default_value_45, 0, sizeof(struct sVar*));
                                        ...
                                        keys_36=(char**)come_increment_ref_count(((char**)(right_value32=(char**)come_calloc(1, sizeof(char*)*(1*(size_35)), "/usr/local/include/comelang2.h", 1380, "char*"))));
                                        ...
                                        __freed_obj__ = 0;
                                        items_37=(struct sVar**)come_increment_ref_count(((struct sVar**)(right_value33=(struct sVar**)come_calloc(1, sizeof(struct sVar*)*(1*(size_35)), "/usr/local/include/comelang2.h", 1381, "struct sVar*"))));
                                        ...
                                        __freed_obj__ = 0;
                                        item_existance_38=(_Bool*)come_increment_ref_count(((_Bool*)(right_value34=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_35)), "/usr/local/include/comelang2.h", 1382, "_Bool"))));
...
memset(&litem_72, 0, sizeof(struct list_item$1charp*));
                                        if(_if_conditional98=self->len==0,                                        _if_conditional98) {
                                            litem_70=(struct list_item$1charp*)come_increment_ref_count(((struct list_item$1charp*)(right_value38=(struct list_item$1charp*)come_calloc(1, sizeof(struct list_item$1charp)*(1), "/usr/local/include/comelang2.h", 282, "struct list_item$1charp"))));
                                            ...
                                            if(_if_conditional99=self->len==1,                                            _if_conditional99) {
                                                litem_71=(struct list_item$1charp*)come_increment_ref_count(((struct list_item$1charp*)(right_value39=(struct list_item$1charp*)come_calloc(1, sizeof(struct list_item$1charp)*(1), "/usr/local/include/comelang2.h", 292, "struct list_item$1charp"))));
                                                ...
                                                litem_72=(struct list_item$1charp*)come_increment_ref_count(((struct list_item$1charp*)(right_value40=(struct list_item$1charp*)come_calloc(1, sizeof(struct list_item$1charp)*(1), "/usr/local/include/comelang2.h", 302, "struct list_item$1charp"))));
...
memset(&conditional_value3_85, 0, sizeof(struct CVALUE*));
    ...
    for_var_table_76=(struct sVarTable*)come_increment_ref_count(((struct sVarTable*)(right_value46=sVarTable_initialize((struct sVarTable*)come_increment_ref_count(((struct sVarTable*)(right_value45=(struct sVarTable*)come_calloc(1, sizeof(struct sVarTable)*(1), "11for.c", 61, "struct sVarTable")))),(_Bool)0,lv_table_75))));
...
memset(&right_value64, 0, sizeof(void*));
    if(_if_conditional117=charp_operator_equals(buf,"for"),    _if_conditional117) {
        ...
        parse_sharp_v5(info);
        if(_if_conditional118=*info->p==59,        _if_conditional118) {
            ...
            expression_node_86=(struct sNode*)come_increment_ref_count(((struct sNode*)(right_value51=expression_v13(info))));
        ...
        if(_if_conditional119=*info->p==59,        _if_conditional119) {
            ...
            expression_node2_87=(struct sNode*)come_increment_ref_count(((struct sNode*)(right_value52=expression_v13(info))));
        ...
        expected_next_character(59,info);
        parse_sharp_v5(info);
        if(_if_conditional120=*info->p==41,        _if_conditional120) {
            ...
            expression_node3_88=(struct sNode*)come_increment_ref_count(((struct sNode*)(right_value53=expression_v13(info))));
        ...
        parse_sharp_v5(info);
        block_89=(struct sBlock*)come_increment_ref_count(((struct sBlock*)(right_value54=parse_block(info,(_Bool)0))));
        ...
        _inf_obj_value1=come_increment_ref_count(((struct sForNode*)(right_value56=sForNode_initialize((struct sForNode*)come_increment_ref_count(((struct sForNode*)(right_value55=(struct sForNode*)come_calloc(1, sizeof(struct sForNode)*(1), "11for.c", 205, "struct sForNode")))),(struct sNode*)come_increment_ref_count(expression_node_86),(struct sNode*)come_increment_ref_count(expression_node2_87),(struct sNode*)come_increment_ref_count(expression_node3_88),block_89,info))));
        ...
        __result58__ = __result_obj__ = ((struct sNode*)(right_value63=_inf_value1));
    ...
    __result59__ = __result_obj__ = ((struct sNode*)(right_value64=string_node_v10(buf,head,head_sline,info)));
...
memset(&__result_obj__, 0, sizeof(void*));
memset(&__freed_obj__, 0, sizeof(_Bool));
            if(_if_conditional121=self!=((void*)0)&&self->mExpressionNode!=((void*)0),            _if_conditional121) {
            ...
            if(_if_conditional122=self!=((void*)0)&&self->mExpressionNode2!=((void*)0),            _if_conditional122) {
            ...
            if(_if_conditional123=self!=((void*)0)&&self->mExpressionNode3!=((void*)0),            _if_conditional123) {
...
memset(&right_value62, 0, sizeof(void*));
            ...
            if(_if_conditional127=self!=((void*)0)&&self->mExpressionNode!=((void*)0),            _if_conditional127) {
                __dec_obj29=result_90->mExpressionNode;
                result_90->mExpressionNode=(struct sNode*)come_increment_ref_count(((struct sNode*)(right_value58=sNode_clone(self->mExpressionNode))));
            ...
            if(_if_conditional128=self!=((void*)0)&&self->mExpressionNode2!=((void*)0),            _if_conditional128) {
                __dec_obj30=result_90->mExpressionNode2;
                result_90->mExpressionNode2=(struct sNode*)come_increment_ref_count(((struct sNode*)(right_value59=sNode_clone(self->mExpressionNode2))));
            ...
            if(_if_conditional129=self!=((void*)0)&&self->mExpressionNode3!=((void*)0),            _if_conditional129) {
                __dec_obj31=result_90->mExpressionNode3;
                result_90->mExpressionNode3=(struct sNode*)come_increment_ref_count(((struct sNode*)(right_value60=sNode_clone(self->mExpressionNode3))));
            ...
            if(_if_conditional130=self!=((void*)0)&&self->mBlock!=((void*)0),            _if_conditional130) {
                __dec_obj32=result_90->mBlock;
                result_90->mBlock=(struct sBlock*)come_increment_ref_count(((struct sBlock*)(right_value61=sBlock_clone(self->mBlock))));
            ...
            if(_if_conditional132=self!=((void*)0)&&self->sname!=((void*)0),            _if_conditional132) {
                __dec_obj33=result_90->sname;
                result_90->sname=(char*)come_increment_ref_count(((char*)(right_value62=string_clone(self->sname))));
