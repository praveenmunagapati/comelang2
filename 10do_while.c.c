...
memset(&right_value56, 0, sizeof(void*));
    if(_if_conditional107=charp_operator_equals(buf,"do"),    _if_conditional107) {
        ...
        _inf_obj_value1=come_increment_ref_count(((struct sDoWhileNode*)(right_value50=sDoWhileNode_initialize((struct sDoWhileNode*)come_increment_ref_count(((struct sDoWhileNode*)(right_value49=(struct sDoWhileNode*)come_calloc(1, sizeof(struct sDoWhileNode)*(1), "10do_while.c", 106)))),(struct sNode*)come_increment_ref_count(expression_node_83),block_81,info))));
