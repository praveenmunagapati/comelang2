...
memset(&right_value56, 0, sizeof(void*));
    if(_if_conditional107=(come_push_stackframe("10do_while.c", 86),__exception_result_var_b49=charp_operator_equals(buf,"do"), come_pop_stackframe(), __exception_result_var_b49),    _if_conditional107) {
        ...
        _inf_obj_value1=come_increment_ref_count((come_push_stackframe("10do_while.c", 106),__exception_result_var_b56=((struct sDoWhileNode*)(right_value50=sDoWhileNode_initialize((struct sDoWhileNode*)come_increment_ref_count(((struct sDoWhileNode*)(right_value49=(struct sDoWhileNode*)come_calloc(1, sizeof(struct sDoWhileNode)*(1), "10do_while.c", 106, "struct sDoWhileNode")))),(struct sNode*)come_increment_ref_count(expression_node_83),block_81,info))), come_pop_stackframe(), __exception_result_var_b56));
...
memset(&right_value54, 0, sizeof(void*));
            ...
            result_84=(struct sDoWhileNode*)come_increment_ref_count(((struct sDoWhileNode*)(right_value51=(struct sDoWhileNode*)come_calloc(1, sizeof(struct sDoWhileNode)*(1), "sDoWhileNode_clone", 3, "struct sDoWhileNode"))));
