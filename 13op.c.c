...
memset(&litem_65, 0, sizeof(struct list_item$1CVALUEph*));
            if(_if_conditional118=self->len==0,            _if_conditional118) {
                litem_63=(struct list_item$1CVALUEph*)come_increment_ref_count(((struct list_item$1CVALUEph*)(right_value79=(struct list_item$1CVALUEph*)come_calloc(1, sizeof(struct list_item$1CVALUEph)*(1), "/usr/local/include/comelang2.h", 282, "struct list_item$1CVALUEph"))));
                ...
                if(_if_conditional120=self->len==1,                _if_conditional120) {
                    litem_64=(struct list_item$1CVALUEph*)come_increment_ref_count(((struct list_item$1CVALUEph*)(right_value80=(struct list_item$1CVALUEph*)come_calloc(1, sizeof(struct list_item$1CVALUEph)*(1), "/usr/local/include/comelang2.h", 292, "struct list_item$1CVALUEph"))));
                    ...
                    litem_65=(struct list_item$1CVALUEph*)come_increment_ref_count(((struct list_item$1CVALUEph*)(right_value81=(struct list_item$1CVALUEph*)come_calloc(1, sizeof(struct list_item$1CVALUEph)*(1), "/usr/local/include/comelang2.h", 302, "struct list_item$1CVALUEph"))));
    ...
    while(_while_condtional13=*info->p,    _while_condtional13) {
        if(_if_conditional419=*info->p==62&&*(info->p+1)==61,        _if_conditional419) {
            ...
            if(_if_conditional429=*info->p==60&&*(info->p+1)==61,            _if_conditional429) {
                ...
                __freed_obj__ = come_is_contained_element(__right_value_freed_obj, 2, right_value459);
                ...
                __right_value_freed_obj[2] = right_value459;
                __freed_obj__ = 0;
                ...
                if(_if_conditional439=*info->p==62&&*(info->p+1)!=62,                _if_conditional439) {
                    ...
                    if(_if_conditional449=*info->p==60&&*(info->p+1)!=60,                    _if_conditional449) {
                        ...
                        __right_value_freed_obj[1] = right_value470;
                        ...
                        if(_if_conditional459=*info->p==92&&*(info->p+1)==62&&*(info->p+2)==61,                        _if_conditional459) {
                            ...
                            if(_if_conditional469=*info->p==92&&*(info->p+1)==60&&*(info->p+2)==61,                            _if_conditional469) {
                                ...
                                __right_value_freed_obj[2] = right_value491;
                                __freed_obj__ = 0;
    ...
    while(_while_condtional14=*info->p,    _while_condtional14) {
        if(_if_conditional499=*info->p==61&&*(info->p+1)==61&&*(info->p+2)==61,        _if_conditional499) {
            ...
            if(_if_conditional509=*info->p==61&&*(info->p+1)==61,            _if_conditional509) {
                ...
                __right_value_freed_obj[2] = right_value524;
                __freed_obj__ = 0;
                ...
                if(_if_conditional519=*info->p==33&&*(info->p+1)==61&&*(info->p+2)==61,                _if_conditional519) {
                    ...
                    __right_value_freed_obj[1] = right_value527;
                    ...
                    if(_if_conditional529=*info->p==33&&*(info->p+1)==61,                    _if_conditional529) {
                        ...
                        __freed_obj__ = come_is_contained_element(__right_value_freed_obj, 1, right_value535);
                        ...
                        __right_value_freed_obj[1] = right_value535;
                        ...
                        __right_value_freed_obj[2] = right_value540;
                        __freed_obj__ = 0;
                        ...
                        if(_if_conditional539=*info->p==92&&*(info->p+1)==61&&*(info->p+2)==61&&*(info->p+3)==61,                        _if_conditional539) {
                            ...
                            if(_if_conditional549=*info->p==92&&*(info->p+1)==61&&*(info->p+2)==61,                            _if_conditional549) {
                                ...
                                __freed_obj__ = come_is_contained_element(__right_value_freed_obj, 1, right_value551);
                                ...
                                __right_value_freed_obj[1] = right_value551;
                                ...
                                if(_if_conditional559=*info->p==92&&*(info->p+1)==33&&*(info->p+2)==61&&*(info->p+3)==61,                                _if_conditional559) {
                                    ...
                                    __freed_obj__ = come_is_contained_element(__right_value_freed_obj, 2, right_value564);
                                    ...
                                    __right_value_freed_obj[2] = right_value564;
                                    __freed_obj__ = 0;
                                    ...
                                    if(_if_conditional569=*info->p==92&&*(info->p+1)==33&&*(info->p+2)==61,                                    _if_conditional569) {
                                        ...
                                        __freed_obj__ = come_is_contained_element(__right_value_freed_obj, 2, right_value572);
                                        ...
                                        __right_value_freed_obj[2] = right_value572;
                                        __freed_obj__ = 0;
...
memset(&right_value589, 0, sizeof(void*));
    ...
    while(_while_condtional15=*info->p,    _while_condtional15) {
        if(_if_conditional579=*info->p==38&&*(info->p+1)!=38&&*(info->p+1)!=61,        _if_conditional579) {
            ...
            __right_value_freed_obj[1] = right_value576;
            ...
            if(_if_conditional589=*info->p==92&&*(info->p+1)==38&&*(info->p+2)!=38&&*(info->p+2)!=61,            _if_conditional589) {
                ...
                __freed_obj__ = come_is_contained_element(__right_value_freed_obj, 1, right_value584);
                ...
                __right_value_freed_obj[1] = right_value584;
                ...
                __right_value_freed_obj[2] = right_value589;
                __freed_obj__ = 0;
    ...
    while(_while_condtional16=*info->p,    _while_condtional16) {
        if(_if_conditional599=*info->p==94&&*(info->p+1)!=61,        _if_conditional599) {
            ...
            if(_if_conditional609=*info->p==92&&*(info->p+1)==94&&*(info->p+2)!=61,            _if_conditional609) {
                ...
                __freed_obj__ = come_is_contained_element(__right_value_freed_obj, 2, right_value606);
                ...
                __right_value_freed_obj[2] = right_value606;
                __freed_obj__ = 0;
...
memset(&right_value623, 0, sizeof(void*));
    ...
    while(_while_condtional17=*info->p,    _while_condtional17) {
        if(_if_conditional619=*info->p==124&&*(info->p+1)!=61&&*(info->p+1)!=124,        _if_conditional619) {
            ...
            __right_value_freed_obj[2] = right_value615;
            __freed_obj__ = 0;
            ...
            if(_if_conditional629=*info->p==92&&*(info->p+1)==124&&*(info->p+2)!=61&&*(info->p+2)!=124,            _if_conditional629) {
                ...
                __freed_obj__ = come_is_contained_element(__right_value_freed_obj, 1, right_value618);
                ...
                __right_value_freed_obj[1] = right_value618;
    ...
    while(_while_condtional19=*info->p,    _while_condtional19) {
        if(_if_conditional659=*info->p==124&&*(info->p+1)==124,        _if_conditional659) {
            ...
            if(_if_conditional669=*info->p==92&&*(info->p+1)==124&&*(info->p+2)==124,            _if_conditional669) {
                ...
                __freed_obj__ = come_is_contained_element(__right_value_freed_obj, 2, right_value657);
                ...
                __right_value_freed_obj[2] = right_value657;
                __freed_obj__ = 0;
...
memset(&right_value666, 0, sizeof(void*));
    ...
    while(_while_condtional20=*info->p,    _while_condtional20) {
        if(_if_conditional679=!info->no_comma&&*info->p==44,        _if_conditional679) {
            ...
            __right_value_freed_obj[2] = right_value666;
            __freed_obj__ = 0;
...
memset(&right_value682, 0, sizeof(void*));
    ...
    while(_while_condtional21=*info->p,    _while_condtional21) {
        if(_if_conditional688=*info->p==63,        _if_conditional688) {
            ...
            __freed_obj__ = come_is_contained_element(__right_value_freed_obj, 2, right_value682);
            ...
            __right_value_freed_obj[2] = right_value682;
            __freed_obj__ = 0;
