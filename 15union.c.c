...
memset(&it2_73, 0, sizeof(char*));
        ...
        if(_if_conditional109=1,        _if_conditional109) {
            if(_if_conditional110=key==((void*)0),            _if_conditional110) {
                stackframe();
                puts("key is null");
                exit(2);
            }
        ...
        while(_while_condtional9=(_Bool)1,        _while_condtional9) {
            if(_if_conditional111=self->item_existance[it_53],            _if_conditional111) {
                if(_if_conditional112=string_equals(self->keys[it_53],key),                _if_conditional112) {
                ...
                it_53++;
                if(_if_conditional134=it_53>=self->size,                _if_conditional134) {
                    it_53=0;
                }
                else {
                    if(_if_conditional135=it_53==hash_52,                    _if_conditional135) {
        ...
        for(        it2_73=list$1charp_begin(self->key_list);        !list$1charp_end(self->key_list);        it2_73=list$1charp_next(self->key_list)        ){
            if(_if_conditional142=string_equals(it2_73,key),            _if_conditional142) {
                puts("SAME KEY");
                same_key_exist_70=(_Bool)1;
            }
        }
        if(_if_conditional143=!same_key_exist_70,        _if_conditional143) {
...
memset(&it_55, 0, sizeof(struct list_item$1charp*));
                            ...
                            while(_while_condtional10=it_55!=((void*)0),                            _while_condtional10) {
                                if(_if_conditional114=string_equals(it_55->item,item),                                _if_conditional114) {
                                        ...
                                        if(_if_conditional121=head==0&&tail==self->len,                                        _if_conditional121) {
                                            ...
                                            if(_if_conditional122=head==0,                                            _if_conditional122) {
                                                ...
                                                while(_while_condtional12=it_59!=((void*)0),                                                _while_condtional12) {
                                                    if(_if_conditional123=i_60<tail,                                                    _if_conditional123) {
                                                        prev_it_61=it_59;
                                                        it_59=it_59->next;
                                                        i_60++;
                                                        ...
                                                        if(_if_conditional124=i_60==tail,                                                        _if_conditional124) {
                                                            self->head=it_59;
                                                ...
                                                if(_if_conditional125=tail==self->len,                                                _if_conditional125) {
                                                    ...
                                                    while(_while_condtional13=it_62!=((void*)0),                                                    _while_condtional13) {
                                                        if(_if_conditional126=i_63==head,                                                        _if_conditional126) {
                                                            self->tail=it_62->prev;
                                                            self->tail->next=((void*)0);
                                                        }
                                                        if(_if_conditional127=i_63>=head,                                                        _if_conditional127) {
                                                            prev_it_64=it_62;
                                                            it_62=it_62->next;
                                                            i_63++;
                                                    ...
                                                    while(_while_condtional14=it_65!=((void*)0),                                                    _while_condtional14) {
                                                        if(_if_conditional128=i_68==head,                                                        _if_conditional128) {
                                                            head_prev_it_66=it_65->prev;
                                                        }
                                                        if(_if_conditional129=i_68==tail,                                                        _if_conditional129) {
                                                            tail_it_67=it_65;
                                                        }
                                                        if(_if_conditional130=i_68>=head&&i_68<tail,                                                        _if_conditional130) {
                                                            prev_it_69=it_65;
                                                            it_65=it_65->next;
                                                            i_68++;
                                                    ...
                                                    if(_if_conditional131=head_prev_it_66!=((void*)0),                                                    _if_conditional131) {
                                                        head_prev_it_66->next=tail_it_67;
                                                    }
                                                    if(_if_conditional132=tail_it_67!=((void*)0),                                                    _if_conditional132) {
...
right_value100 = (void*)0;
    ...
    if(_if_conditional148=!klass_80->mOutputed,    _if_conditional148) {
        klass_80->mOutputed=(_Bool)1;
        if(_if_conditional150=list$1tuple2$2charphsTypephph_length(klass_80->mFields)>0,        _if_conditional150) {
            ...
            if(_if_conditional158=info->output_header_file&&string_operator_not_equals(klass_80->mDeclareSName,info->base_sname),            _if_conditional158) {
            }
            else {
                if(self->mOutput) {
...
right_value137 = (void*)0;
    if(_if_conditional167=map$2charphsClassph_at(info->classes,type_name,((void*)0))==((void*)0),    _if_conditional167) {
        output_93=(_Bool)1;
    ...
    while(_while_condtional21=(_Bool)1,    _while_condtional21) {
        ...
        if(_if_conditional214=!err_127,        _if_conditional214) {
...
memset(&it_95, 0, sizeof(unsigned int));
        ...
        while(_while_condtional16=(_Bool)1,        _while_condtional16) {
            if(_if_conditional160=self->item_existance[it_95],            _if_conditional160) {
                if(_if_conditional161=string_equals(self->keys[it_95],key),                _if_conditional161) {
                ...
                it_95++;
                if(_if_conditional165=it_95>=self->size,                _if_conditional165) {
                    it_95=0;
                }
                else {
                    if(_if_conditional166=it_95==hash_94,                    _if_conditional166) {
...
memset(&it2_114, 0, sizeof(char*));
            ...
            if(_if_conditional176=1,            _if_conditional176) {
                if(_if_conditional177=key==((void*)0),                _if_conditional177) {
                    stackframe();
                    puts("key is null");
                    exit(2);
                }
            ...
            while(_while_condtional18=(_Bool)1,            _while_condtional18) {
                if(_if_conditional178=self->item_existance[it_112],                _if_conditional178) {
                    if(_if_conditional179=string_equals(self->keys[it_112],key),                    _if_conditional179) {
                    ...
                    it_112++;
                    if(_if_conditional182=it_112>=self->size,                    _if_conditional182) {
                        it_112=0;
                    }
                    else {
                        if(_if_conditional183=it_112==hash_111,                        _if_conditional183) {
                            printf("unexpected error in map.insert\n");
                            stackframe();
                            exit(2);
                        }
            ...
            for(            it2_114=list$1charp_begin(self->key_list);            !list$1charp_end(self->key_list);            it2_114=list$1charp_next(self->key_list)            ){
                if(_if_conditional186=string_equals(it2_114,key),                _if_conditional186) {
                    puts("SAME KEY");
                    same_key_exist_113=(_Bool)1;
                }
            }
            if(_if_conditional187=!same_key_exist_113,            _if_conditional187) {
                list$1charp_push_back(self->key_list,key);
            }
...
memset(&default_value_110, 0, sizeof(struct sClass*));
                    ...
                    for(                    it_103=map$2charphsClassph_begin(self);                    !map$2charphsClassph_end(self);                    it_103=map$2charphsClassph_next(self)                    ){
                        ...
                        while(_while_condtional17=(_Bool)1,                        _while_condtional17) {
                            if(_if_conditional173=item_existance_99[n_109],                            _if_conditional173) {
                                n_109++;
                                if(_if_conditional174=n_109>=size_96,                                _if_conditional174) {
                                    n_109=0;
                                }
                                else {
                                    if(_if_conditional175=n_109==hash_108,                                    _if_conditional175) {
                                        printf("unexpected error in map.rehash(1)\n");
                                        stackframe();
                                        exit(2);
                                    }
...
right_value162 = (void*)0;
    if(_if_conditional226=charp_operator_equals(buf,"union"),    _if_conditional226) {
        ...
        output_134=(_Bool)1;
        if(_if_conditional227=map$2charphsClassph_at(info->classes,type_name_133,((void*)0))==((void*)0),        _if_conditional227) {
        ...
        while(_while_condtional22=(_Bool)1,        _while_condtional22) {
            ...
            if(_if_conditional228=!err_138,            _if_conditional228) {
                printf("%s %d: parse_type failed\n",info->sname,info->sline);
                exit(2);
            }
            expected_next_character(59,info);
            ...
            if(_if_conditional229=*info->p==125,            _if_conditional229) {
                info->p++;
                skip_spaces_and_lf(info);
...
memset(&__result_obj__, 0, sizeof(void*));
            if(_if_conditional230=self!=((void*)0)&&self->mType!=((void*)0),            _if_conditional230) {
...
right_value160 = (void*)0;
            ...
            if(_if_conditional233=self!=((void*)0)&&self->mType!=((void*)0),            _if_conditional233) {
...
right_value167 = (void*)0;
    define_struct_142=(_Bool)0;
    {
        ...
        if(_if_conditional237=charp_operator_equals(buf,"union"),        _if_conditional237) {
            type_name_145=(char*)come_increment_ref_count(((char*)(right_value163=parse_word(info))));
            right_value163 = come_decrement_ref_count2(right_value163, (void*)0, (void*)0, 1, 0, 0, __result_obj__);
            if(_if_conditional238=*info->p==123,            _if_conditional238) {
                ((char*)(right_value164=skip_block(info)));
                right_value164 = come_decrement_ref_count2(right_value164, (void*)0, (void*)0, 1, 0, 0, __result_obj__);
                if(_if_conditional239=*info->p==59,                _if_conditional239) {
