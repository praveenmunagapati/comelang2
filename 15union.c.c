...
right_value57 = (void*)0;
    ...
    self->mType=(struct sType*)come_increment_ref_count(((struct sType*)(right_value49=sType_clone(type))));
...
right_value20 = (void*)0;
                ...
                result_12=(struct list$1sTypeph*)come_increment_ref_count(((struct list$1sTypeph*)(right_value16=list$1sTypeph_initialize((struct list$1sTypeph*)come_increment_ref_count(((struct list$1sTypeph*)(right_value15=(struct list$1sTypeph*)come_calloc(1, sizeof(struct list$1sTypeph)*(1), "/usr/local/include/comelang2.h", 142, "list$1sTypeph"))))))));
...
memset(&litem_16, 0, sizeof(struct list_item$1sTypeph*));
                        if(_if_conditional26=self->len==0,                        _if_conditional26) {
                            litem_14=(struct list_item$1sTypeph*)come_increment_ref_count(((struct list_item$1sTypeph*)(right_value17=(struct list_item$1sTypeph*)come_calloc(1, sizeof(struct list_item$1sTypeph)*(1), "/usr/local/include/comelang2.h", 156, "list_item$1sTypeph"))));
                            ...
                            if(_if_conditional27=self->len==1,                            _if_conditional27) {
                                litem_15=(struct list_item$1sTypeph*)come_increment_ref_count(((struct list_item$1sTypeph*)(right_value18=(struct list_item$1sTypeph*)come_calloc(1, sizeof(struct list_item$1sTypeph)*(1), "/usr/local/include/comelang2.h", 166, "list_item$1sTypeph"))));
                                ...
                                litem_16=(struct list_item$1sTypeph*)come_increment_ref_count(((struct list_item$1sTypeph*)(right_value19=(struct list_item$1sTypeph*)come_calloc(1, sizeof(struct list_item$1sTypeph)*(1), "/usr/local/include/comelang2.h", 176, "list_item$1sTypeph"))));
...
right_value34 = (void*)0;
                ...
                result_18=(struct list$1sNodeph*)come_increment_ref_count(((struct list$1sNodeph*)(right_value29=list$1sNodeph_initialize((struct list$1sNodeph*)come_increment_ref_count(((struct list$1sNodeph*)(right_value28=(struct list$1sNodeph*)come_calloc(1, sizeof(struct list$1sNodeph)*(1), "/usr/local/include/comelang2.h", 142, "list$1sNodeph"))))))));
...
memset(&litem_22, 0, sizeof(struct list_item$1sNodeph*));
                        if(_if_conditional37=self->len==0,                        _if_conditional37) {
                            litem_20=(struct list_item$1sNodeph*)come_increment_ref_count(((struct list_item$1sNodeph*)(right_value30=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "/usr/local/include/comelang2.h", 156, "list_item$1sNodeph"))));
                            ...
                            if(_if_conditional38=self->len==1,                            _if_conditional38) {
                                litem_21=(struct list_item$1sNodeph*)come_increment_ref_count(((struct list_item$1sNodeph*)(right_value31=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "/usr/local/include/comelang2.h", 166, "list_item$1sNodeph"))));
                                ...
                                litem_22=(struct list_item$1sNodeph*)come_increment_ref_count(((struct list_item$1sNodeph*)(right_value32=(struct list_item$1sNodeph*)come_calloc(1, sizeof(struct list_item$1sNodeph)*(1), "/usr/local/include/comelang2.h", 176, "list_item$1sNodeph"))));
...
right_value42 = (void*)0;
                ...
                result_24=(struct list$1charph*)come_increment_ref_count(((struct list$1charph*)(right_value38=list$1charph_initialize((struct list$1charph*)come_increment_ref_count(((struct list$1charph*)(right_value37=(struct list$1charph*)come_calloc(1, sizeof(struct list$1charph)*(1), "/usr/local/include/comelang2.h", 142, "list$1charph"))))))));
...
memset(&litem_28, 0, sizeof(struct list_item$1charph*));
                        if(_if_conditional52=self->len==0,                        _if_conditional52) {
                            litem_26=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(right_value39=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "/usr/local/include/comelang2.h", 156, "list_item$1charph"))));
                            ...
                            if(_if_conditional53=self->len==1,                            _if_conditional53) {
                                litem_27=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(right_value40=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "/usr/local/include/comelang2.h", 166, "list_item$1charph"))));
                                ...
                                litem_28=(struct list_item$1charph*)come_increment_ref_count(((struct list_item$1charph*)(right_value41=(struct list_item$1charph*)come_calloc(1, sizeof(struct list_item$1charph)*(1), "/usr/local/include/comelang2.h", 176, "list_item$1charph"))));
...
memset(&it2_67, 0, sizeof(char*));
        if(_if_conditional93=self->len*10>=self->size,        _if_conditional93) {
            map$2charphsTypeph_rehash(self);
        }
        hash_46=string_get_hash_key(key)%self->size;
        it_47=hash_46;
        while(_while_condtional9=(_Bool)1,        _while_condtional9) {
            if(_if_conditional105=self->item_existance[it_47],            _if_conditional105) {
                if(_if_conditional106=string_equals(self->keys[it_47],key),                _if_conditional106) {
                ...
                it_47++;
                if(_if_conditional128=it_47>=self->size,                _if_conditional128) {
                    it_47=0;
                }
                else {
                    if(_if_conditional129=it_47==hash_46,                    _if_conditional129) {
        ...
        for(        it2_67=list$1charp_begin(self->key_list);        !list$1charp_end(self->key_list);        it2_67=list$1charp_next(self->key_list)        ){
            if(_if_conditional136=string_equals(it2_67,key),            _if_conditional136) {
                puts("SAME KEY");
                same_key_exist_64=(_Bool)1;
            }
        }
        if(_if_conditional137=!same_key_exist_64,        _if_conditional137) {
...
memset(&default_value_45, 0, sizeof(struct sType*));
                ...
                keys_30=(char**)come_increment_ref_count(((char**)(right_value50=(char**)come_calloc(1, sizeof(char*)*(1*(size_29)), "/usr/local/include/comelang2.h", 1335, "char*%"))));
                right_value50 = come_decrement_ref_count2(right_value50, (void*)0, (void*)0, 1, 0, 0, __result_obj__);
                items_31=(struct sType**)come_increment_ref_count(((struct sType**)(right_value51=(struct sType**)come_calloc(1, sizeof(struct sType*)*(1*(size_29)), "/usr/local/include/comelang2.h", 1336, "sType*%"))));
                come_call_finalizer2(sType_finalize,right_value51, (void*)0, (void*)0, 0, 1, 0, 0, __result_obj__);
                item_existance_32=(_Bool*)come_increment_ref_count(((_Bool*)(right_value52=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_29)), "/usr/local/include/comelang2.h", 1337, "bool"))));
                ...
                for(                it_36=map$2charphsTypeph_begin(self);                !map$2charphsTypeph_end(self);                it_36=map$2charphsTypeph_next(self)                ){
                    ...
                    while(_while_condtional8=(_Bool)1,                    _while_condtional8) {
                        if(_if_conditional102=item_existance_32[n_44],                        _if_conditional102) {
                            n_44++;
                            if(_if_conditional103=n_44>=size_29,                            _if_conditional103) {
                                n_44=0;
                            }
                            else {
                                if(_if_conditional104=n_44==hash_43,                                _if_conditional104) {
...
memset(&it_41, 0, sizeof(unsigned int));
                        ...
                        while(_while_condtional7=(_Bool)1,                        _while_condtional7) {
                            if(_if_conditional98=self->item_existance[it_41],                            _if_conditional98) {
                                if(_if_conditional99=string_equals(self->keys[it_41],key),                                _if_conditional99) {
                                ...
                                it_41++;
                                if(_if_conditional100=it_41>=self->size,                                _if_conditional100) {
                                    it_41=0;
                                }
                                else {
                                    if(_if_conditional101=it_41==hash_40,                                    _if_conditional101) {
...
memset(&it_49, 0, sizeof(struct list_item$1charp*));
                            ...
                            while(_while_condtional10=it_49!=((void*)0),                            _while_condtional10) {
                                if(_if_conditional108=string_equals(it_49->item,item),                                _if_conditional108) {
                                        ...
                                        if(_if_conditional115=head==0&&tail==self->len,                                        _if_conditional115) {
                                            ...
                                            if(_if_conditional116=head==0,                                            _if_conditional116) {
                                                ...
                                                while(_while_condtional12=it_53!=((void*)0),                                                _while_condtional12) {
                                                    if(_if_conditional117=i_54<tail,                                                    _if_conditional117) {
                                                        prev_it_55=it_53;
                                                        it_53=it_53->next;
                                                        i_54++;
                                                        ...
                                                        if(_if_conditional118=i_54==tail,                                                        _if_conditional118) {
                                                            self->head=it_53;
                                                ...
                                                if(_if_conditional119=tail==self->len,                                                _if_conditional119) {
                                                    ...
                                                    while(_while_condtional13=it_56!=((void*)0),                                                    _while_condtional13) {
                                                        if(_if_conditional120=i_57==head,                                                        _if_conditional120) {
                                                            self->tail=it_56->prev;
                                                            self->tail->next=((void*)0);
                                                        }
                                                        if(_if_conditional121=i_57>=head,                                                        _if_conditional121) {
                                                            prev_it_58=it_56;
                                                            it_56=it_56->next;
                                                            i_57++;
                                                    ...
                                                    while(_while_condtional14=it_59!=((void*)0),                                                    _while_condtional14) {
                                                        if(_if_conditional122=i_62==head,                                                        _if_conditional122) {
                                                            head_prev_it_60=it_59->prev;
                                                        }
                                                        if(_if_conditional123=i_62==tail,                                                        _if_conditional123) {
                                                            tail_it_61=it_59;
                                                        }
                                                        if(_if_conditional124=i_62>=head&&i_62<tail,                                                        _if_conditional124) {
                                                            prev_it_63=it_59;
                                                            it_59=it_59->next;
                                                            i_62++;
                                                    ...
                                                    if(_if_conditional125=head_prev_it_60!=((void*)0),                                                    _if_conditional125) {
                                                        head_prev_it_60->next=tail_it_61;
                                                    }
                                                    if(_if_conditional126=tail_it_61!=((void*)0),                                                    _if_conditional126) {
...
memset(&litem_72, 0, sizeof(struct list_item$1charp*));
                if(_if_conditional138=self->len==0,                _if_conditional138) {
                    litem_70=(struct list_item$1charp*)come_increment_ref_count(((struct list_item$1charp*)(right_value53=(struct list_item$1charp*)come_calloc(1, sizeof(struct list_item$1charp)*(1), "/usr/local/include/comelang2.h", 226, "list_item$1charp"))));
                    ...
                    if(_if_conditional139=self->len==1,                    _if_conditional139) {
                        litem_71=(struct list_item$1charp*)come_increment_ref_count(((struct list_item$1charp*)(right_value54=(struct list_item$1charp*)come_calloc(1, sizeof(struct list_item$1charp)*(1), "/usr/local/include/comelang2.h", 236, "list_item$1charp"))));
                        ...
                        litem_72=(struct list_item$1charp*)come_increment_ref_count(((struct list_item$1charp*)(right_value55=(struct list_item$1charp*)come_calloc(1, sizeof(struct list_item$1charp)*(1), "/usr/local/include/comelang2.h", 246, "list_item$1charp"))));
                        come_call_finalizer2(list_item$1charpp_finalize,right_value55, (void*)0, (void*)0, 0, 1, 0, 0, __result_obj__);
...
right_value58 = (void*)0;
    __result54__ = __result_obj__ = ((char*)(right_value58=__builtin_string("sUnionNode")));
...
right_value64 = (void*)0;
    ...
    if(_if_conditional142=!klass_74->mOutputed,    _if_conditional142) {
        klass_74->mOutputed=(_Bool)1;
        if(_if_conditional143=list$1tuple2$2charphsTypephph_length(klass_74->mFields)>0,        _if_conditional143) {
            buf_75=(struct buffer*)come_increment_ref_count(((struct buffer*)(right_value60=buffer_initialize((struct buffer*)come_increment_ref_count(((struct buffer*)(right_value59=(struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "15union.c", 46, "buffer"))))))));
            ...
            buffer_append_str(buf_75,((char*)(right_value61=xsprintf("union %s\n{\n",type_73->mClass->mName))));
            ...
            for(            o2_saved_76=(struct list$1tuple2$2charphsTypephph*)come_increment_ref_count((klass_74->mFields)),it_79=list$1tuple2$2charphsTypephph_begin((o2_saved_76));            !list$1tuple2$2charphsTypephph_end((o2_saved_76));            it_79=list$1tuple2$2charphsTypephph_next((o2_saved_76))            ){
                ...
                buffer_append_str(buf_75,((char*)(right_value62=make_define_var(type_83,name_82,(_Bool)0,info))));
            ...
            buffer_append_str(buf_75,((char*)(right_value63=xsprintf("};\n"))));
            right_value63 = come_decrement_ref_count2(right_value63, (void*)0, (void*)0, 1, 0, 0, __result_obj__);
            if(_if_conditional151=info->output_header_file&&string_operator_not_equals(klass_74->mDeclareSName,info->base_sname),            _if_conditional151) {
            }
            else {
                if(self->mOutput) {
                    add_come_code_at_source_head(info,"%s",((char*)(right_value64=buffer_to_string(buf_75))));
...
right_value65 = (void*)0;
    __result65__ = __result_obj__ = ((char*)(right_value65=__builtin_string(self->sname)));
...
right_value101 = (void*)0;
    if(_if_conditional160=map$2charphsClassph_at(info->classes,type_name,((void*)0))==((void*)0),    _if_conditional160) {
        output_87=(_Bool)1;
        __dec_obj31=klass_86;
        klass_86=(struct sClass*)come_increment_ref_count(((struct sClass*)(right_value68=sClass_initialize((struct sClass*)come_increment_ref_count(((struct sClass*)(right_value66=(struct sClass*)come_calloc(1, sizeof(struct sClass)*(1), "15union.c", 88, "sClass")))),((char*)(right_value67=__builtin_string(type_name))),(_Bool)0,(_Bool)1,(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)0,-1,-1,(_Bool)0,info))));
        come_call_finalizer2(sClass_finalize,__dec_obj31, (void*)0, (void*)0, 0, 0, 0, 0, (void*)0);
        ...
        map$2charphsClassph_insert(info->classes,(char*)come_increment_ref_count(((char*)(right_value72=__builtin_string(type_name)))),(struct sClass*)come_increment_ref_count(((struct sClass*)(right_value86=sClass_clone(klass_86)))));
        ...
        output_87=(_Bool)0;
        __dec_obj40=klass_86;
        klass_86=(struct sClass*)come_increment_ref_count(((struct sClass*)(right_value87=sClass_clone(map$2charphsClassph_at(info->classes,type_name,((void*)0))))));
    ...
    type_116=(struct sType*)come_increment_ref_count(((struct sType*)(right_value89=sType_initialize((struct sType*)come_increment_ref_count(((struct sType*)(right_value88=(struct sType*)come_calloc(1, sizeof(struct sType)*(1), "15union.c", 96, "sType")))),type_name,(_Bool)0,info))));
    ...
    while(_while_condtional21=(_Bool)1,    _while_condtional21) {
        multiple_assign_var2=((struct tuple3$3sTypephcharphbool*)(right_value90=parse_type(info,(_Bool)1,(_Bool)1,(_Bool)0)));
        ...
        come_call_finalizer2(tuple3$3sTypephcharphboolp_finalize,right_value90, (void*)0, (void*)0, 0, 1, 0, 0, __result_obj__);
        if(_if_conditional204=!err_121,        _if_conditional204) {
            printf("%s %d: parse_type failed\n",info->sname,info->sline);
            exit(2);
        }
        expected_next_character(59,info);
        if(_if_conditional205=!info->no_output_err,        _if_conditional205) {
            list$1tuple2$2charphsTypephph_push_back(type_116->mClass->mFields,(struct tuple2$2charphsTypeph*)come_increment_ref_count(((struct tuple2$2charphsTypeph*)(right_value95=tuple2$2charphsTypeph_initialize((struct tuple2$2charphsTypeph*)come_increment_ref_count(((struct tuple2$2charphsTypeph*)(right_value94=(struct tuple2$2charphsTypeph*)come_calloc(1, sizeof(struct tuple2$2charphsTypeph)*(1), "15union.c", 112, "tuple2$2charphsTypeph")))),(char*)come_increment_ref_count(name_120),(struct sType*)come_increment_ref_count(type2_119))))));
    ...
    __result91__ = __result_obj__ = ((struct sNode*)(right_value101=_inf_value1));
    ...
    come_call_finalizer2(sUnionNode_finalize,right_value97, (void*)0, (void*)0, 0, 1, 0, 0, __result_obj__);
...
memset(&it_89, 0, sizeof(unsigned int));
        ...
        while(_while_condtional16=(_Bool)1,        _while_condtional16) {
            if(_if_conditional153=self->item_existance[it_89],            _if_conditional153) {
                if(_if_conditional154=string_equals(self->keys[it_89],key),                _if_conditional154) {
                ...
                it_89++;
                if(_if_conditional158=it_89>=self->size,                _if_conditional158) {
                    it_89=0;
                }
                else {
                    if(_if_conditional159=it_89==hash_88,                    _if_conditional159) {
...
memset(&it2_108, 0, sizeof(char*));
            ...
            while(_while_condtional18=(_Bool)1,            _while_condtional18) {
                if(_if_conditional169=self->item_existance[it_106],                _if_conditional169) {
                    if(_if_conditional170=string_equals(self->keys[it_106],key),                    _if_conditional170) {
                    ...
                    it_106++;
                    if(_if_conditional173=it_106>=self->size,                    _if_conditional173) {
                        it_106=0;
                    }
                    else {
                        if(_if_conditional174=it_106==hash_105,                        _if_conditional174) {
                            printf("unexpected error in map.insert\n");
                            stackframe();
                            exit(2);
                        }
            ...
            for(            it2_108=list$1charp_begin(self->key_list);            !list$1charp_end(self->key_list);            it2_108=list$1charp_next(self->key_list)            ){
                if(_if_conditional177=string_equals(it2_108,key),                _if_conditional177) {
                    puts("SAME KEY");
                    same_key_exist_107=(_Bool)1;
                }
            }
            if(_if_conditional178=!same_key_exist_107,            _if_conditional178) {
                list$1charp_push_back(self->key_list,key);
            }
...
memset(&default_value_104, 0, sizeof(struct sClass*));
                    ...
                    keys_91=(char**)come_increment_ref_count(((char**)(right_value69=(char**)come_calloc(1, sizeof(char*)*(1*(size_90)), "/usr/local/include/comelang2.h", 1335, "char*%"))));
                    right_value69 = come_decrement_ref_count2(right_value69, (void*)0, (void*)0, 1, 0, 0, __result_obj__);
                    items_92=(struct sClass**)come_increment_ref_count(((struct sClass**)(right_value70=(struct sClass**)come_calloc(1, sizeof(struct sClass*)*(1*(size_90)), "/usr/local/include/comelang2.h", 1336, "sClass*%"))));
                    come_call_finalizer2(sClass_finalize,right_value70, (void*)0, (void*)0, 0, 1, 0, 0, __result_obj__);
                    item_existance_93=(_Bool*)come_increment_ref_count(((_Bool*)(right_value71=(_Bool*)come_calloc(1, sizeof(_Bool)*(1*(size_90)), "/usr/local/include/comelang2.h", 1337, "bool"))));
                    ...
                    for(                    it_97=map$2charphsClassph_begin(self);                    !map$2charphsClassph_end(self);                    it_97=map$2charphsClassph_next(self)                    ){
                        ...
                        while(_while_condtional17=(_Bool)1,                        _while_condtional17) {
                            if(_if_conditional166=item_existance_93[n_103],                            _if_conditional166) {
                                n_103++;
                                if(_if_conditional167=n_103>=size_90,                                _if_conditional167) {
                                    n_103=0;
                                }
                                else {
                                    if(_if_conditional168=n_103==hash_102,                                    _if_conditional168) {
                                        printf("unexpected error in map.rehash(1)\n");
                                        stackframe();
                                        exit(2);
                                    }
...
right_value85 = (void*)0;
            ...
            result_109=(struct sClass*)come_increment_ref_count(((struct sClass*)(right_value73=(struct sClass*)come_calloc(1, sizeof(struct sClass)*(1), "sClass_clone", 3, "sClass"))));
            ...
            if(_if_conditional188=self!=((void*)0)&&self->mName!=((void*)0),            _if_conditional188) {
                __dec_obj32=result_109->mName;
                result_109->mName=(char*)come_increment_ref_count(((char*)(right_value74=string_clone(self->mName))));
            ...
            if(_if_conditional191=self!=((void*)0)&&self->mFields!=((void*)0),            _if_conditional191) {
                __dec_obj38=result_109->mFields;
                result_109->mFields=(struct list$1tuple2$2charphsTypephph*)come_increment_ref_count(((struct list$1tuple2$2charphsTypephph*)(right_value84=list$1tuple2$2charphsTypephphp_clone(self->mFields))));
                come_call_finalizer2(list$1tuple2$2charphsTypephph_finalize,__dec_obj38, (void*)0, (void*)0, 0, 0, 0, 0, (void*)0);
                come_call_finalizer2(list$1tuple2$2charphsTypephphp_finalize,right_value84, (void*)0, (void*)0, 0, 1, 0, 0, __result_obj__);
            }
            ...
            if(_if_conditional201=self!=((void*)0)&&self->mDeclareSName!=((void*)0),            _if_conditional201) {
                __dec_obj39=result_109->mDeclareSName;
                result_109->mDeclareSName=(char*)come_increment_ref_count(((char*)(right_value85=string_clone(self->mDeclareSName))));
...
right_value83 = (void*)0;
                    ...
                    result_110=(struct list$1tuple2$2charphsTypephph*)come_increment_ref_count(((struct list$1tuple2$2charphsTypephph*)(right_value76=list$1tuple2$2charphsTypephph_initialize((struct list$1tuple2$2charphsTypephph*)come_increment_ref_count(((struct list$1tuple2$2charphsTypephph*)(right_value75=(struct list$1tuple2$2charphsTypephph*)come_calloc(1, sizeof(struct list$1tuple2$2charphsTypephph)*(1), "/usr/local/include/comelang2.h", 142, "list$1tuple2$2charphsTypephph"))))))));
                    ...
                    while(_while_condtional19=it_111!=((void*)0),                    _while_condtional19) {
                        list$1tuple2$2charphsTypephph_add(result_110,(struct tuple2$2charphsTypeph*)come_increment_ref_count(((struct tuple2$2charphsTypeph*)(right_value83=tuple2$2charphsTypephp_clone(it_111->item)))));
...
memset(&litem_114, 0, sizeof(struct list_item$1tuple2$2charphsTypephph*));
                            if(_if_conditional193=self->len==0,                            _if_conditional193) {
                                litem_112=(struct list_item$1tuple2$2charphsTypephph*)come_increment_ref_count(((struct list_item$1tuple2$2charphsTypephph*)(right_value77=(struct list_item$1tuple2$2charphsTypephph*)come_calloc(1, sizeof(struct list_item$1tuple2$2charphsTypephph)*(1), "/usr/local/include/comelang2.h", 156, "list_item$1tuple2$2charphsTypephph"))));
                                ...
                                if(_if_conditional196=self->len==1,                                _if_conditional196) {
                                    litem_113=(struct list_item$1tuple2$2charphsTypephph*)come_increment_ref_count(((struct list_item$1tuple2$2charphsTypephph*)(right_value78=(struct list_item$1tuple2$2charphsTypephph*)come_calloc(1, sizeof(struct list_item$1tuple2$2charphsTypephph)*(1), "/usr/local/include/comelang2.h", 166, "list_item$1tuple2$2charphsTypephph"))));
                                    ...
                                    litem_114=(struct list_item$1tuple2$2charphsTypephph*)come_increment_ref_count(((struct list_item$1tuple2$2charphsTypephph*)(right_value79=(struct list_item$1tuple2$2charphsTypephph*)come_calloc(1, sizeof(struct list_item$1tuple2$2charphsTypephph)*(1), "/usr/local/include/comelang2.h", 176, "list_item$1tuple2$2charphsTypephph"))));
...
right_value82 = (void*)0;
                            ...
                            result_115=(struct tuple2$2charphsTypeph*)come_increment_ref_count(((struct tuple2$2charphsTypeph*)(right_value80=(struct tuple2$2charphsTypeph*)come_calloc(1, sizeof(struct tuple2$2charphsTypeph)*(1), "tuple2$2charphsTypephp_clone", 3, "tuple2$2charphsTypeph"))));
                            come_call_finalizer2(tuple2$2charphsTypeph_finalize,right_value80, (void*)0, (void*)0, 0, 1, 0, 0, __result_obj__);
                            if(_if_conditional198=self!=((void*)0)&&self->v1!=((void*)0),                            _if_conditional198) {
                                __dec_obj36=result_115->v1;
                                result_115->v1=(char*)come_increment_ref_count(((char*)(right_value81=string_clone(self->v1))));
                                __dec_obj36 = come_decrement_ref_count2(__dec_obj36, (void*)0, (void*)0, 0,0,0, (void*)0);
                                right_value81 = come_decrement_ref_count2(right_value81, (void*)0, (void*)0, 1, 0, 0, __result_obj__);
                            }
                            if(_if_conditional199=self!=((void*)0)&&self->v2!=((void*)0),                            _if_conditional199) {
                                __dec_obj37=result_115->v2;
                                result_115->v2=(struct sType*)come_increment_ref_count(((struct sType*)(right_value82=sType_clone(self->v2))));
...
memset(&litem_124, 0, sizeof(struct list_item$1tuple2$2charphsTypephph*));
                if(_if_conditional206=self->len==0,                _if_conditional206) {
                    litem_122=(struct list_item$1tuple2$2charphsTypephph*)come_increment_ref_count(((struct list_item$1tuple2$2charphsTypephph*)(right_value91=(struct list_item$1tuple2$2charphsTypephph*)come_calloc(1, sizeof(struct list_item$1tuple2$2charphsTypephph)*(1), "/usr/local/include/comelang2.h", 226, "list_item$1tuple2$2charphsTypephph"))));
                    ...
                    if(_if_conditional207=self->len==1,                    _if_conditional207) {
                        litem_123=(struct list_item$1tuple2$2charphsTypephph*)come_increment_ref_count(((struct list_item$1tuple2$2charphsTypephph*)(right_value92=(struct list_item$1tuple2$2charphsTypephph*)come_calloc(1, sizeof(struct list_item$1tuple2$2charphsTypephph)*(1), "/usr/local/include/comelang2.h", 236, "list_item$1tuple2$2charphsTypephph"))));
                        ...
                        litem_124=(struct list_item$1tuple2$2charphsTypephph*)come_increment_ref_count(((struct list_item$1tuple2$2charphsTypephph*)(right_value93=(struct list_item$1tuple2$2charphsTypephph*)come_calloc(1, sizeof(struct list_item$1tuple2$2charphsTypephph)*(1), "/usr/local/include/comelang2.h", 246, "list_item$1tuple2$2charphsTypephph"))));
...
right_value126 = (void*)0;
    if(_if_conditional216=charp_operator_equals(buf,"union"),    _if_conditional216) {
        source_head_126=info->p;
        type_name_127=(char*)come_increment_ref_count(((char*)(right_value102=parse_word(info))));
        right_value102 = come_decrement_ref_count2(right_value102, (void*)0, (void*)0, 1, 0, 0, __result_obj__);
        output_128=(_Bool)1;
        if(_if_conditional217=map$2charphsClassph_at(info->classes,type_name_127,((void*)0))==((void*)0),        _if_conditional217) {
            map$2charphsClassph_insert(info->classes,(char*)come_increment_ref_count(type_name_127),(struct sClass*)come_increment_ref_count(((struct sClass*)(right_value105=sClass_initialize((struct sClass*)come_increment_ref_count(((struct sClass*)(right_value103=(struct sClass*)come_calloc(1, sizeof(struct sClass)*(1), "15union.c", 134, "sClass")))),((char*)(right_value104=__builtin_string(type_name_127))),(_Bool)0,(_Bool)1,(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)0,-1,-1,(_Bool)0,info)))));
            ...
            output_128=(_Bool)0;
            map$2charphsClassph_insert(info->classes,(char*)come_increment_ref_count(type_name_127),(struct sClass*)come_increment_ref_count(((struct sClass*)(right_value108=sClass_initialize((struct sClass*)come_increment_ref_count(((struct sClass*)(right_value106=(struct sClass*)come_calloc(1, sizeof(struct sClass)*(1), "15union.c", 138, "sClass")))),((char*)(right_value107=__builtin_string(type_name_127))),(_Bool)0,(_Bool)1,(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)0,-1,-1,(_Bool)0,info)))));
        ...
        map$2charphsClassph_insert(info->classes,(char*)come_increment_ref_count(type_name_127),(struct sClass*)come_increment_ref_count(((struct sClass*)(right_value111=sClass_initialize((struct sClass*)come_increment_ref_count(((struct sClass*)(right_value109=(struct sClass*)come_calloc(1, sizeof(struct sClass)*(1), "15union.c", 141, "sClass")))),((char*)(right_value110=__builtin_string(type_name_127))),(_Bool)0,(_Bool)1,(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)0,(_Bool)0,-1,-1,(_Bool)0,info)))));
        ...
        type_129=(struct sType*)come_increment_ref_count(((struct sType*)(right_value113=sType_initialize((struct sType*)come_increment_ref_count(((struct sType*)(right_value112=(struct sType*)come_calloc(1, sizeof(struct sType)*(1), "15union.c", 143, "sType")))),type_name_127,(_Bool)0,info))));
        ...
        while(_while_condtional22=(_Bool)1,        _while_condtional22) {
            multiple_assign_var3=((struct tuple3$3sTypephcharphbool*)(right_value114=parse_type(info,(_Bool)1,(_Bool)1,(_Bool)0)));
            ...
            if(_if_conditional218=!err_132,            _if_conditional218) {
                printf("%s %d: parse_type failed\n",info->sname,info->sline);
                exit(2);
            }
            expected_next_character(59,info);
            list$1tuple2$2charphsTypephph_push_back(type_129->mClass->mFields,(struct tuple2$2charphsTypeph*)come_increment_ref_count(((struct tuple2$2charphsTypeph*)(right_value116=tuple2$2charphsTypeph_initialize((struct tuple2$2charphsTypeph*)come_increment_ref_count(((struct tuple2$2charphsTypeph*)(right_value115=(struct tuple2$2charphsTypeph*)come_calloc(1, sizeof(struct tuple2$2charphsTypeph)*(1), "15union.c", 157, "tuple2$2charphsTypeph")))),(char*)come_increment_ref_count(name_131),(struct sType*)come_increment_ref_count(type2_130))))));
        ...
        header_134=(struct buffer*)come_increment_ref_count(((struct buffer*)(right_value118=buffer_initialize((struct buffer*)come_increment_ref_count(((struct buffer*)(right_value117=(struct buffer*)come_calloc(1, sizeof(struct buffer)*(1), "15union.c", 168, "buffer"))))))));
        ...
        add_come_code_at_come_header(info,"%s;\n",((char*)(right_value119=buffer_to_string(header_134))));
        ...
        __result94__ = __result_obj__ = ((struct sNode*)(right_value125=_inf_value2));
    ...
    __result95__ = __result_obj__ = ((struct sNode*)(right_value126=top_level_v96(buf,head,head_sline,info)));
...
right_value124 = (void*)0;
            ...
            result_135=(struct sUnionNode*)come_increment_ref_count(((struct sUnionNode*)(right_value122=(struct sUnionNode*)come_calloc(1, sizeof(struct sUnionNode)*(1), "sUnionNode_clone", 3, "sUnionNode"))));
            come_call_finalizer2(sUnionNode_finalize,right_value122, (void*)0, (void*)0, 0, 1, 0, 0, __result_obj__);
            if(_if_conditional223=self!=((void*)0)&&self->mType!=((void*)0),            _if_conditional223) {
                __dec_obj48=result_135->mType;
            ...
            __result93__ = __result_obj__ = result_135;
...
right_value131 = (void*)0;
    define_struct_136=(_Bool)0;
    {
        ...
        if(_if_conditional227=charp_operator_equals(buf,"union"),        _if_conditional227) {
            type_name_139=(char*)come_increment_ref_count(((char*)(right_value127=parse_word(info))));
    ...
    if(define_struct_136) {
        type_name_140=(char*)come_increment_ref_count(((char*)(right_value129=parse_word(info))));
        right_value129 = come_decrement_ref_count2(right_value129, (void*)0, (void*)0, 1, 0, 0, __result_obj__);
        __result96__ = __result_obj__ = ((struct sNode*)(right_value130=parse_union((char*)come_increment_ref_count(type_name_140),info)));
    ...
    __result97__ = __result_obj__ = ((struct sNode*)(right_value131=string_node_v14(buf,head,head_sline,info)));
